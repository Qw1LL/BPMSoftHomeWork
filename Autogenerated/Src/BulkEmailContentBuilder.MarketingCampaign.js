define("BulkEmailContentBuilder", ["BulkEmailHelper", "BulkEmailTemplateHelper", "BulkEmailHyperlinkCorrector",
	...
	function(BulkEmailHelper, BulkEmailTemplateHelper, BulkEmailHyperlinkCorrector, BulkEmailContentBuilderEnumsModule,
		...
		BPMSoft.BulkEmailContentBuilderActions = {
			Close: 1,
			Save: 2,
		...
		return {
			mixins: {
				dynamicContent: "BPMSoft.DynamicContentBuilderMixin",
			...
			attributes: {
				...
				"BulkEmailEntity": {
					dataValueType: BPMSoft.DataValueType.ENTITY,
					type: BPMSoft.ViewModelColumnType.VIRTUAL_COLUMN
				},
			...
			properties: {
				/**
				 * @inheritdoc BPMSoft.ContentBuilder#unselectableItems
				 * @override
				 */
			...
			methods: {
				...
				_openEmailTemplateLookupGallery: function() {
					...
					var renderTo = ModalBox.show(config, BPMSoft.emptyFn, this);
				...
				_getAggregatedMacrosDataValueTypes: function() {
					var dataValueTypes = Object.values(BPMSoft.DataValueType);
					dataValueTypes = Ext.Array.remove(dataValueTypes, BPMSoft.DataValueType.LOOKUP);
					return Ext.Array.remove(dataValueTypes, BPMSoft.DataValueType.BLOB);
				},
				...
				init: function(callback, scope) {
					this.$DynamicContentEnabled = BPMSoft.Features.getIsEnabled("BulkEmailDynamicContentBuilder");
				 ...
				 * @protected
				 * @returns {BPMSoft.FilterGroup} Entity filters.
				 */
				getEmailTemplateLookupFilters: function() {
					...
					filters.addItem(BPMSoft.createColumnFilterWithParameter(
						BPMSoft.ComparisonType.EQUAL, "ConfigType", this.getConfigType()));
					return filters;
				},
				...
				selectTemplateFromLookup: function() {
					const isEmailTemplateLookupGalleryEnabled =
						this.BPMSoft.Features.getIsEnabled("EmailTemplateLookupGallery");
				...
				/**
				 * @inheritdoc BPMSoft.ContentBuilder#subscribeGroupElementsEvents
				 * @override
				 */
				...
				/**
				 * @inheritdoc BPMSoft.ContentBuilder#unsubscribeGroupElementsEvents
				 * @override
				 */
				...
				/**
				 * @inheritdoc BPMSoft.ContentBuilder#getPreviewHtml
				 * @override
				 */
				 ...
				 * @param {BPMSoft.ContentBlockGroupViewModel} group Content block group view model.
				 */
				...
				/**
				 * @inheritdoc BPMSoft.ContentBuilder#onItemCopy
				 * @override
				 */
				...
				/**
				 * @inheritdoc BPMSoft.EmailContentBuilder#createContentValidator
				 * @override
				 */
				createContentValidator: function() {
					return Ext.create("BPMSoft.EmailContentValidator");
				},
				...
				_updateBulkEmailTemplateConfig: function(templateConfig, html, saveConfig, callback, scope) {
					var configText = BPMSoft.encode(templateConfig);
				 ...
				 * @protected
				 * @returns {BPMSoft.BulkEmailTemplateValidator} Instance of BulkEmailTemplateValidator.
				 */
				...
				/**
				 * @inheritdoc BPMSoft.EmailContentBuilder#openPreviewModule
				 * @override
				 */
				...
				/**
				 * @inheritdoc BPMSoft.EmailContentBuilder#onSave
				 * @override
				 */
				 ...
				 * @private
				 * @param {BPMSoft.Collection} items Collection with view model items.
				 * @param {BPMSoft.ExportedItemType} itemType Expected item type.
				...
				_updateContentForHtmlGroup: function(updateConfig) {
					...
					BPMSoft.each(group.Items, function(block) {
						...
						if (htmlViewModel
								&& htmlViewModel.$ItemType === BPMSoft.ContentBuilderBodyItemType.mjraw.value) {
				 ...
				 * @protected
				 * @param {Object} config Config of content items.
				 * @param {BPMSoft.BaseContentExporter} emailContentExporter of exporter
				 */
				...
				addUnsubscribeBlock: function(config) {
					...
					var contentBuilderHelper = Ext.create("BPMSoft.ContentBuilderHelper", {
				...
				/**
				 * @inheritdoc BPMSoft.EmailContentBuilder#createContentBuilderHelper
				 * @override
				 */
				...
				/**
				 * @inheritdoc BPMSoft.core.ContentBuilder#subscribeMessages
				 * @override
				 */
				...
				/**
				 * @inheritdoc BPMSoft.ContentBuilder#isEmailMacroAvailable
				 * @override
				 */
				 ...
				 * @returns {BPMSoft.UpdateQuery} update.
				 */
				...
				onBulkEmailContentBuilderAction: function(action) {
					...
					switch(actionMessageId) {
						case BPMSoft.BulkEmailContentBuilderActions.Close:
							this.cancel();
							break;
						case BPMSoft.BulkEmailContentBuilderActions.GetContentBuilderConfig:
							return this.getContentBuilderConfig();
						case BPMSoft.BulkEmailContentBuilderActions.OpenTestEmailDialog:
							this.openSendTestEmailContentModalBox();
							break;
						case BPMSoft.BulkEmailContentBuilderActions.GetBulkEmailTitle:
							return this.$BulkEmailEntity.$Name;
						case BPMSoft.BulkEmailContentBuilderActions.GetBulkEmailId:
							return this.$RecordId;
						case BPMSoft.BulkEmailContentBuilderActions.GetReplicaHeaders:
							return this.$ReplicaHeadersCollection;
						case BPMSoft.BulkEmailContentBuilderActions.GetBulkEmailDefaultHeaders:
							return this.getBulkEmailDefaultHeaders();
						case BPMSoft.BulkEmailContentBuilderActions.SelectTemplateFromLookup:
							this.selectTemplateFromLookup();
							break;
						case BPMSoft.BulkEmailContentBuilderActions.Save:
							this.onSaveAction(action.config);
							break;
						case BPMSoft.BulkEmailContentBuilderActions.LoadTemplateFromLookup:
				...
				/**
				 * @inheritdoc BPMSoft.core.ContentBuilder#publishContentItemConfig
				 * @override
				 */
