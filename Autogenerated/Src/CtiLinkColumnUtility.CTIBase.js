define("CtiLinkColumnUtility", [], function() {
		...
		/**
		 * @class BPMSoft.configuration.CtiLinkColumnUtility.
		 * ##### ### ###### # ######### #### "######".
		 */
		Ext.define("BPMSoft.configuration.CtiLinkColumnUtility", {
			alternateClassName: "BPMSoft.CtiLinkColumnUtility",
		...
		return BPMSoft.CtiLinkColumnUtility;
	});
