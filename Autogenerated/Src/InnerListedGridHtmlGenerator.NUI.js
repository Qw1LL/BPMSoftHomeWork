define("InnerListedGridHtmlGenerator", ["css!InnerListedGridHtmlGeneratorCSS"],
	function() {
		Ext.define("BPMSoft.controls.InnerListedGridHtmlGenerator", {
			alternateClassName: "BPMSoft.InnerListedGridHtmlGenerator",
			extend: "BPMSoft.ListedGridHtmlGenerator",
			...
			/**
			 * @inheritdoc BPMSoft.GridHtmlGenerator#listedRowsCss
			 * @overridden
			 */
			listedRowsCss: "grid-listed-row listed-grid-line",

			/**
			 * @inheritdoc BPMSoft.GridHtmlGenerator#captionsCss
			 * @overridden
			 */
			...
			_clearStyleSheet: function() {
				if (this.styleSheetId) {
					BPMSoft.removeStyleSheet(this.styleSheetId);
			...
			_scrollFixedHeader: function(scrollDomEl) {
				...
				const scrollPosition = BPMSoft.getScrollPosition(scrollEl);
			...
			generateCssRules: function() {
				...
				BPMSoft.createStyleSheet(gridRule, styleSheetId);
			...
			/**
			 * @inheritdoc BPMSoft.GridHtmlGenerator#getDefaultCellHtmlConfig
			 * @overridden
			 */
			...
			/**
			 * @inheritdoc BPMSoft.ListedGridHtmlGenerator#getDefaultCaptionCellHtmlConfig
			 * @overridden
			 */
			...
			/**
			 * @inheritdoc BPMSoft.GridHtmlGenerator#renderContent
			 * @overridden
			 */
			...
			/**
			 * @inheritdoc BPMSoft.GridHtmlGenerator#generateWrapHtmlConfig
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.GridHtmlGenerator#generateGridWrapConfig
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.GridHtmlGenerator#getGridContentConfig
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.GridHtmlGenerator#getHorizontalScrollEl
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.GridHtmlGenerator#getVerticalScrollEl
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.GridHtmlGenerator#appendGridContent
			 * @overridden
			 */
