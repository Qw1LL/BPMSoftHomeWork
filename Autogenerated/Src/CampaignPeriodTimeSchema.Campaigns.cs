namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class CampaignPeriodTimeSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// <summary>
	/// Минуты в условиях перехода кампаний.
	/// </summary>
	public class CampaignPeriodTime : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class CampaignPeriodTime_CampaignsEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignPeriodTime
	{
