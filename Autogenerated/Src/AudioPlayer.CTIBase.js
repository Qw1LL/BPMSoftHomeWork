/**
 * @class BPMSoft.controls.AudioPlayer
 * #####, ########### ##########.
 */
Ext.define("BPMSoft.controls.AudioPlayer", {
	extend: "BPMSoft.Component",
	alternateClassName: "BPMSoft.AudioPlayer",
	...
	setSourceUrl: function(sourceUrl) {
		...
		if (!this.getIsElementAttachedToDom(elDom)) {
			// TODO Audio element should be created as single instance
			return;
		}
		elDom.src = sourceUrl;
	},
	...
	getTplData: function() {
		...
		var audioTplData = {
			...
			sourceUrl: BPMSoft.utils.string.encodeHtml(this.sourceUrl)
		};
