namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class PricelistSchema : BPMSoft.Configuration.Pricelist_ProductCatalogue_BPMSoftSchema
	{
	...
	/// Прайс-лист.
	/// </summary>
	public class Pricelist : BPMSoft.Configuration.Pricelist_ProductCatalogue_BPMSoft
	{
	...
	/// <exclude/>
	public partial class Pricelist_PRMOrderEventsProcess<TEntity> : BPMSoft.Configuration.Pricelist_ProductCatalogueEventsProcess<TEntity> where TEntity : Pricelist
	{
