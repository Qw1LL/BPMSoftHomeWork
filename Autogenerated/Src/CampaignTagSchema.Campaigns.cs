namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class CampaignTagSchema : BPMSoft.Configuration.BaseTagSchema
	{
	...
	/// <summary>
	/// Тег раздела кампании.
	/// </summary>
	public class CampaignTag : BPMSoft.Configuration.BaseTag
	{
	...
	/// <exclude/>
	public partial class CampaignTag_CampaignsEventsProcess<TEntity> : BPMSoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : CampaignTag
	{
