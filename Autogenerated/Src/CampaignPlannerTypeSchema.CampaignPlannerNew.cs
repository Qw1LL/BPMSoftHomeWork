namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class CampaignPlannerTypeSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// <summary>
	/// Тип маркетингового плана.
	/// </summary>
	public class CampaignPlannerType : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class CampaignPlannerType_CampaignPlannerNewEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignPlannerType
	{
