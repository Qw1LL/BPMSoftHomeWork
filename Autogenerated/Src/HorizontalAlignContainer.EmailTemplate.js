define("HorizontalAlignContainer", [], function() {
	 ...
	 */
	Ext.define("BPMSoft.controls.HorizontalAlignContainer", {
		extend: "BPMSoft.Container",
		alternateClassName: "BPMSoft.HorizontalAlignContainer",
		...
		applyTplConfigProperties: function(tplData, tplConfig) {
			BPMSoft.each(tplConfig, function(propertyValue, propertyName) {
				tplData[propertyName] = BPMSoft.deepClone(propertyValue);
			}, this);
		},
