define("QueuePageProfileUtilities", ["QueueItem"], function(QueueItem) {
		...
		/**
		 * @class BPMSoft.configuration.mixins.QueuePageProfileUtilities
		 * ###### ### ###### # ######## ## ######## #######.
		 * @type {BPMSoft.BaseObject}
		 */
		Ext.define("BPMSoft.configuration.mixins.QueuePageProfileUtilities", {
			extend: "BPMSoft.BaseObject",
			alternateClassName: "BPMSoft.QueuePageProfileUtilities",
			 ...
			 * ########## ######### #######, ####### ##### ######## # #######.
			 * @private
			 * @param {BPMSoft.EntitySchema} schemaInstance ######### #####.
			 * @returns {Object} ######### #######.
			 */
			...
			saveDefaultGridProfile: function(schemaUId, callback) {
				BPMSoft.EntitySchemaManager.getItemByUId(schemaUId, function(schema) {
					schema.getInstance(function(schemaInstance) {
						...
						BPMSoft.utils.saveUserProfile(pageProfileKey, pageProfileConfig, true, function() {
							BPMSoft.utils.saveUserProfile(detailProfileKey, detailProfileConfig, true, function() {
								if (callback) {
									callback();
								}
							});
