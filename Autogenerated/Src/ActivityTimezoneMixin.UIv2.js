define("ActivityTimezoneMixin", ["TimezoneUtils", "ActivityTimezoneMixinResources", "ModalBox"],
		function(TimezoneUtils, resources) {
			/**
			 * @class BPMSoft.configuration.mixins.ActivityTimezoneMixin
			 * Activity time zone mixin.
			 */
			Ext.define("BPMSoft.configuration.mixins.ActivityTimezoneMixin", {
				alternateClassName: "BPMSoft.ActivityTimezoneMixin",
				...
				_loadCurrentUserTimezone: function(callback, scope) {
					var code = BPMSoft.SysValue.CURRENT_USER_TIMEZONE_CODE;
					this._loadTimezoneAdjustmentRule(code, function(adjustmentRuleConfig) {
						...
						this.set("CurrentUserTimezone", {
							...
							"TransitionStart": BPMSoft.parseDate(adjustmentRuleConfig.transitionStart),
							"TransitionEnd": BPMSoft.parseDate(adjustmentRuleConfig.transitionEnd)
						});
				...
				setAdjustmentRule: function(adjustmentRuleConfig, callback, scope) {
					...
					this.set("TransitionStart", BPMSoft.parseDate(adjustmentRuleConfig.transitionStart));
					this.set("TransitionEnd", BPMSoft.parseDate(adjustmentRuleConfig.transitionEnd));
					this.Ext.callback(callback, scope || this);
				},
				...
				getDeepCloneValue: function(name) {
					return this.BPMSoft.deepClone(this.get(name));
				},
