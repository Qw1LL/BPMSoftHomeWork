define("TimelineFilterMenuItem", ["css!TimelineFilterMenuItem"], function() {
	Ext.define("BPMSoft.controls.TimelineFilterMenuItem", {
		extend: "BPMSoft.MenuItem",
		alternateClassName: "BPMSoft.TimelineFilterMenuItem",
		...
		/**
		 * @inheritDoc BPMSoft.MenuItem#getTplData
		 * @override
		 */
		getTplData: function() {
		...
		/**
		 * @inheritDoc BPMSoft.BaseMenuItem#prepareTplDataStylesAndClasses
		 * @override
		 */
		...
		/**
		 * @inheritDoc BPMSoft.MenuItem#init
		 * @override
		 */
		init: function() {
			this.callParent(arguments);
		...
		createCheckboxControl: function() {
			this._checkboxControl = Ext.create("BPMSoft.CheckBoxEdit", {
		...
		/**
		 * @inheritdoc BPMSoft.BaseMenuItem#onItemClick
		 * @override
		 */
		...
		/**
		 * @inheritDoc BPMSoft.MenuItem#bind
		 * @override
		 */
		bind: function() {
			this.callParent(arguments);
		...
		/**
		 * @inheritdoc BPMSoft.BaseMenuItem#onClick
		 * @override
		 */
		...
		/**
		 * @inheritDoc BPMSoft.MenuItem#getBindConfig
		 * @override
		 */
