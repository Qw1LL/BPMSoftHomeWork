...
define("DynamicBlockPropertiesPage", ["DynamicBlockPropertiesPageResources", "ModalBox",
	...
	return {
		...
		attributes: {
			 ...
			 * @type {BPMSoft.DynamicContentBlockGroupViewModel}
			 */
			"SelectedGroup": {
		...
		methods: {
			...
			_initSegmentCollection: function() {
				this.$SegmentsCollection = Ext.create("BPMSoft.BaseViewModelCollection");
			 ...
			 * @private
			 * @param {BPMSoft.DynamicContentBlockViewModel} segment Current segment.
			 ...
			 * @private
			 * @param {BPMSoft.DynamicContentBlockViewModel} item Source block view model.
			 * @returns {BPMSoft.SegmentContainerListItemViewModel} Segment view model.
			 */
			_segmentToListItemViewModel: function(item) {
				var caption = this._getSegmentCaption(item);
				var viewModelItem = this.Ext.create("BPMSoft.SegmentContainerListItemViewModel", {
					values: {
						Id: item.$Id,
			 ...
			 * @private
			 * @param {BPMSoft.Collection} items Group's blocks.
			 */
			 ...
			 * @private
			 * @param {BPMSoft.SegmentContainerListItemViewModel} segment Segment to start from.
			 * @param {Boolean} isPriorityUp True when segment with bigger priority required.
			 * @return {BPMSoft.SegmentContainerListItemViewModel} Next segment by priority.
			 */
			 ...
			 * @private
			 * @param {Array[BPMSoft.SegmentContainerListItemViewModel]} items List of segments.
			...
			_getItemsProperties: function(items, properties) {
				...
				BPMSoft.each(items, function(item) {
					...
					BPMSoft.each(properties, function(propName) {
			...
			validateAvailableAttributes: function() {
				...
				if (this.$SelectedGroup) {
					BPMSoft.each(this.$SelectedGroup.$Items, function(block) {
			 ...
			 * @return {Array[BPMSoft.SegmentContainerListItemViewModel]} Changed segments.
			 */
			 ...
			 * @returns {BPMSoft.Collection} Available attributes.
			 */
			getAvailableAttributes: function(selectedIndex) {
				var attributesInUse = [];
				if (this.$SelectedGroup) {
					BPMSoft.each(this.$SelectedGroup.$Items, function(item) {
			 ...
			 * @public
			 * @param {BPMSoft.BaseViewModelCollection} collection Segments collection.
			 */
			 ...
			 * @public
			 * @param {BPMSoft.BaseContentBlockViewModel} item New selected content item.
			 */
			 ...
			 * @public
			 * @param {BPMSoft.SegmentContainerListItemViewModel} item Current selected segment.
			 */
