 ...
 */
define("AddDataUserTaskPropertiesPage", ["BPMSoft", "ProcessUserTaskConstants", "BusinessRuleModule",
	"AddDataUserTaskPropertiesPageResources", "EntityColumnMappingMixin"],
	function(BPMSoft, ProcessUserTaskConstants, businessRuleModule) {
		return {
			mixins: {
			...
			methods: {
				 ...
				 * {@link BPMSoft.configuration.ProcessUserTaskConstants#RECORD_ADD_MODE.RECORD_SET}.
				 * @private
				 * @return {Boolean}
				 */
				 ...
				 * @protected
				 * @param {BPMSoft.ProcessBaseElementSchema} element Process element.
				 * @return {BPMSoft.ProcessUserTaskConstants.RECORD_ADD_MODE} Add data mode.
				 */
				...
				saveAddDataMode: function(element) {
					...
					if (!addDataModeEnumItem) {
						throw new BPMSoft.DataFieldIsRequiredException({fieldName: "AddDataModeEnumItem"});
					}
