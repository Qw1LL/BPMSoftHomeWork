namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class MkpInstalledAppNewsSchema : BPMSoft.Configuration.BaseEntitySchema
	{
	...
	/// Installed app news.
	/// </summary>
	public class MkpInstalledAppNews : BPMSoft.Configuration.BaseEntity
	{
	...
	/// <exclude/>
	public partial class MkpInstalledAppNews_MkpNotificationsEventsProcess<TEntity> : BPMSoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : MkpInstalledAppNews
	{
