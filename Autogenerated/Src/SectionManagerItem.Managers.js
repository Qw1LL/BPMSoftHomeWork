define("SectionManagerItem", ["SectionManagerItemResources", "SysModuleEntityManager"], function() {
	...
	/**
	 * @class BPMSoft.SectionManagerItem
	 * Class of section manager element.
	 */

	Ext.define("BPMSoft.SectionManagerItem", {
		extend: "BPMSoft.ObjectManagerItem",
		alternateClassName: "BPMSoft.SectionManagerItem",
		...
		getIsDefaultLeftPanelLogo: function() {
			...
			return Ext.isEmpty(value) || value === BPMSoft.DesignTimeEnums.DefaultIcon.SECTION_DEFAULT_ICON_ID;
		},
		 ...
		 * @return {BPMSoft.SysModuleEntityManagerItem} module entity manager element.
		 */
		getSysModuleEntityManagerItem: function(callback, scope) {
			BPMSoft.SysModuleEntityManager.initialize(null, function() {
				...
				const item = BPMSoft.SysModuleEntityManager.findItem(sysModuleEntityId);
		 ...
		 * @param {Function} callback Callback function.
		 * @param {Object} scope Callback function context.
		 * @return {BPMSoft.Collection} Section in workplace manager items.
		 */
	...
	return BPMSoft.SectionManagerItem;
});
