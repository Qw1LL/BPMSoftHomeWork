namespace BPMSoft.Configuration.ML
{
	...
	public class QueryInterpreter : IQueryInterpreter
	{
		...
		/// <summary>
		/// Adds reference on a type from <see cref="BPMSoft.Configuration"/> namespace which is used in expression.
		/// </summary>
		...
		public bool RegisterConfigurationType(string typeName) {
			string assemblyQualifiedName = $"BPMSoft.Configuration.{typeName}, BPMSoft.Configuration";
