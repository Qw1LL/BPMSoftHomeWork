			...
			methods: {
				...
				processSettingsPagesCallback: function(manifestSchema) {
					this.renameManifest(manifestSchema, function() {
						BPMSoft.ClientUnitSchemaManager.save(this.processDefaultWorkplace, this);
					});
				},
				...
				showMessage: function(message, callback) {
					...
					BPMSoft.showInformation(message, callback, this, msgBoxConfig);
				},
				...
				doesDefaultWorkplaceExist: function(callback) {
					...
					esq.filters.add("filterCode", this.BPMSoft.createColumnFilterWithParameter(
						this.BPMSoft.ComparisonType.EQUAL, "Code", "DefaultWorkplace"));
				...
				addDefaultWorkplace: function(callback) {
					...
					insert.setParameterValue("Code", "DefaultWorkplace", BPMSoft.DataValueType.TEXT);
