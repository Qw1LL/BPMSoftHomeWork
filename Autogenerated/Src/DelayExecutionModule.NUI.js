define('DelayExecutionModule', ['ext-base', 'BPMSoft', 'sandbox', 'Activity', 'ProcessModule', 'CardViewGenerator',
	'ConfigurationEnums', 'DelayExecutionModuleResources', 'LookupUtilities', 'ProcessModuleUtilities'],
	function(Ext, BPMSoft, sandbox, Activity, ProcessModule, CardViewGenerator, ConfigurationEnums, resources,
		...
		function addSchemaColumnToContainer(container, entitySchema, column) {
			var structureColumn = BPMSoft.deepClone(column);
			structureColumn.type = BPMSoft.ViewModelSchemaItem.ATTRIBUTE;
			...
			if (structureColumn.dataValueType === BPMSoft.DataValueType.BOOLEAN) {
		...
		function getView(viewModel) {
			...
			return Ext.create('BPMSoft.Container', containerMain);
		}
		...
		function getViewModel() {
			return Ext.create('BPMSoft.BaseViewModel', {
				...
				values: {
					...
					DelayDurationList: new BPMSoft.Collection(),
					DelayRemindBeforeList: new BPMSoft.Collection(),
