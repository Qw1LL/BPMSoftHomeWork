define("MailboxSyncSettingsViewModel", ["MaskHelper", "ModalBox",
	"MailboxSyncSettingsViewModelResources", "RightUtilities", "BPMSoft",
	"ConfigurationConstants", "ServiceHelper", "MailboxSyncSettings", "BaseSchemaViewModel"],
	function(MaskHelper, ModalBox, resources, RightUtilities, BPMSoft, ConfigurationConstants, ServiceHelper,
		MailboxSyncSettings) {
		/**
		 * @class BPMSoft.Exchange.MailboxSynchronizationSettingsViewMode
		 * View model class of mailbox synchronization settings.
		 */
		Ext.define("BPMSoft.Exchange.MailboxSyncSettingsViewModel", {

			extend: "BPMSoft.BaseSchemaViewModel",

			alternateClassName: "BPMSoft.MailboxSyncSettingsViewModel",
			...
			_loadMultiDeleteResultModule: function() {
				if (BPMSoft.MultiDeleteResultSchemaViewModel) {
			...
			_deleteRecordsAsyncCallback: function(responseObject) {
				...
				var result = this.BPMSoft.decode(responseObject.DeleteRecordsAsyncResult);
			...
			getData: function(callback, scope) {
				...
				var isSharedFilter = select.createColumnFilterWithParameter(
					BPMSoft.ComparisonType.EQUAL, "IsShared", true);
			...
			loadModel: function(result, callback, scope) {
				...
				entities.each(function(entity) {
					...
					results[recordId] = Ext.create("BPMSoft.BaseViewModel", {
						rowConfig: {
							Id: {dataValueType: BPMSoft.DataValueType.GUID},
							SenderEmailAddress: {dataValueType: BPMSoft.DataValueType.TEXT},
							UserName: {dataValueType: BPMSoft.DataValueType.TEXT},
							Type: {dataValueType: BPMSoft.DataValueType.LOOKUP},
							MailBoxOwner: {dataValueType: BPMSoft.DataValueType.TEXT}
						},
			...
			onDelete: function(returnCode) {
				...
				var operationKey = BPMSoft.generateGUID();
				var params = {
