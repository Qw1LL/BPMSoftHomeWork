namespace BPMSoft.Configuration
{
	...
	public class NotificationUtilities
	{
		...
		/// </summary>
		/// <param name="userConnection">Specified instance of <see cref="BPMSoft.Core.UserConnection"/>.</param>
		...
		public static DateTime GetSysAdminUnitLocalDateTime(UserConnection userConnection, Guid sysAdminUnitId) {
			...
			if (string.IsNullOrEmpty(timeZoneId))
				...
				destinationTimeZone = TimeZoneUtilities.GetTimeZoneInfo(timeZoneId);
