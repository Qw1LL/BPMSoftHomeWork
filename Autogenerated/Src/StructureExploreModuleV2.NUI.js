define("StructureExploreModuleV2", ["StructureExplorerMainViewModel", "StructureExplorerViewConfig",
	 ...
	 */
	Ext.define("BPMSoft.configuration.StructureExploreModule", {
		extend: "BPMSoft.BaseModule",
		alternateClassName: "BPMSoft.StructureExploreModule",
		 ...
		 * @type {String}
		 */
		viewModelClassName: "BPMSoft.StructureExplorerMainViewModel",
		 ...
		 * @type {String}
		 */
		viewConfigClassName: "BPMSoft.StructureExplorerViewConfig",
		...
		_initViewModel: function() {
			...
			this.viewItemCollection = new BPMSoft.Collection();
		...
		_initView: function() {
			...
			this.view = Ext.create(viewConfig.className || "BPMSoft.Container", viewConfig);
		},
		...
		destroy: function() {
			...
			BPMSoft.safeDestroy(this.viewItemCollection, this.viewModel, this.view);
	...
	return BPMSoft.StructureExploreModule;
