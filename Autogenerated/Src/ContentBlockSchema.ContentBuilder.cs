namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ContentBlockSchema : BPMSoft.Configuration.BaseEntitySchema
	{
	...
	/// Content block.
	/// </summary>
	public class ContentBlock : BPMSoft.Configuration.BaseEntity
	{
	...
	/// <exclude/>
	public partial class ContentBlock_ContentBuilderEventsProcess<TEntity> : BPMSoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ContentBlock
	{
