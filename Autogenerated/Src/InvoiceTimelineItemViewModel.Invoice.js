define("InvoiceTimelineItemViewModel", ["InvoiceTimelineItemViewModelResources", "BaseTimelineItemViewModel"],
	function() {
		/**
		 * @class BPMSoft.configuration.InvoiceTimelineItemViewModel
		 * Invoice timeline item view model class.
		 */
		Ext.define("BPMSoft.configuration.InvoiceTimelineItemViewModel", {
			alternateClassName: "BPMSoft.InvoiceTimelineItemViewModel",
