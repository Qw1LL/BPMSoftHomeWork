define("DynamicContentUtilities", ["BulkEmailHyperlinkCorrector", "DynamicContentContractBuilder",
	...
	Ext.define("BPMSoft.configuration.DynamicContentUtilities", {
			extend: "BPMSoft.BaseObject",
			alternateClassName: "BPMSoft.DynamicContentUtilities",
			 ...
			 * @type {Boolean}
			 */
			_isDynamicContentEnabled: BPMSoft.Features.getIsEnabled("BulkEmailDynamicContentBuilder"),
			 ...
			 * @return {BPMSoft.BaseViewModel} Content builder view model.
			 */
			...
			getDcTemplateContract: function(recordId, templateJson) {
				...
				BPMSoft.each(contract.Replicas, function(replica) {
			...
			saveDynamicContentTemplate: function(recordId, templateConfigText, callback, scope) {
				...
				var templateJson = BPMSoft.decode(templateConfigText);
	...
	return Ext.create("BPMSoft.DynamicContentUtilities");
});
