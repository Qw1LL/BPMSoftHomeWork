define("MobileRecordDesignerSettings", ["ext-base", "MobileRecordDesignerSettingsResources", "MobileDesignerUtils",
	...
	function(Ext, resources, MobileDesignerUtils) {
		...
		/**
		 * @class BPMSoft.configuration.MobileBaseDesignerSettings
		 * ##### ######### ######## #########.
		 */
		var module = Ext.define("BPMSoft.configuration.MobileRecordDesignerSettings", {
			alternateClassName: "BPMSoft.MobileRecordDesignerSettings",
			...
			/**
			 * @inheritDoc BPMSoft.MobileBaseDesignerSettings#initializeCaptionValues
			 * @protected
			 * @overridden
			 */
			...
			/**
			 * @inheritDoc BPMSoft.MobileBaseDesignerSettings#removeItem
			 * @overridden
			 */
			...
			/**
			 * @inheritDoc BPMSoft.MobileBaseDesignerSettings#applyItem
			 * @overridden
			 */
