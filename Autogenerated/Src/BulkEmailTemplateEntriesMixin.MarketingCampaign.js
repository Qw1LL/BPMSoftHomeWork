define("BulkEmailTemplateEntriesMixin", ["BulkEmailHyperlinkCorrector", "DynamicContentContractBuilder",
	...
	function(BulkEmailHyperlinkCorrector, ContractBuilder, ServiceHelper) {
		Ext.define("BPMSoft.configuration.BulkEmailTemplateEntriesMixin", {

			alternateClassName: "BPMSoft.BulkEmailTemplateEntriesMixin",
			...
			getDcTemplateContract: function(bulkEmailId, templateJson, replicaHeaders) {
				if (this.$IsWizardMode) {
					var headersReplicaBuilder = Ext.create("BPMSoft.DynamicHeadersReplicaBuilder");
			 ...
			 * @protected
			 * @param {String} bulkEmailId Bulk email identifier.
			 * @param {BPMSoft.Collection} headersCollection Bulk email replica headers collection.
			...
			getDcTemplateHeadersSaveContract: function(bulkEmailId, headersCollection, templateSaveContract) {
				...
				var headers = [];
				BPMSoft.each(actualHeaders, function(header) {
					headers.push({
			 ...
			 * @param {BPMSoft.Collection} headers Bulk email replica headers collection.
			 */
