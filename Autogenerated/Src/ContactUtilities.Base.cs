	...
	public static class ContactUtilities
	{
		...
		private static EntitySchemaQuery GetContactCommunicationsEsq(UserConnection userConnection, Guid contactId) {
			...
			contactEmailsESQ.Filters.Add(contactEmailsESQ.CreateFilterWithParameters(FilterComparisonType.Equal,
				"CommunicationType", Guid.Parse(BPMSoft.Configuration.CommunicationTypeConsts.EmailId)));
		...
		public static List<Guid> FindContactsByEmail(string email, UserConnection userConnection) {
			...
			contactCommunicationESQ.Filters.Add(
				...
				Guid.Parse(BPMSoft.Configuration.CommunicationTypeConsts.EmailId)));
		...
		public static string FindContactEmail(UserConnection userConnection, Guid contactId, string domain) {
			domain = "@" + domain;
			string email = string.Empty;
			var communicationTypeContact = Guid.Parse(BPMSoft.Configuration.CommunicationTypeConsts.EmailId);
		...
		/// </summary>
		/// <param name="contact"><see cref="BPMSoft.Configuration.Contact"/> instance.</param>
		/// <param name="converter"><see cref="IContactFieldConverter"/> implementation.</param>
		...
		public static IContactFieldConverter GetContactConverter(UserConnection userConnection) {
			object converterIdValue = BPMSoft.Core.Configuration.SysSettings.GetValue(userConnection, "ContactFieldConverter");
