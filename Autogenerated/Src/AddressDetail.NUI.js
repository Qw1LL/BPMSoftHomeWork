define("AddressDetail", ["ext-base", "BPMSoft", "sandbox", "ContactAddress", "AccountAddress",
	"AddressDetailStructure", "AddressDetailResources", "LookupUtilities"], function(Ext, BPMSoft, sandbox,
	...
	structure.userCode = function() {
		...
		this.methods.initItem = function() {
			BPMSoft.each(["Country", "Region", "City"], function(columnName) {
