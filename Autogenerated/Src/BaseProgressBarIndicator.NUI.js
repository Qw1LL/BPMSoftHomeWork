define("BaseProgressBarIndicator", ["ext-base", "CompletenessMenu", "CompletenessMenuItem"],
		function(Ext) {
			...
			/**
			 * @class BPMSoft.controls.BaseProgressBarIndicator
			 * Progress bar component base class.
			 */
			Ext.define("BPMSoft.controls.BaseProgressBarIndicator", {
				alternateClassName: "BPMSoft.BaseProgressBarIndicator",
				 ...
				 * @type {String[]}
				 */
				sectorsColors: ["#FF4800", "#FFAE00", "#33B864"],
				...
				/**
				 * Returns the binding configuration to the model. Implements mixin interface {@link BPMSoft.Bindable}.
				 * @overridden
				 */
			...
			return BPMSoft.BaseProgressBarIndicator;
		}
);
