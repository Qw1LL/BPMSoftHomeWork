define("LabelDateEdit", ["ext-base", "BPMSoft", "sandbox",
		"LabelDateEditResources"],
	function(Ext, BPMSoft, sandbox, resources) {
		/**
		 * @class BPMSoft.controls.LabelDateEdit
		 * ##### ######## ########## ###### ####
		 */
		var LabelDateEdit = Ext.define("BPMSoft.controls.LabelDateEdit", {
			extend: "BPMSoft.DateEdit",
			alternateClassName: "BPMSoft.LabelDateEdit",
			...
			getTplData: function() {
				...
				var labelTplData = {
					...
					caption: BPMSoft.utils.string.encodeHtml(this.caption)
				};
				var inputId = this.inputId;
				labelTplData.inputId = inputId
					? "for = \"" + BPMSoft.utils.string.encodeHtml(inputId) + "\""
					: "";
