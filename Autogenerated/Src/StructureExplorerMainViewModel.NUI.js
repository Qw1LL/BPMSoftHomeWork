define("StructureExplorerMainViewModel", [
	 ...
	 */
	Ext.define("BPMSoft.configuration.StructureExplorerMainViewModel", {
		extend: "BPMSoft.model.BaseViewModel",
		alternateClassName: "BPMSoft.StructureExplorerMainViewModel",
		...
		_createItemViewModel: function() {
			const item = new BPMSoft.StructureExplorerViewModelItem({
		...
		constructor: function() {
			...
			this.viewModelCollection = new BPMSoft.BaseViewModelCollection();
		...
		initRootSchema: function(callback, scope) {
			...
			EntityStructureHelper.getItemCaption(this.rootItemIdentifier, function(name) {
				...
				if (BPMSoft[paramSchemaName]) {
					this.set("entitySchema", BPMSoft[paramSchemaName]);
				}
	...
	return BPMSoft.StructureExplorerMainViewModel;
});
