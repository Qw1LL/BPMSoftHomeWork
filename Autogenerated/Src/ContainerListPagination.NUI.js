/**
 * @class BPMSoft.controls.ContainerListPagination
 * @extends BPMSoft.controls.ContainerList
 * Class capable of hiding elements of its collection.
 */
define("ContainerListPagination", ["ContainerList"], function() {
	Ext.define("BPMSoft.controls.ContainerListPagination", {
		extend: "BPMSoft.ContainerList",
		alternateClassName: "BPMSoft.ContainerListPagination",
		...
		/**
		 * @inheritdoc  BPMSoft.controls.ContainerList#getBindConfig
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.ContainerList#getItemView
		 * @overridden
		 */
	...
	return BPMSoft.ContainerListPagination;
});
