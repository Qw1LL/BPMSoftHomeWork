define("GridSettingsV2", ["GridSettingsV2Resources", "ConfigurationConstants",
		...
		function(resources, ConfigurationConstants, MaskHelper, StructureExplorerUtilities, viewGenerator,
			...
			/**
			 * @class BPMSoft.configuration.GridSettings
			 * ##### GridSettings ############ ### ######### ######## ####### ########
			 */
			Ext.define("BPMSoft.configuration.GridSettings", {
				alternateClassName: "BPMSoft.GridSettings",
				...
				loadProfile: function(profile) {
					...
					var viewModelConfig = viewModelGenerator.generate({
						...
						GridType: this.isTiled ? this.BPMSoft.GridType.TILED : this.BPMSoft.GridType.LISTED
					});
				...
				changeGridType: function() {
					this.isTiled = (this.viewModel.get("GridType") === this.BPMSoft.GridType.TILED);
