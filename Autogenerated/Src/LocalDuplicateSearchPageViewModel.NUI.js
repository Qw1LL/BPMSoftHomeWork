define("LocalDuplicateSearchPageViewModel", [
	...
	Ext.define("BPMSoft.LocalDuplicatesViewModel", {
	...
	function onDuplicatesIdLoad() {
		...
		var esq = Ext.create("BPMSoft.EntitySchemaQuery", {rootSchemaName: entitySchemaName});
		this.addColumns(esq);
	...
	function addColumns(esq) {
		...
		esq.addColumn("Name");
		esq.addColumn("Owner");
		BPMSoft.each(additionalColumns, function(column) {
