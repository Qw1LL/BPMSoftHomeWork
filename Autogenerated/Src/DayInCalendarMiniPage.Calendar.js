		...
		function(resources, ViewUtilities) {
			return {
				...
				attributes: {
					 ...
					 */
					"MiniPageModes": {
						"value": [this.BPMSoft.ConfigurationEnums.CardOperation.EDIT]
					},
					/**
				...
				methods: {
					...
					createIntervalViewModel: function(visible, from, to) {
						var viewModel = Ext.create("BPMSoft.BaseViewModel", {
							values: {
								Id: this.BPMSoft.utils.guid.generateGUID(),
					...
					getVisibleIntervalCount: function() {
						var intervalsCollection = this.getCollection("IntervalsCollection");
						var count = 0;
						this.BPMSoft.each(intervalsCollection.getItems(), function(item) {
					...
					getIntervalItemConfig: function(itemConfig, item) {
						...
						var removeButtonConfig = {
							...
							"imageConfig": this.get("Resources.Images.AddButtonImage"),
					 ...
					 * @protected
					 * @param {Object} item Interval.
					 * @return {BPMSoft.Query} Insert query.
					 */
					insertIntervalQuery: function(item) {
						var insert = this.Ext.create("BPMSoft.InsertQuery", {
							rootSchemaName: "WorkingTimeInterval"
						});
						insert.setParameterValue("Id", item.get("Id"), this.BPMSoft.DataValueType.GUID);
						insert.setParameterValue(this.entitySchemaName, this.get("PrimaryColumnValue"),
								this.BPMSoft.DataValueType.GUID);
						insert.setParameterValue("To", item.get("ToValue"), this.BPMSoft.DataValueType.DATE_TIME);
						insert.setParameterValue("From", item.get("FromValue"), this.BPMSoft.DataValueType.DATE_TIME);
						return insert;
					},
					...
					updateIntervalQuery: function(item) {
						...
						update.setParameterValue("To", item.get("ToValue"), this.BPMSoft.DataValueType.DATE_TIME);
						update.setParameterValue("From", item.get("FromValue"), this.BPMSoft.DataValueType.DATE_TIME);
