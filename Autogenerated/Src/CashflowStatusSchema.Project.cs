namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class CashflowStatusSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Состояние операции.
	/// </summary>
	public class CashflowStatus : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class CashflowStatus_ProjectEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CashflowStatus
	{
