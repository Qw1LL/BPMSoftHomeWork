define("EmailUtilitiesV2", ["ext-base", "BPMSoft", "EmailUtilitiesV2Resources", "ConfigurationServiceProvider"],
	function(Ext, BPMSoft, resources) {
		...
		function removeHtmlTags(value) {
			...
			BPMSoft.each(regexArray, function(item) {
		...
		Ext.define("BPMSoft.EmailUtilities", {
			extend: "BPMSoft.BaseObject",
			send: send,
			removeHtmlTags: removeHtmlTags
		});
		return Ext.create("BPMSoft.EmailUtilities");
	});
