define("EmailHelper", ["ext-base", "BPMSoft", "EmailHelperResources"],
		function(Ext, BPMSoft, resources) {

			/**
			 * @class BPMSoft.configuration.EmailHelper
			 * Utilities class email validation.
			 */
			Ext.define("BPMSoft.configuration.EmailHelper", {
				extend: "BPMSoft.BaseObject",
				alternateClassName: "BPMSoft.EmailHelper",
				 ...
				 */
				init: function() {
					BPMSoft.SysSettings.querySysSettings(["EmailPattern"], function(sysSettings) {
				...
				getEmailValidator: function(value) {
					return {
						invalidMessage: (value && !BPMSoft.EmailHelper.isEmailAddress(value))
