namespace BPMSoft.Configuration.Packages.Case
{
	using System;
	using System.IO;
	...
	public class CaseEntityFileCopier : IEntityFileCopier
	{
		...
		/// <summary>
		/// File repository <see cref="BPMSoft.Configuration.FileRepository"/>
		/// </summary>
		...
		/// </summary>
		/// <param name="userConnection">User connection.</param>
		/// <param name="fileRepository">File repository <see cref="BPMSoft.Configuration.FileRepository"/></param>
