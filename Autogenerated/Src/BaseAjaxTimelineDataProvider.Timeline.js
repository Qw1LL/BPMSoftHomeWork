define("BaseAjaxTimelineDataProvider", ["BaseTimelineDataProvider"], function() {
	 ...
	 */
	Ext.define("BPMSoft.configuration.BaseAjaxTimelineDataProvider", {
		extend: "BPMSoft.BaseTimelineDataProvider",
		alternateClassName: "BPMSoft.BaseAjaxTimelineDataProvider",
		...
		/**
		 * @inheritdoc BPMSoft.BaseTimelineDataProvider#loadDataBySearchResult
		 * @override
		 */
		...
		abortRequest: function() {
			...
			if (requestId) {
				BPMSoft.AjaxProvider.abortRequestByInstanceId(requestId);
			}
			this.requestId = null;
		},
		...
		/**
		 * @inheritdoc BPMSoft.BaseTimelineDataProvider#abort
		 * @override
		 */
		abort: function() {
			this.abortRequest();
