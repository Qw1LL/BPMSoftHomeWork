define("FolderFilterItemViewModel", ["FolderFilterItemViewModelResources", "ConfigurationConstants",
	...
	/**
	 * @class BPMSoft.configuration.FolderFilterItemViewModel
	 * Folder filter item viewModel.
	 */
	Ext.define("BPMSoft.configuration.FolderFilterItemViewModel", {
		extend: "BPMSoft.BaseViewModel",
		alternateClassName: "BPMSoft.FolderFilterItemViewModel",
		...
		_findGridDataItemByName: function(name) {
			...
			var parent = this.get("Parent");
			var parentId = parent && parent.value || BPMSoft.GUID_EMPTY;
	...
	return BPMSoft.FolderFilterItemViewModel;
});
