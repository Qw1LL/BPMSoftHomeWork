define("DCTemplateReplicaRepository", ["ServiceHelper"], function(ServiceHelper) {
	/**
	 * @class BPMSoft.configuration.DCTemplateReplicaRepository
	 */
	Ext.define("BPMSoft.configuration.DCTemplateReplicaRepository", {
		alternateClassName: "BPMSoft.DCTemplateReplicaRepository",
		...
		destroy: function() {
			this.destroyed = true;
			BPMSoft.each(this.requestData, function(requestObject) {
