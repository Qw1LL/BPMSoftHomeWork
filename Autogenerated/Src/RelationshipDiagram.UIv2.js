...
define("RelationshipDiagram", ["RelationshipDiagramResources", "ej-diagram",
		...
		function(resources) {
			 ...
			 * ######, ########### ########## ### ######### ######### ## ##### #########.
			 */
			Ext.define("BPMSoft.diagram.userHandles.RelationshipNodeSelectionTool", {
				extend: "BPMSoft.NodeSelectionTool",
				alternateClassName: "BPMSoft.RelationshipNodeSelectionTool",
				...
				/**
				 * @inheritdoc BPMSoft.NodeSelectionTool#getNodeSelectionTool
				 * @overridden
				 */
				...
				/**
				 * @inheritdoc BPMSoft.NodeSelectionTool#nodeSelectionRenderUserHandle
				 * @overridden
				 */
			 ...
			 * ######, ########### ########## ### ######## ######### ## ##### #########.
			 */
			Ext.define("BPMSoft.diagram.userHandles.RelationshipNodeRemoveTool", {
				extend: "BPMSoft.NodeRemoveTool",
				alternateClassName: "BPMSoft.RelationshipNodeRemoveTool",
				...
				*/
				...
				/**
				 * @inheritdoc BPMSoft.NodeRemoveTool#getNodeRemoveTool
				 * @overridden
				 */
				...
				/**
				 * @inheritdoc BPMSoft.NodeRemoveTool#nodeRemoveTool
				 * @overridden
				 */
				...
				/**
				 * @inheritdoc BPMSoft.NodeRemoveTool#nodeRemoveRenderUserHandle
				 * @overridden
				 */
			 ...
			 * ######, ########### ########## ### ########## ######### ## ##### #########.
			 */
			Ext.define("BPMSoft.diagram.userHandles.RelationshipNodeAddTool", {
				alternateClassName: "BPMSoft.RelationshipNodeAddTool",
				...
				*/
				...
				getNodeAddTool: function() {
					...
					var addNodeHandle = this.nodeAddHandle = ej.Diagram.UserHandle({
						...
						constraint: BPMSoft.diagram.ToolsConstraint.NodeAddTool,
				...
				customSelectTool: function(base) {
					...
					tool.prototype.mouseup = function(evt) {
						...
						if (diagram.selectionList.length === 1 && model) {
							...
							if (!selectedNode.parentId || selectedNode.parentId === BPMSoft.GUID_EMPTY) {
					...
					tool.prototype.prepareLookup = function() {
						var diagram = this.diagram;
						var lookupNode;
						BPMSoft.each(diagram.nodes(), function(node) {
							if (node.lookup) {
								lookupNode = node;
								return false;
							}
			...
			/**
			 * @class BPMSoft.configuration.RelationshipDiagram
			 * ##### ######### ############.
			 */
			Ext.define("BPMSoft.configuration.RelationshipDiagram", {
				extend: "BPMSoft.Diagram",
				alternateClassName: "BPMSoft.RelationshipDiagram",

				mixins: {
					nodeSelectionTool: "BPMSoft.RelationshipNodeSelectionTool",
					nodeRemoveTool: "BPMSoft.RelationshipNodeRemoveTool",
					nodeAddTool: "BPMSoft.RelationshipNodeAddTool"
				},
				...
				nodePortsTemplate: function(node) {
					BPMSoft.each(node.ports, function(port) {
						port.visibility = port.visibility || ej.Diagram.PortVisibility.Hidden;
					}, this);
				},

				/**
				 * @inheritdoc BPMSoft.Diagram#setDefaults
				 * @overridden
				 */
				...
				/**
				 * @inheritdoc BPMSoft.Diagram#customizeDiagram
				 * @overridden
				 */
				...
				customizeWrapText: function() {
					...
					ej.Diagram.SvgContext._wrapText = function(node, textBBox, text, label, svg) {
						...
						if (childNodes && (str.length > 0)) {
							...
							var maxLineCount = BPMSoft.getIsRtlMode() ? 2 : 3;
				...
				customizeRenderLookup: function() {
					...
					svgContext._renderLookup = function(node, svg) {
						...
						if (model && !node.lookup && node.lookupConfig) {
							...
							var lookupEdit = Ext.create("BPMSoft.LookupEdit",
				...
				/**
				 * @inheritdoc BPMSoft.Diagram#disableKeys
				 * @overridden
				 */
				...
				/**
				 * @inheritdoc BPMSoft.Diagram#onDestroy
				 * @overridden
				 */
				onDestroy: function() {
					var diagram = this.diagram;
				...
				renderToolContextMenu: function(handle) {
					...
					BPMSoft.each(handle.contextMenu.items, function(menuItem) {
