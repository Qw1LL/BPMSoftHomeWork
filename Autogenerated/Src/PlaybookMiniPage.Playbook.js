 define("PlaybookMiniPage", ["css!PlaybookSectionActionDashboardCSS", "PlaybookIframeControl"], function() {
	return {
		...
		attributes: {
			...
			"MiniPageModes": {
				"value": [
					this.BPMSoft.ConfigurationEnums.CardOperation.VIEW
				]
			},
		},
		properties: {
		...
		methods: {
			...
			getFrameContent: function() {
				return this.BPMSoft.sanitizeHTML(this.$Notes);
			},
				...
				"values": {
					"generator": function() {
						return {
							...
							"className": "BPMSoft.PlaybookIframeControl",
