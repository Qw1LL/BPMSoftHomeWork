define("MarketingCalendar", ["MarketingCalendarItem", "css!MarketingCalendar"],
	function() {
		Ext.define("BPMSoft.controls.MarketingCalendar", {
			alternateClassName: "BPMSoft.MarketingCalendar",
			 ...
			 * @type {String}
			 */
			itemClassName: "BPMSoft.MarketingCalendarItem",

			/**
			 * Class that draw data grid
			 * @protected
			 */
			dataGridClassName: "BPMSoft.MarketingCalendarGrid",
			...
			/**
			 * @inheritdoc BPMSoft.GridLayoutTableEdit#cellHeingt
			 * @overridden
			 */
			cellHeight: 72,

			/**
			 * @inheritdoc BPMSoft.GridLayoutTableEdit#generateRow
			 * @overridden
			 * @returns {String} - HTML
			 */
			...
			/**
			 * @inheritdoc BPMSoft.GridLayoutEdit#getItemsMaxRow
			 * @overridden
			 */
			...
			/**
			 * ########## ####### "add" ######### BPMSoft.BaseViewModelCollection.
			 * @overridden
			 * @inheritdoc BPMSoft.GridLayoutEditItem#onItemAdd
