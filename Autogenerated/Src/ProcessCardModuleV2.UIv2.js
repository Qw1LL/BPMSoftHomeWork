define("ProcessCardModuleV2", ["ProcessHelper", "UserQuestionProcessPageV2Utilities", "AutoGeneratedPageV2Utilities",
	...
	/**
	 * @class BPMSoft.configuration.ProcessCardModule
	 * Class using for create card module by process.
	 */
	Ext.define("BPMSoft.configuration.ProcessCardModule", {
		alternateClassName: "BPMSoft.ProcessCardModule",
		extend: "BPMSoft.CardModule",
		...
		destroy: function(config) {
			...
			const messages = this.BPMSoft.keys(this._messages);
		...
		/**
		 * @inheritdoc BPMSoft.CardModule#initSchemaName
		 * @override
		 */
		...
		_initProcessCard: function(callback) {
			...
			BPMSoft.ProcessModuleUtilities.tryShowProcessCard.call(this, config);
		},
		...
		setPrcExecDataParameters: function() {
			...
			this.BPMSoft.each(this.prcExecData.parameters, function(param, name) {
		...
		initPrcExecData: function(callback) {
			...
			if (BPMSoft.ProcessExecutionDataUtils.getIsElementCompleted(procElUId)) {
				this.log(Ext.String.format("Element {0} completed already, navigating back",
					procElUId), BPMSoft.LogMessageType.WARNING);
		...
		_addTaskExecutionDetailButton: function(executionData, customDiff) {
			if (this._getIsTaskExecutionDetailsSupported(executionData)) {
				...
				const taskDetailsButtonDiff = BPMSoft.ProcessModuleUtilities
		...
		/**
		 * @inheritdoc BPMSoft.CardModule#getIsSeparateMode
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.ProcessCardModuleMixin#getCanTryShowProcessCard
		 * @override
		 */
	...
	return BPMSoft.ProcessCardModule;
});
