define("ActivityDetailV2", ["BPMSoft", "ProcessModuleUtilities", "ConfigurationConstants"],
		function(BPMSoft, ProcessModuleUtilities, ConfigurationConstants) {
			return {
				/**
				 * Entity schema name.
				 * @type {String}
				...
				methods: {
					...
					/**
					 * @inheritdoc BPMSoft.ActivitySectionV2#getFilters
					 * @overridden
					 */
					getFilters: function() {
						...
						filters.add("NotEmailFilter", this.BPMSoft.createColumnFilterWithParameter(
							this.BPMSoft.ComparisonType.NOT_EQUAL, "Type", activityTypes.Email));
						return filters;
					},
					...
					initEditPages: function() {
						...
						this.BPMSoft.each(editPages.getItems(), function(item) {
							...
							if (!BPMSoft.contains(exceptActivityTypes, itemId)) {
