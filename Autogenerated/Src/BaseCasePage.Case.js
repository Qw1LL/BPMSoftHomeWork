				...
				"Status": {
					lookupListConfig: {
						...
						filter: function() {
							...
							filterGroup.add("StatusFilter", BPMSoft.createColumnFilterWithParameter(
								BPMSoft.ComparisonType.EQUAL,
								"[CaseNextStatus:NextStatus].Status", this.get("OriginalStatus").value));
							filterGroup.add("StatusFilterCurrent", BPMSoft.createColumnFilterWithParameter(
								BPMSoft.ComparisonType.EQUAL,
				...
				"SatisfactionLevel": {
					lookupListConfig: {
						...
						orders: [
							{
								columnPath: "Point",
								direction: BPMSoft.OrderDirection.DESC
							}
						]
					}
				},
