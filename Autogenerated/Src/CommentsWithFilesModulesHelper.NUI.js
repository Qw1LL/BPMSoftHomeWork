define('CommentsWithFilesModulesHelper', ['ext-base', 'BPMSoft', 'CommentsWithFilesModulesHelperResources',
	'FileHelper'], function(Ext, BPMSoft, resources, FileHelper) {
		function getViewConfig(UId) {
			var fileButtonConfig = BPMSoft.deepClone(FileHelper.addFileButtonConfig);
					...
					items: [
						...
						},
						{
							...
							html: '<img id="' + 'selectedItemImage' + UId +
								...
								BPMSoft.ImageUrlBuilder.getUrl(resources.localizableImages.SelecteItemImage) + '"/>',
							selectors: {
			...
			var config = {
				methods: {
					...
					getFilesSelect: function(KnowledgeBaseId) {
						...
						select.addAggregationSchemaColumn('KnowledgeBase', BPMSoft.AggregationType.COUNT,
