define("HierarchicalRecordsUtilities", [],
		function() {
			var HierarchicalRecordsUtilitiesClass =
					this.Ext.define("BPMSoft.configuration.mixins.HierarchicalRecordsUtilities", {

						alternateClassName: "BPMSoft.HierarchicalRecordsUtilities",
						...
						createParentFilters: function(childrenCollection) {
							...
							var notChildrenFilter = this.BPMSoft.createColumnInFilterWithParameters("Id", childrenCollection);
							notChildrenFilter.comparisonType = this.BPMSoft.ComparisonType.NOT_EQUAL;
