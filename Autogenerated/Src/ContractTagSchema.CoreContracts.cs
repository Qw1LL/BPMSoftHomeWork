namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ContractTagSchema : BPMSoft.Configuration.BaseTagSchema
	{
	...
	/// <summary>
	/// Тег раздела договоры.
	/// </summary>
	public class ContractTag : BPMSoft.Configuration.BaseTag
	{
	...
	/// <exclude/>
	public partial class ContractTag_CoreContractsEventsProcess<TEntity> : BPMSoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ContractTag
	{
