define('EditPageDesignerViewGenerator', ['ext-base', 'BPMSoft', 'sandbox', 'CardViewGenerator', 'ConfigurationEnums',
'EditPageDesignerViewGeneratorResources', 'EditPageDesignerHelper', 'ColumnHelper'],
function(Ext, BPMSoft, sandbox, CardViewGenerator, ConfigurationEnums,
	resources, EditPageDesignerHelper, ColumnHelper) {

	Ext.define('BPMSoft.Configuration.EditPageDesignerViewGenerator', {
		alternateClassName: 'BPMSoft.EditPageDesignerViewGenerator',
		extend: 'BPMSoft.CardViewGenerator',
		...
		getTabbedContainerConfig: function(schemaItem) {
			...
			if (schemaItemType === BPMSoft.ViewModelSchemaItem.GROUP) {
				wrapClasses.push('ts-controlgroup-wrap');
			}
			if (schemaItemType === BPMSoft.ViewModelSchemaItem.DETAIL) {
	...
	var editPageViewGenerator = Ext.create('BPMSoft.EditPageDesignerViewGenerator');
