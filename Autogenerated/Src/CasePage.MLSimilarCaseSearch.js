	...
	return {
		...
		methods: {
			...
			initSimilarCaseText: function() {
				...
				select.addAggregationSchemaColumn("Id", BPMSoft.AggregationType.COUNT, "Count");
			...
			getFoundSimilarCasesIcon: function() {
				return this.BPMSoft.ImageUrlBuilder.getUrl(this.get("Resources.Images.SimilarCasesFoundIcon"));
			}
		},
		attributes: {
