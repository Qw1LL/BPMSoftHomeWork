define("SourceCodeEditMixin", ["ext-base", "BPMSoft", "SourceCodeEditEnums", "SourceCodeEditMixinResources",
	"SourceCodeEdit", "css!SourceCodeEditMixin"],
	function(Ext, BPMSoft, sourceCodeEditEnums, resources) {
		/**
		 * @class BPMSoft.controls.mixins.SourceCodeEditMixin
		 * Class of source code edit mixin.
		 */
		Ext.define("BPMSoft.controls.mixins.SourceCodeEditMixin", {
			alternateClassName: "BPMSoft.SourceCodeEditMixin",
			...
			renderSourceCodeEditModalBoxWrap: function() {
				...
				this.sourceCodeEditContainer = Ext.create("BPMSoft.Container", config);
			...
			initSourceCodeEdit: function() {
				...
				if (!this.sourceCodeEdit && el) {
					...
					this.sourceCodeEdit = Ext.create("BPMSoft.SourceCodeEdit", config);
			 ...
			 */
			loadSourceCodeValue: BPMSoft.abstractFn,
			 ...
			 * @param {String} Source.
			 */
			saveSourceCodeValue: BPMSoft.abstractFn,
