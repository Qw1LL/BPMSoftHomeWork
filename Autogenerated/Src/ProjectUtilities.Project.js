define("ProjectUtilities", ["ProjectUtilitiesResources"], function(resources) {
	...
	Ext.define("BPMSoft.configuration.mixins.ProjectUtilities", {
		extend: "BPMSoft.BaseObject",
		alternateClassName: "BPMSoft.ProjectUtilities",

		projectServiceTimeout: 5 * 60 * 1000,

		projectServiceName: "ProjectService",

		callService: BPMSoft.emptyFn,
		 ...
		 */
		init: function() {
			this.BPMSoft.each(resources.localizableStrings, function(item, key) {
				this.set("Resources.Strings." + key, item);
			}, this);
			this.BPMSoft.each(resources.localizableImages, function(item, key) {
	...
	return BPMSoft.ProjectUtilities;
});
