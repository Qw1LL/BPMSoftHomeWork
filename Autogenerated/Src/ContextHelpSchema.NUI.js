	...
	return {
		...
		methods: {
			...
			init: function(callback, scope) {
				...
				this.callParent([
					function() {
						...
						this.BPMSoft.SysSettings.querySysSettings(sysSettingsNameArray, function(values) {
			...
			getEmailParameters: function(mailActionType, callback, scope) {
				...
				var parameters = {};
				this.BPMSoft.SysSettings.querySysSettings(sysSettingsNameArray,
						function(values) {
							if (values) {
								parameters = {
			...
			prepareEmailConfig: function(mailActionType, callback, scope) {
				this.getEmailParameters(mailActionType, function(parameters) {
					this.getUrlParameters(function(urlParameters) {
						...
						var product = encodeURIComponent(this.Ext.util.Format.htmlDecode(parameters.ProductName) || "");
