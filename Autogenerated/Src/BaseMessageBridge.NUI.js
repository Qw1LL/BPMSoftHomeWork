		...
		return {
			...
			methods: {
				...
				publishSocketMessages: function(sender, webSocketMessage) {
					...
					this.BPMSoft.each(messageConfigs, function(messageConfig) {
				...
				getServerChannelResponseObject: function(response) {
					return this.Ext.create("BPMSoft.BaseServerChannelResponse", {
						message: response
					});
				},
				...
				publishSavedMessages: function(sandboxMessageName) {
					...
					this.BPMSoft.each(savedMessages, function(message) {
				 ...
				 * @virtual
				 */
				saveMessageToHistory: this.BPMSoft.emptyFn,
				 ...
				 * @virtual
				 */
				deleteSavedMessages: this.BPMSoft.emptyFn,
				 ...
				 * @virtual
				 */
				getMessagesFromHistory: this.BPMSoft.emptyFn
			}
		};
	});
