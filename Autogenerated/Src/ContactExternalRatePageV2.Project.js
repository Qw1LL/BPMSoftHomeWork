define("ContactExternalRatePageV2", ["BPMSoft", "BusinessRuleModule", "ext-base", "sandbox", "StorageUtilities"],
			...
			return {
				...
				methods: {
					...
					checkOnSave: function(datesChecked) {
						...
						var select = Ext.create("BPMSoft.EntitySchemaQuery", {rootSchemaName: "ContactExternalRate"});
