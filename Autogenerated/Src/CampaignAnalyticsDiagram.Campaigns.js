define("CampaignAnalyticsDiagram", ["CampaignEnums", "process-schema-diagram", "DiagramNodeBadgeMixin"],
	...
	Ext.define("BPMSoft.configuration.CampaignAnalyticsDiagram", {
		extend: "BPMSoft.ProcessSchemaDiagram",
		alternateClassName: "BPMSoft.CampaignAnalyticsDiagram",
		...
		mixins: {
			nodeBadge: "BPMSoft.DiagramNodeBadgeMixin"
		},
		...
		/**
		 * @inheritdoc BPMSoft.Designers.ProcessSchemaDiagram#init
		 * @override
		 */
		init: function() {
			this.readOnly = true;
		...
		/**
		 * @inheritdoc BPMSoft.Designers.ProcessSchemaDiagram#disableDiagramFeatures
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Designers.ProcessSchemaDiagram#changeNodeConnectorsSelection
		 * @override
		 */
