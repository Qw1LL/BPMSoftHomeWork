define('FileListModule', ['ext-base', 'BPMSoft', 'sandbox', 'FileListModuleResources',
	'FileListViewGenerator', 'FileListViewModelGenerator'],
	function(Ext, BPMSoft, sandbox, resources, viewGenerator, viewModelGenerator) {
		function createConstructor(context) {
			...
			function reRender(renderTo) {
				...
				view = Ext.create(config.className || 'BPMSoft.Container', viewConfig);
				view.bind(this);
