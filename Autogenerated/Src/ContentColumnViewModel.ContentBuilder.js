define("ContentColumnViewModel", ["ContentColumnViewModelResources", "BaseContentBlockViewModel",
	...
	function(resources) {
		 ...
		 */
		Ext.define("BPMSoft.controls.ContentColumnViewModel", {
			extend: "BPMSoft.controls.BaseContentBlockViewModel",
			alternateClassName: "BPMSoft.ContentColumnViewModel",
			 ...
			 * @type {String}
			 */
			className: "BPMSoft.ContentColumn",
			...
			childItemTypes: {
				...
				text: "BPMSoft.ContentMjTextElementViewModel",
				mjimage: "BPMSoft.ContentMjImageElementViewModel",
				mjbutton: "BPMSoft.ContentMjButtonElementViewModel",
				mjdivider: "BPMSoft.ContentMjDividerElementViewModel",
				navbar: "BPMSoft.ContentNavbarElementViewModel",
				spacer: "BPMSoft.ContentSpacerElementViewModel"
			},
			...
			getViewConfig: function() {
				...
				Ext.apply(config, {
					...
					"dropGroupName": [BPMSoft.ContentBuilder.constants.ElementDropGroup]
				});
				return config;
			},
			 ...
			 * @protected
			 * @param {BPMSoft.model.BaseViewModel} element The insertion element.
			 */
		...
		return BPMSoft.ContentColumnViewModel;
	}
);
