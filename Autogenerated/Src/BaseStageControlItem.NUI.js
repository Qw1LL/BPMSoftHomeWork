define("BaseStageControlItem", ["ext-base"], function(Ext) {
	Ext.define("BPMSoft.controls.BaseStageControlItem", {
		extend: "BPMSoft.Button",
		alternateClassName: "BPMSoft.BaseStageControlItem",
		...
		generateItemStyle: function() {
			...
			if (this.displayColor) {
				style =  Ext.String.format("background-color:{0}; border-color:{0}", this.displayColor); //https://jira-ax.norbit.ru/browse/CREAT-8439
			}
			return style;
		},

		/**
		 * @inheritdoc BPMSoft.Button#getTplData
		 * @overriden
		 */
		getTplData: function() {
		...
		/**
		 * @inheritdoc BPMSoft.Button#updateSelectors
		 * @overridden
		 */
		...
		setItemHoverStyles: function(wrapClass) {
			...
			BPMSoft.reCreateStyleSheet(stageNotPassedSelector, "background-color", hoverColor, "notPassedStyle");
			BPMSoft.reCreateStyleSheet(stageNotPassedAfterSelector, borderColorCSS, hoverColor,
				"notPassedAfterStyle");
			BPMSoft.reCreateStyleSheet(stagePassedSelector, "background-color", hoverColor + "!important",
				"passedStyle");
			BPMSoft.reCreateStyleSheet(stagePassedAfterSelector, borderColorCSS, hoverColor, "pasedAfterStyle");
		},
