...
define("SegmentContainerListItemViewModel", ["SegmentContainerListItemViewModelResources",
	...
	/**
	 * @class BPMSoft.configuration.SegmentContainerListItemViewModel
	 */
	Ext.define("BPMSoft.configuration.SegmentContainerListItemViewModel", {
		extend: "BPMSoft.BaseViewModel",
		alternateClassName: "BPMSoft.SegmentContainerListItemViewModel",
		...
		attributes: {
			 ...
			 */
			"Attribute": {
				dataValueType: BPMSoft.DataValueType.CUCTOM_OBJECT,
				type: BPMSoft.ViewModelColumnType.VIRTUAL_COLUMN
			},
		 ...
		 * @type {BPMSoft.DynamicContentBlockViewModel}
		 */
		source: null,
		 ...
		 * @private
		 * @param {BPMSoft.SegmentContainerListItemViewModel} item Current view model.
		 */
		 ...
		 * @private
		 */
		_onSelectedAttributeChanged: BPMSoft.debounce(function() {
			if (this.$Attribute) {
		 ...
		 * @public
		 * @param {BPMSoft.DynamicContentBlockViewModel} source Source view model for segment item.
		 */
	...
	return BPMSoft.configuration.SegmentContainerListItemViewModel;
});
