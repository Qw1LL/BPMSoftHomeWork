define("GaugeModule", ["GaugeModuleResources", "BaseWidgetModule", "HighchartsWrapper", "BaseWidgetViewModel"],
	function() {
		...
		/**
		 * @class BPMSoft.controls.GaugeChart
		 * Class of Gauge chart.
		 */
		Ext.define("BPMSoft.controls.GaugeChart", {
			extend: "BPMSoft.Chart",
			alternateClassName: "BPMSoft.GaugeChart",
			...
			validateTypes: function() {
				return BPMSoft.isArray(this.sectorsColors) && BPMSoft.isArray(this.sectorsBounds);
			},
			...
			validateData: function() {
				...
				BPMSoft.each(this.sectorsBounds, function(bound) {
			...
			_getFormat: function(value) {
				return Ext.isNumber(value) ?
					Ext.String.format("{y:{0}.0f}", BPMSoft.Resources.CultureSettings.thousandSeparator) : "{y}";
			},
			...
			/**
			 * @inheritdoc BPMSoft.Chart#getDefaultChartConfig
			 * @overridden
			 */
			...
			getRoundedBounds: function(bounds, tickInterval) {
				...
				BPMSoft.each(bounds.slice(1, bounds.length - 1), function(bound) {
			...
			/**
			 * @inheritdoc BPMSoft.Chart#getInitConfig
			 * @overridden
			 */
			getInitConfig: function() {
				...
				if (BPMSoft.getIsRtlMode() && gaugeSize >= 100) {
					...
					"yAxis": [
						{
							...
							"labels": {
								...
								formatter: function() {
									...
									BPMSoft.each(roundedBounds, function(roundedBound, i) {
		...
		/**
		 * @class BPMSoft.configuration.GaugeViewConfig
		 * Class generates configuration of Gauge module view.
		 */
		Ext.define("BPMSoft.configuration.GaugeViewConfig", {
			extend: "BPMSoft.BaseModel",
			alternateClassName: "BPMSoft.GaugeViewConfig",
			...
			generate: function(config) {
				...
				var chartId = BPMSoft.Component.generateId();
				return {
		...
		/**
		 * @class BPMSoft.configuration.GaugeViewModel
		 * Class of Gauge view model.
		 */
		Ext.define("BPMSoft.configuration.GaugeViewModel", {
			extend: "BPMSoft.configuration.BaseWidgetViewModel",
			alternateClassName: "BPMSoft.GaugeViewModel",
			...
			getReverseSectors: function() {
				return this.get("orderDirection") === BPMSoft.OrderDirection.ASC;
			}
		});

		/**
		 * @class BPMSoft.configuration.GaugeModule
		 * Class of gauge module.
		 */
		Ext.define("BPMSoft.configuration.GaugeModule", {
			extend: "BPMSoft.BaseWidgetModule",
			alternateClassName: "BPMSoft.GaugeModule",

			/**
			 * Class name of the Gauge module view model.
			 * @type {String}
			 */
			viewModelClassName: "BPMSoft.GaugeViewModel",

			/**
			 * Class name of the Gauge module view configuration.
			 * @type {String}
			 */
			viewConfigClassName: "BPMSoft.GaugeViewConfig",
