define("AlignableContainer", ["css!AlignableContainer"], function() {
	...
	/**
	 */
	Ext.define("BPMSoft.controls.AlignableContainer", {
		extend: "BPMSoft.controls.Container",
		alternateClassName: "BPMSoft.AlignableContainer",

		mixins: {
			alignable: "BPMSoft.Alignable"
		},
		...
		/**
		 * @inheritdoc BPMSoft.controls.Container#defaultRenderTpl
		 * @override
		 */
		defaultRenderTpl: [
			"<div>",
		...
		/**
		 * @inheritdoc BPMSoft.controls.Component#clearDomListeners
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.Component#setVisible
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.alignable#getAlignOrder
		 * @override
		 */
		getAlignOrder: function() {
			var orderedTypes = this.alignOrder || [
				BPMSoft.AlignType.BOTTOM,
				BPMSoft.AlignType.TOP,
				BPMSoft.AlignType.RIGHT,
				BPMSoft.AlignType.LEFT
			];
			return orderedTypes;
		},
		...
		/**
		 * @inheritdoc BPMSoft.alignable#applyAlignConfig
		 * @override
		 */
		...
		setContainerOffset: function(config) {
			...
			if (alignConfig && alignConfig.alignType) {
				...
				if (offset) {
					...
					config.offset.x = offset.x ? (BPMSoft.getIsRtlMode() ? -offset.x : offset.x) : 0;
				}
			}
		},
		...
		_getAlignTypeByPageDirection: function(alignType) {
			...
			switch (alignType) {
				case BPMSoft.AlignType.LEFT: {
					return BPMSoft.AlignType.RIGHT;
				}
				case BPMSoft.AlignType.RIGHT: {
					return BPMSoft.AlignType.LEFT;
				}
				default: {
					return alignType;
				}
