define("BpmCrmCloudServiceApi", ["ServiceHelper", "BpmCrmCloudServiceApiResources",
		"BpCloudIntegrationEnums"],
	function(ServiceHelper, resources) {
		Ext.define("BPMSoft.configuration.BpmCrmCloudServiceApi", {
			alternateClassName: "BPMSoft.BpmCrmCloudServiceApi",
			singleton: true,

			/**
			 * Calls the "UpdateUserSettings" method of the BpmCrmCloudService.
			 * @public
			...
			/**
			 * Calls the "AccountInfo" method of the BpmCrmCloudService.
			 * @public
			 * @param {Function} callback Callback function.
			 * @param {Object} scope Execution context.
			 */
			...
			/**
			 * Calls the "SenderDomainsInfo" method of the BpmCrmCloudService.
			 * @public
			 * @param {Function} callback Callback function.
			 * @param {Object} scope Execution context.
			 */
			...
			/**
			 * Calls the "AddSenderDomainForProvider" method of the BpmCrmCloudService.
			 * @public
			 * @param {Function} callback Callback function.
			 * @param {Object} scope Execution context.
			 */
			...
			/**
			 * Calls the "AddSenderDomain" method of the BpmCrmCloudService.
			 * @public
			 * @param {Object} data Parameters.
			 * @param {Function} callback Callback function.
			 * @param {Object} scope Execution context.
			...
			validateSenderDomain: function(domain, callback, scope) {
				this.senderDomainsInfo(function(response) {
					...
					var domainStatus = BPMSoft.BpCloudIntegration.enums.SenderDomainStatus;
			...
			/**
			 * Calls the "GetCheckedEmails" method of the BpmCrmCloudService.
			 * @public
			...
			/**
			 * Calls the "ValidateSender" method of the BpmCrmCloudService.
			 * @public
			 * @param {Array} emails Emails to check.
			 * @param {Function} callback Callback function.
			 * @param {Object} scope Execution context.
			...
			callService: function(methodName, data, callback, scope) {
				var config = {
					serviceName: "BpmCrmCloudService",
