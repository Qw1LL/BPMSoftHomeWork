define("MultipleInput", ["ext-base", "BPMSoft", "MultipleInputResources", "css!MultipleInput"],
		function(Ext, BPMSoft, resources) {
			 ...
			 */
			return Ext.define("BPMSoft.controls.MultipleInput", {
				extend: "BPMSoft.controls.Component",
				alternateClassName: "BPMSoft.MultipleInput",
				 ...
				 * @type {Object}
				 */
				_removeEmailImageSource: BPMSoft.ImageUrlBuilder.getUrl(resources.localizableImages.RemoveEmailIcon),
				...
				/**
				 * Extends the binding mechanism of {@link BPMSoft.Bindable} mixin events
				...
				init: function() {
					this.callParent(arguments);
					this.renderedItemsCollection = Ext.create("BPMSoft.Collection");
				...
				onRemoveItemButtonClick: function(event) {
					...
					BPMSoft.delay(this.removeItemFromDom, this, this.removeItemDelay, [emailElement]);
				},
