define("MailboxFolderSyncSettingsModule", ["sandbox", "ext-base", "BPMSoft",
	"MailboxFolderSyncSettingsModuleResources", "MaskHelper", "ServiceHelper", "ExchangeNUIConstants"],
	function(sandbox, Ext, BPMSoft, resources, MaskHelper, ServiceHelper, ExchangeNUIConstants) {
				...
				methods: {
					...
					getFoldersFromService: function() {
						...
						switch (this.get("mailServerTypeId")) {
							case ExchangeNUIConstants.MailServer.Type.Exchange:
								requestUrl = BPMSoft.workspaceBaseUrl + "/rest/ExchangeSyncService/GetMailboxFolders";
								data = {
							...
							case ExchangeNUIConstants.MailServer.Type.Imap:
								requestUrl = BPMSoft.workspaceBaseUrl + "/rest/ImapUtilitiesService/GetMailboxFolders";
								data = {
					...
					getGroupsFromBpm: function() {
						...
						select.getEntityCollection(function(response) {
							...
							var resultItems = [];
							var rootId = BPMSoft.utils.generateGUID();
							resultItems.push({
								Id: rootId,
					...
					fillGrid: function(responseItems) {
						...
						for (var i = 0; i < responseItems.length; i++) {
							...
							results[exchangeFolder.Id] = Ext.create("BPMSoft.BaseViewModel", {
								rowConfig: {
