define('SectionDesignerFinishPageModule', ['ext-base', 'BPMSoft', 'sandbox',
		'SectionDesignerFinishPageModuleResources', 'SectionDesignerUtils', 'SectionDesignDataModule',
		'SectionDesignerEnums', 'ModalBox'],
	function(Ext, BPMSoft, sandbox, resources, SectionDesignerUtils, SectionDesignDataModule, SectionDesignerEnums, ModalBox) {
		var view,
			viewModel;
