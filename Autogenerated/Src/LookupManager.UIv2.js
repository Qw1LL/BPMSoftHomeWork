define("LookupManager", ["RightUtilities", "LookupManagerItem", "AnalyticsManager"], function(RightUtilities) {
	/**
	 * @class BPMSoft.LookupManager
	 * Lookup manager class.
	 */
	Ext.define("BPMSoft.manager.LookupManager", {
		extend: "BPMSoft.AnalyticsManager",
		alternateClassName: "BPMSoft.LookupManager",
		singleton: true,
		 ...
		 * @type {String}
		 */
		itemClassName: "BPMSoft.LookupManagerItem",
		 ...
		 * @throws {BPMSoft.UnauthorizedException}
		 */
		checkIsInitialized: function() {
			this.callParent(arguments);
			if (!this.getCanManageLookups()) {
				throw new BPMSoft.UnauthorizedException();
			}
		},
