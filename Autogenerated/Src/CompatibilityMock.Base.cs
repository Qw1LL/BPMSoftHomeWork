...
namespace BPMSoft.UI.WebControls.Utilities
{
	using System.Web;
...
#region Реализовать работу DataSourceFilter в .net core
namespace  BPMSoft.UI.WebControls.Utilities.Json.Converters
{
	using System;
	using System.Web;
	...
	public class ProcessDataSourceFiltersJsonConverter : DataSourceFiltersJsonConverter
	{
		...
		private void ThrowInvalidRightExpressionParameterValueException(string parameterDisplayValue) {
			...
			string exceptionMessage = new LocalizableString("BPMSoft.UI.WebControls",
	...
	public class DataSourceFiltersJsonConverter : BPMSoftJsonConverter
	{
	...
	public class DataValueTypeJsonConverter : BPMSoftJsonConverter
	{
...
namespace BPMSoft.UI.WebControls.Controls
{
	using System;
...
#region Адаптировать DotNetOpenAuth.OAuth.ChannelElements
...
#region Адаптировать BPMSoft.GoogleServices

namespace BPMSoft.GoogleServices
{
...
#region BPMSoft.Social.Google

namespace BPMSoft.Social.Google {
	using System.Collections.Generic;
	using BPMSoft.Core;
...
#region Адаптировать BPMSoft.Social

namespace BPMSoft.Social
{
	using System;
	using System.Collections.Generic;
	using DotNetOpenAuth.OAuth.ChannelElements;
	using BPMSoft.GoogleServerConnector;
