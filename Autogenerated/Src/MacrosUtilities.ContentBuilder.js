define("MacrosUtilities", ["MacrosUtilitiesResources", "ModalBox"],
	function(resources, ModalBox) {
		/**
		 * @class BPMSoft.configuration.MacrosUtilities
		 */
		Ext.define("BPMSoft.configuration.MacrosUtilities", {
			alternateClassName: "BPMSoft.MacrosUtilities",
