		...
		return {
			...
			methods: {
				...
				getChangedColumns: function() {
					var changedColumns = {};
					this.BPMSoft.each(this.changedValues, function(value, columnName) {
				...
				changeActiveRecord: function(direction) {
					...
					switch (direction) {
						...
						case "back":
							...
							break;
						default:
							throw Ext.create(this.BPMSoft.NotImplementedException);
					}
				},
				 ...
				 * @protected
				 * @return {BPMSoft.TranslationListViewGenerator} Returns view generator instance.
				 */
				getTranslationListViewGenerator: function() {
					return this.Ext.create(BPMSoft.TranslationListViewGenerator);
				},
				...
				getVisibleColumnsInfo: function() {
					...
					var info = [];
					this.BPMSoft.each(visibleColumns, function(columnPath) {
				...
				getTranslationColumnsInfo: function(includeAllColumns) {
					...
					this.BPMSoft.each(this.entitySchema.columns, function(column, columnPath) {
						var columnUsageType = column.usageType;
						if (columnUsageType !== this.BPMSoft.EntitySchemaColumnUsageType.General) {
							return;
						}
						var cultureIndex = this.getCultureIndex(columnPath);
						...
						var existColumnInfo = this.BPMSoft.findItem(items, {cultureIndex: cultureIndex});
						if (!existColumnInfo) {
			...
			diff: /**SCHEMA_DIFF*/[
				...
				},
				{
					...
					"values": {
						...
						"className": "BPMSoft.DynamicViewContainer",
