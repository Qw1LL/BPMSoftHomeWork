define("SourceCodeEditGenerator", ["ViewGeneratorV2", "SourceCodeEdit"], function() {
	 ...
	 */
	Ext.define("BPMSoft.configuration.SourceCodeEditGenerator", {
		extend: "BPMSoft.ViewGenerator",
		alternateClassName: "BPMSoft.SourceCodeEditGenerator",

		/**
		 * Class name of SourceCodeEdit control.
		 * @type {String}
		 */
		sourceCodeEditClassName: "BPMSoft.SourceCodeEdit",
	...
	return Ext.create("BPMSoft.SourceCodeEditGenerator");
});
