namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class SysModuleReportTypeSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Printable form type.
	/// </summary>
	public class SysModuleReportType : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class SysModuleReportType_BaseEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SysModuleReportType
	{
