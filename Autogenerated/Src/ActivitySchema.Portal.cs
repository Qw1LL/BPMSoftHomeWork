namespace BPMSoft.Configuration
{
	...
	#region Class: Activity_Portal_BPMSoftSchema

	/// <exclude/>
	public class Activity_Portal_BPMSoftSchema : BPMSoft.Configuration.Activity_Invoice_BPMSoftSchema
	{

		#region Constructors: Public

		public Activity_Portal_BPMSoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Activity_Portal_BPMSoftSchema(Activity_Portal_BPMSoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Activity_Portal_BPMSoftSchema(Activity_Portal_BPMSoftSchema source)
			: base(source) {
		}
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Activity_Portal_BPMSoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new Activity_Portal_BPMSoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Activity_Portal_BPMSoftSchema(this, true);
		}
	...
	#region Class: Activity_Portal_BPMSoft

	/// <summary>
	/// Активность.
	/// </summary>
	public class Activity_Portal_BPMSoft : BPMSoft.Configuration.Activity_Invoice_BPMSoft
	{

		#region Constructors: Public

		public Activity_Portal_BPMSoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Activity_Portal_BPMSoft";
		}

		public Activity_Portal_BPMSoft(Activity_Portal_BPMSoft source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new Activity_Portal_BPMSoft(this);
		}
	...
	/// <exclude/>
	public partial class Activity_PortalEventsProcess<TEntity> : BPMSoft.Configuration.Activity_InvoiceEventsProcess<TEntity> where TEntity : Activity_Portal_BPMSoft
	{
	...
	/// <exclude/>
	public class Activity_PortalEventsProcess : Activity_PortalEventsProcess<Activity_Portal_BPMSoft>
	{
