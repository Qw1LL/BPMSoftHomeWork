define("EmployeePageMixin", [], function() {
	/**
	 * @class BPMSoft.configuration.mixins.EmployeePageMixin
	 * Implements common business logic for EmployeePage and EmployeeMiniPage.
	 */
	Ext.define("BPMSoft.configuration.mixins.EmployeePageMixin", {
		alternateClassName: "BPMSoft.EmployeePageMixin",
