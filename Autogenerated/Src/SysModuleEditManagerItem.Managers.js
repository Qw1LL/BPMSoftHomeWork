define("SysModuleEditManagerItem", ["SysModuleEditManagerItemResources"], function() {
	 ...
	 * ##### ######## ######### ######## ##### #######.
	 */
	Ext.define("BPMSoft.manager.SysModuleEditManagerItem", {
		extend: "BPMSoft.manager.ObjectManagerItem",
		alternateClassName: "BPMSoft.SysModuleEditManagerItem",
		...
		/**
		 * Mini page schema modes. Values of enum BPMSoft.ConfigurationEnums.CardOperation joins by ";".
		 */
		miniPageModes: null,
