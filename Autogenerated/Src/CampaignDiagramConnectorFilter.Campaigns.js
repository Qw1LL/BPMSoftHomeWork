define("CampaignDiagramConnectorFilter", ["LookupUtilities", "CampaignEnums"],
	...
	Ext.define("BPMSoft.configuration.CampaignDiagramConnectorFilter", {
		alternateClassName: "BPMSoft.CampaignDiagramConnectorFilter",
		...
		onLoadHyperlinks: function(response) {
			...
			if (items) {
				var hyperlinks = BPMSoft.reduce(items, function(memo, hyperlink) {
		...
		validateHyperlinks: function() {
			...
			BPMSoft.each(bulkEmailHyperlinks, function(bulkEmailHyperlink) {
				var hyperlink = BPMSoft.findWhere(allSourceBulkEmailHyperlinks, {
		...
		getSelectedIds: function() {
			return BPMSoft.reduce(this.get("BulkEmailHyperlinks"), function(memo, hyperlink) {
