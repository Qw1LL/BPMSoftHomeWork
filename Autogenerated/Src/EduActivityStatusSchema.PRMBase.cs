namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class EduActivityStatusSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// <summary>
	/// Статус образовательной активности.
	/// </summary>
	public class EduActivityStatus : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class EduActivityStatus_PRMBaseEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EduActivityStatus
	{
