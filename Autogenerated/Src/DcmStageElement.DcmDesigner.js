define("DcmStageElement", ["ext-base", "BPMSoft", "DcmStageElementResources", "css!DcmStageElement", "DcmConstants"],
	function(Ext, BPMSoft, resources) {
		/**
		 * @class BPMSoft.controls.DcmStageElement
		 */
		Ext.define("BPMSoft.controls.DcmStageElement", {

			alternateClassName: "BPMSoft.DcmStageElement",
			 ...
			 * @type {Number}
			 */
			requiredType: BPMSoft.DcmConstants.ElementRequiredType.NOT_REQUIRED.value,
			...
			getTplData: function() {
				...
				var image;
				if (this.imageConfig) {
					image = BPMSoft.ImageUrlBuilder.getUrl(this.imageConfig);
				}
			...
			applyClasses: function(tplData) {
				...
				if (this.requiredType === BPMSoft.DcmConstants.ElementRequiredType.REQUIRED.value) {
			...
			setSelected: function(selected) {
				...
				if (wrapEl && selectedClass && this.rendered) {
					if (selected) {
						...
						BPMSoft.utils.dom.scrollIntoView(wrapEl.dom, false);
					} else {
			...
			getRemoveButtonImage: function() {
				...
				var removeImageUrl = BPMSoft.ImageUrlBuilder.getUrl(removeImage);
		...
		return BPMSoft.controls.DcmStageElement;
