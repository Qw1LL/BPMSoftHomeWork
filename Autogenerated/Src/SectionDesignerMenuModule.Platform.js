 ...
 * @deprecated
 */
define('SectionDesignerMenuModule', ['ext-base', 'BPMSoft', 'sandbox', 'SideBarModuleResources', 'ModuleUtils'],
	function(Ext, BPMSoft, sandbox, resources, ModuleUtils) {
		var sideBar;
		var info;
		...
		function render(renderTo) {
			...
			sandbox.subscribe('PostSectionMenuConfig', function(args) {
				...
				sideBar = Ext.create('BPMSoft.SideBar', {
					renderTo: renderTo,
					items: config
				});
