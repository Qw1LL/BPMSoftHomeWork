define("BaseMessageHistoryUtility", ["LocalMessageConstants", "EmailMessageConstants", "ConfigurationConstants"],
	function(LocalMessageConstants) {
		/**
		 * @class BPMSoft.configuration.mixins.BaseMessageHistoryUtility
		 * Mixin, that implements base logic of message history.
		 */
		Ext.define("BPMSoft.configuration.mixins.BaseMessageHistoryUtility", {
			alternateClassName: "BPMSoft.BaseMessageHistoryUtility",
			 ...
			 * @param {BPMSoft.EntitySchemaQuery} esq query to CaseMessageHistory.
			 * @protected
			 */
			addFiltersToMessageHistoryExistsEsq: function(esq) {
				...
				filterGroup.add("CommunicationFilter", this.BPMSoft.createColumnFilterWithParameter(
					this.BPMSoft.ComparisonType.NOT_EQUAL, "MessageNotifier", LocalMessageConstants.MessageNotifier.Local));
