define("BusinessRuleActionDesignerContainer", ["BusinessRuleActionDesignerContainerResources",
		...
		/**
		 * @class BPMSoft.controls.BusinessRuleActionDesignerContainer
		 */
		Ext.define("BPMSoft.controls.BusinessRuleActionDesignerContainer", {
			extend: "BPMSoft.Container",
			alternateClassName: "BPMSoft.BusinessRuleActionDesignerContainer",
			...
			getBlocksHeaderTpl: function() {
				...
				var tpl = "";
				BPMSoft.each(blockList, function(blockName) {
			...
			getViewItemsPropertyNames: function() {
				...
				BPMSoft.each(this.getBlockNameList(), function(blockName) {
		...
		return BPMSoft.BusinessRuleActionDesignerContainer;
	});
