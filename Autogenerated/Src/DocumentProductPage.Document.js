define('DocumentProductPage', ['ext-base', 'BPMSoft', 'sandbox',
	'DocumentProduct', 'DocumentProductPageStructure', 'DocumentProductPageResources',
	'BusinessRuleModule', 'MoneyModule'],
	function(Ext, BPMSoft, sandbox, DocumentProduct, structure,
		...
		structure.userCode = function() {
			...
			this.methods.calcTaxAmount = function() {
				...
				var taxAmount = 0;
				if (BPMSoft.SysSettings.cachedSettings.PriceWithTaxes) {
