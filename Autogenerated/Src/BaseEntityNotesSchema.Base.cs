namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	[IsVirtual]
	public class BaseEntityNotesSchema : BPMSoft.Configuration.BaseEntitySchema
	{
	...
	/// </summary>
	public class BaseEntityNotes : BPMSoft.Configuration.BaseEntity
	{
	...
	/// <exclude/>
	public partial class BaseEntityNotes_BaseEventsProcess<TEntity> : BPMSoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BaseEntityNotes
	{
