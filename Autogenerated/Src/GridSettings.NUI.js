define("GridSettings", ["ext-base", "BPMSoft", "sandbox", "GridSettingsResources", "ConfigurationConstants",
		"MaskHelper", "StructureExplorerUtilities", "GridSettingsViewGenerator",
		"GridSettingsViewModelGenerator", "ConfigurationEnums"],
		function(Ext, BPMSoft, sandbox, resources, ConfigurationConstants, MaskHelper, StructureExplorerUtilities,
	...
	function getUserSaveRights(callback, renderTo, scope) {
		var currentUser = BPMSoft.SysValue.CURRENT_USER.value;
		...
		esq.filters.add("SysUser", BPMSoft.createColumnFilterWithParameter(
			BPMSoft.ComparisonType.EQUAL, "SysUser", currentUser));
		esq.filters.add("SysRole", BPMSoft.createColumnFilterWithParameter(
			BPMSoft.ComparisonType.EQUAL, "SysRole", sysAdmins));
