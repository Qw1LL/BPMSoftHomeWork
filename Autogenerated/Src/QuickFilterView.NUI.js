define('QuickFilterView', ['ext-base', 'BPMSoft', 'FixedFilterView', 'FolderFilterView', 'CustomFilterView',
	'QuickFilterViewResources'],
	function(Ext, BPMSoft, FixedFilterView, FolderFilterView, CustomFilterView, resources) {
