namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class SysAdminUnitSchema : BPMSoft.Configuration.SysAdminUnit_Translation_BPMSoftSchema
	{
	...
	/// </summary>
	public class SysAdminUnit : BPMSoft.Configuration.SysAdminUnit_Translation_BPMSoft
	{
	...
	/// <exclude/>
	public partial class SysAdminUnit_SSPEventsProcess<TEntity> : BPMSoft.Configuration.SysAdminUnit_TranslationEventsProcess<TEntity> where TEntity : SysAdminUnit
	{
