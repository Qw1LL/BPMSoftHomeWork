namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ReleaseTypeSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Тип релиза.
	/// </summary>
	public class ReleaseType : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class ReleaseType_ReleaseEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ReleaseType
	{
