namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class BETArchiveFirstGenerationSchema : BPMSoft.Configuration.BulkEmailTargetSchema
	{
	...
	/// <summary>
	/// Архив Отклик в Email первого уровня.
	/// </summary>
	public class BETArchiveFirstGeneration : BPMSoft.Configuration.BulkEmailTarget
	{
	...
	/// <exclude/>
	public partial class BETArchiveFirstGeneration_MarketingCampaignEventsProcess<TEntity> : BPMSoft.Configuration.BulkEmailTarget_MarketingCampaignEventsProcess<TEntity> where TEntity : BETArchiveFirstGeneration
	{
