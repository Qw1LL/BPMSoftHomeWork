define("DetailModuleV2", ["BaseSchemaModuleV2", "css!SectionModuleV2", "css!BaseSectionV2CSS"], function() {
	/**
	 * @class BPMSoft.configuration.DetailModule
	 * ##### DetailModule ############ ### ######## ########## ######
	 */
	Ext.define("BPMSoft.configuration.DetailModule", {
		alternateClassName: "BPMSoft.DetailModule",
		...
		/**
		 * @inheritdoc BPMSoft.BaseSchemaModuleV2#getElementsPrefix
		 * @override
		 */
