define("BaseSchemaModuleV2", ["performancecountermanager",
	 ...
	 * ####### ##### ################# ######.
	 */
	Ext.define("BPMSoft.configuration.BaseSchemaModule", {
		extend: "BPMSoft.configuration.BaseModule",
		alternateClassName: "BPMSoft.BaseSchemaModule",
		...
		_containsIdGenerator: function(viewModel) {
			return viewModel && viewModel.getSchemaViewModelContainerId !== BPMSoft.emptyFn
		...
		getViewConfig: function(viewModel) {
			...
			var viewConfig = {
				...
				items: this.BPMSoft.deepClone(this.viewConfig),
		...
		render: function(renderTo) {
			...
			if (!view || view.destroyed) {
				...
				view = this.view = this.Ext.create("BPMSoft.Container", viewConfig);
				view.bind(viewModel);
		 ...
		 */
		getAdditionalDiff: BPMSoft.emptyFn,
		 ...
		 * @virtual
		 */
		getElementsPrefix: BPMSoft.emptyFn
	});
	return BPMSoft.BaseSchemaModule;
});
