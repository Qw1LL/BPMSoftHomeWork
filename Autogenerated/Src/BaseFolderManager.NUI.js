define("BaseFolderManager", ["ext-base", "BPMSoft", "sandbox", "BaseFolderManagerResources",
	...
	return Ext.define("BPMSoft.BaseFolderManager", {
		...
		initializeModule: function(callback, scope) {
			...
			require([self._config.folderFilterViewId, self._config.folderFilterViewModelId], function(FilterView,
				...
				self.view = Ext.create("BPMSoft.Container", viewConfig);
