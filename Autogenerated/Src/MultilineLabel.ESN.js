define("MultilineLabel", ["ext-base", "BPMSoft", "MultilineLabelResources", "css!MultilineLabel"],
	 ...
	 */
	return Ext.define("BPMSoft.controls.MultilineLabel", {
		extend: "BPMSoft.Label",
		alternateClassName: "BPMSoft.MultilineLabel",
		...
		/**
		 * @inheritdoc BPMSoft.Label#setCaption
		 * @override
		 */
		...
		_sanitizeValue: function(value) {
			const needSanitizeHtml = BPMSoft.Features.getIsDisabled("DoNotSanitizeHtmlInMultilineLabel");
			return needSanitizeHtml ? BPMSoft.sanitizeHTML(value) : value;
		},
