namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ClosureCodeSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// <summary>
	/// Причина закрытия обращения.
	/// </summary>
	public class ClosureCode : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class ClosureCode_CaseEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ClosureCode
	{
