define("ESNHtmlEditModule", ["ext-base", "BPMSoft", "ExtendedHtmlEditModule"], function(Ext, BPMSoft) {
	/* global CKEDITOR */
	Ext.define("BPMSoft.controls.ESNHtmlEdit", {
		extend: "BPMSoft.ExtendedHtmlEdit",
		alternateClassName: "BPMSoft.ESNHtmlEdit",

		//region Properties: Private

		/**
		 * @inheritdoc BPMSoft.HtmlEdit#trackingStartChars
		 * @overridden
		 */
		trackingStartChars: ["@"],
		...
		/**
		 * @inheritdoc BPMSoft.ExtendedHtmlEdit#tpl
		 * @overridden
		 */
		tpl: [
			//jscs:disable
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#tplData
		 * @overridden
		 */
		tplData: {
			"classes": {
		...
		/**
		 * @inheritDoc BPMSoft.HtmlEdit#initFonts
		 * @overridden
		 */
		initFonts: BPMSoft.emptyFn,

		/**
		 * @inheritDoc BPMSoft.HtmlEdit#setupBodyDrop
		 * @overridden
		 */
		setupBodyDrop: BPMSoft.emptyFn,

		/**
		 * @inheritdoc BPMSoft.HtmlEdit#margin
		 * @overridden
		 */
		margin: "",
		...
		/**
		 * @inheritdoc BPMSoft.ExtendedHtmlEdit#placeholderClass
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.ExpandableList#enableLocalFilter
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.ExtendedHtmlEdit#setTrackingValue
		 * @overridden
		 */
		setTrackingValue: function(item, callback, scope) {
			...
			BPMSoft.each(this.customItemAttributes, function(value) {
		...
		/**
		 * @inheritdoc BPMSoft.controls.ExtendedHtmlEdit#onKeyDown
		 * @override
		...
		/**
		 * @inheritdoc BPMSoft.controls.ExtendedHtmlEdit#onKeyUp
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.ExtendedHtmlEdit#isTrackingStartChar
		 * @overridden
		 * @private
		...
		/**
		 * @inheritdoc BPMSoft.controls.ExtendedHtmlEdit#setBindConfigParams
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.ExtendedHtmlEdit#clearTrackingNode
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.ExtendedHtmlEdit#removePlaceholder
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.ExtendedHtmlEdit#setListAlignOffset
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.ExtendedHtmlEdit#setInitConfig
		 * @overridden
		 */
		 ...
		 * @param {BPMSoft.BaseViewModel} model The data model which is linked to the control.
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#onFocus
		 * @overridden
		 */
		onFocus: function() {
			this.callParent(arguments);
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#onBlur
		 * @overridden
		 */
		onBlur: function() {
			this.callParent(arguments);
		...
		/**
		 * @inheritdoc BPMSoft.ExtendedHtmlEdit#onContentDom
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.ExtendedHtmlEdit#onEnterKeyPressed
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.ExtendedHtmlEdit#onKeyPress
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#initToolbarItems
		 * @overridden
		 */
		initToolbarItems: BPMSoft.emptyFn,

		/**
		 * @inheritdoc BPMSoft.HtmlEdit#getEditorConfig
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#getKeyStrokes
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#insertHyperLink
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#setAdditionalContentStyles
		 * @overridden
		 */
		setAdditionalContentStyles: BPMSoft.emptyFn,
