define("CampaignDiagramPropertyModule", ["CampaignDiagramPropertyEnums"],
	function(PropertyEnums) {
		Ext.define("BPMSoft.configuration.CampaignDiagramPropertyModule", {
			extend: "BPMSoft.BaseModule",
			alternateClassName: "BPMSoft.CampaignDiagramPropertyModule",
			Ext: null,
			BPMSoft: null,
			sandbox: null,
			renderTo: null,
			...
			initViewModel: function() {
				...
				schemaBuilder.build(config, function(viewModelClass, viewConfig) {
					...
					var view = Ext.create("BPMSoft.Container", viewConfig[0]);
		...
		return BPMSoft.CampaignDiagramPropertyModule;
	});
