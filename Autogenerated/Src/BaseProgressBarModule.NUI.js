define("BaseProgressBarModule", ["BPMSoft"], function(BPMSoft) {
	/**
	 *  @class BPMSoft.controls.BaseProgressBar
	 *  ##### ### ###### # ########### ######### ## #######.
	 */
	var baseProgressBarClass = Ext.define("BPMSoft.controls.BaseProgressBar", {
		alternateClassName: "BPMSoft.BaseProgressBar",
		...
		setValue: function(value) {
			...
			this.value = BPMSoft.deepClone(value);
			if (this.rendered) {
				this.reRender();
			}
		},
