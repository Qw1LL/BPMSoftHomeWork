define("SectionMergeHelper", ["SectionMergeHelperResources", "ModalBox", "DesktopPopupNotification",
	...
	function(resources, ModalBox, DesktopPopupNotification) {
		/**
		 * @class BPMSoft.configuration.mixins.SectionMergeHelper
		 * Mixin for merge in section.
		 */
		Ext.define("BPMSoft.configuration.mixins.SectionMergeHelper", {
			alternateClassName: "BPMSoft.SectionMergeHelper",
			...
			getMergePopupIconUrl: function() {
				return this.BPMSoft.ImageUrlBuilder.getUrl(resources.localizableImages.DefMergeIcon);
			},
			 ...
			 * @return {BPMSoft.Collection} Items menu button with added item.
			 */
