define("MarketingCalendarGrid", ["css!MarketingCalendarGrid"], function() {
	Ext.define("BPMSoft.controls.MarketingCalendarGrid", {
		alternateClassName: "BPMSoft.MarketingCalendarGrid",
		extend: "BPMSoft.Grid",
		...
		categoryCss: "grid-listed-row-category",
		notCategoryCss: "grid-listed-row-notcategory",
		notCategorySubLevelCss: "grid-listed-row-notcategorysublevel",
		/**
		 * @overridden
		 */
		 ...
		 */
		dataGridRowsWrapCss: "grid-rows-wrap",

		/**
		 * Data grid rows wraper DOM Id sufix
		 */
		dataGridRowsWrapDomIdSufix: "grid-rows-wrap",
		...
		deleteStylesInitResultsPage:function() {
		...
		initDomEvents: function() {
			...
			this.deleteStylesInitResultsPage();
		...
		/**
		 * @inheritdoc BPMSoft.Grid#renderListedGrid
		 * @overridden
		 * ##### ######## ################ ####### ### ########## ####### ########### ## ######### #####.
		 * @protected
		 * @param {Array} result
		...
		renderListedGrid: function(result, options) {
			...
			var bottomSpinnerSpaceTpl = new Ext.Template(
					'<span class="grid-bottom-spinner-space"></span>');
