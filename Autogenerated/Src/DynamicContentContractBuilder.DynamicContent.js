...
function() {
	return {
		...
		_getReplicaBuilder: function() {
			return this.ReplicaBuilder || Ext.create("BPMSoft.DynamicContentReplicaBuilder");
		},
		...
		_getAttributeDto: function(attribute) {
			var result = {};
			BPMSoft.each(this.serializableDCAttributeProperties, function(prop) {
		...
		_getReplicasContracts: function(templateJson) {
			...
			var contracts = [];
			BPMSoft.each(replicasConfigs, function(replica) {
