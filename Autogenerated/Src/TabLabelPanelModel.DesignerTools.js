define("TabLabelPanelModel", ["ext-base", "BPMSoft", "TabLabelPanelItemModel"],
	function(Ext, BPMSoft) {

		/**
		 * @class BPMSoft.TabLabelPanelModel
		 * Tabs container model class.
		 */
		Ext.define("BPMSoft.TabLabelPanelModel", {
			...
			addTabToCollection: function(collection, tab) {
				...
				var item = Ext.create("BPMSoft.TabLabelPanelItemModel", {
					values: {
						TabModel: this,
			...
			setActiveTabByTabCode: function(tabCode) {
				...
				if (tabs) {
					...
					BPMSoft.each(tabKeys, function(key, index) {
