define("ContentBuilderElement", ["css!ContentBuilderElement", "ContentBuilderElementViewModel"], function() {
	...
	/**
	 * @class BPMSoft.controls.ContentBuilderElement
	 */
	Ext.define("BPMSoft.controls.ContentBuilderElement", {
		extend: "BPMSoft.Component",
		alternateClassName: "BPMSoft.ContentBuilderElement",
		mixins: {
			draggable: "BPMSoft.DraggableContentElement"
		},
		 ...
		 * @protected
		 * @type {BPMSoft.ReorderableContainer}
		 */
		container: null,
		...
		/**
		 * @inheritdoc BPMSoft.Draggable#b4StartDrag
		 * @overridden
		 */
	...
	return BPMSoft.ContentBuilderElement;
});
