define("DcmDesignerFilterEditFilter", ["ProcessDesignerFilterEditFilter"], function() {
	 ...
	 */
	Ext.define("BPMSoft.controls.DcmDesignerFilterEditFilter", {
		extend: "BPMSoft.ProcessDesignerFilterEditFilter",
		alternateClassName: "BPMSoft.DcmDesignerFilterEditFilter",

		/**
		 * @inheritdoc BPMSoft.ProcessDesignerFilterEditFilter#constructor
		 * @overridden
		 */
