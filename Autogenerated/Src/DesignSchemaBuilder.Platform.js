define("DesignSchemaBuilder", ["SectionDesignDataModule", "SchemaBuilderV2", "ext-base", "BPMSoft",
	"DesignViewGeneratorV2"],
	function(SectionDesignDataModule) {
		var schemaBuilder = Ext.define("BPMSoft.configuration.DesignSchemaBuilder", {
			extend: "BPMSoft.SchemaBuilder",
			alternateClassName: "BPMSoft.DesignSchemaBuilder",
			...
			createViewGenerator: function() {
				return Ext.create("BPMSoft.DesignViewGenerator");
			},
			...
			/**
			 * @inheritdoc BPMSoft.SchemaBuilder#requireSchema
			 * @protected
			 * @overridden
			 */
			...
			/**
			 * @inheritdoc BPMSoft.SchemaBuilder#initSchemaStructure
			 * @protected
			 * @overridden
			 */
			...
			/**
			 * @inheritdoc BPMSoft.SchemaBuilder#initSchemaResources
			 * @protected
			 * @overridden
			 */
			...
			/**
			 * @inheritdoc BPMSoft.SchemaBuilder#initSchemaParent
			 * @protected
			 * @overridden
			 */
			...
			/**
			 * @inheritdoc BPMSoft.SchemaBuilder#requireAllSchemaHierarchy
			 * @overridden
			 * ##### ######## ######## ####.
			 */
