namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class QueuePrioritySchema : BPMSoft.Configuration.BaseValueLookupSchema
	{
	...
	/// <summary>
	/// Приоритет очереди в едином окне.
	/// </summary>
	public class QueuePriority : BPMSoft.Configuration.BaseValueLookup
	{
	...
	/// <exclude/>
	public partial class QueuePriority_OperatorSingleWindowEventsProcess<TEntity> : BPMSoft.Configuration.BaseValueLookup_BaseEventsProcess<TEntity> where TEntity : QueuePriority
	{
