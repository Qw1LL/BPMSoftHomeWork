define("BaseClientConnector", ["ExecuteCommandRequest"], function() {
	/**
	 * @class BPMSoft.configuration.SocialNetworkClientConnector
	 * ##### ########### ###### # ########## ##### # #######.
	 */
	Ext.define("BPMSoft.configuration.social.BaseClientConnector", {
		extend: "BPMSoft.core.BaseObject",
		alternateClassName: "BPMSoft.BaseClientConnector",
