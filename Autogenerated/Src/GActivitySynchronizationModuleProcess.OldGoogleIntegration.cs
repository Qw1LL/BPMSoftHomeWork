namespace BPMSoft.Core.Process
{
	...
	/// <exclude/>
	public class GActivitySynchronizationModuleProcessSchema : BPMSoft.Core.Process.ProcessSchema
	{
	...
	/// <exclude/>
	public class GActivitySynchronizationModuleProcess : BPMSoft.Core.Process.Process
	{
