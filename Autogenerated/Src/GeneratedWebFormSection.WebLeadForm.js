define('GeneratedWebFormSection', ['ext-base', 'BPMSoft', 'sandbox', 'GeneratedWebForm',
		'GeneratedWebFormSectionStructure', 'GeneratedWebFormSectionResources', 'ConfigurationEnums',
		'GeneratedWebFormUtilities'],
	function(Ext, BPMSoft, sandbox, GeneratedWebForm, structure, resources, ConfigurationEnums,
			GeneratedWebFormUtilities) {
