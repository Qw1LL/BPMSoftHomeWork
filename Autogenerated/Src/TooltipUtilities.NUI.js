define("TooltipUtilities", ["TooltipUtilitiesResources", "AcademyUtilities", "InformationButton",
	...
	/**
	 * @class BPMSoft.configuration.mixins.TooltipUtilities
	 * Contains utility methods used by tooltips.
	 */
	Ext.define("BPMSoft.configuration.mixins.TooltipUtilities", {
		alternateClassName: "BPMSoft.TooltipUtilities",
	...
	return BPMSoft.TooltipUtilities;
});
