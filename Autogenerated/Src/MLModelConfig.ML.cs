namespace BPMSoft.Configuration.ML
{
	...
	/// <summary>
	/// Extension to <see cref="BPMSoft.Nui.ServiceModel.DataContract.ColumnExpression"/> with ML model
	/// additional properties.
	/// </summary>
	/// <seealso cref="BPMSoft.Nui.ServiceModel.DataContract.ColumnExpression" />
	...
	public class MLModelConfig
	{
		...
		/// <see cref="BPMSoft.Core.DB.Select"/> instance.
		/// </summary>
		/// <value>
		...
		/// returns <see cref="BPMSoft.Core.DB.Select"/> instance.
		/// </summary>
		/// <value>
