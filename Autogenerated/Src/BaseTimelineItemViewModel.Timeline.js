define("BaseTimelineItemViewModel", ["NetworkUtilities", "MiniPageUtilities", "BaseTimelineItemViewModelResources"],
	function(networkUtilities) {
		 ...
		 */
		Ext.define("BPMSoft.configuration.BaseTimelineItemViewModel", {
			alternateClassName: "BPMSoft.BaseTimelineItemViewModel",
			 ...
			 * @private
			 * @param {BPMSoft.BaseModel} instance Instance.
			 * @return {Array} Resource class names.
			 */
			_getResourceClassNames: function(instance) {
				var result = [];
				if (!BPMSoft.isInstanceOfClass(instance, "BPMSoft.BaseModel")) {
					return;
				}
			...
			_initClassResources: function() {
				...
				BPMSoft.each(resourceClassNames, function(resourceClassName) {
			...
			getGroupIconSrc: function() {
				return BPMSoft.ImageUrlBuilder.getUrl(this.get("Resources.Images.GroupIcon"));
			},
			...
			getFormattedFloatNumberValue: function(numberValue) {
				return BPMSoft.getFormattedNumberValue(numberValue, {
