define("SupplyPaymentGridButtonsUtility", ["SupplyPaymentElement", "SupplyPaymentGridButtonsUtilityResources",
	 ...
	 * ######### ###### ### ###### ###### # ####### ###### "###### ######## # #####".
	 */
	Ext.define("BPMSoft.configuration.SupplyPaymentGridButtonsUtility", {
		extend: "BPMSoft.BaseObject",
		alternateClassName: "BPMSoft.SupplyPaymentGridButtonsUtility",
				...
				detailColumn: {
					...
					modifyQuery: function(esq) {
						esq.addAggregationSchemaColumn("[SupplyPaymentProduct:SupplyPaymentElement].Id",
								BPMSoft.AggregationType.COUNT, this.name);
					}
				},
		...
		/**
		 * ######### ######## ####### "####" ###### ####### # ########### ## ####.
		 * @param {BPMSoft.BaseModel} supplyPaymentRow ###### #######.
		 */
		...
		getCustomLinkColumns: function() {
			...
			var config = this.customLinkColumns = Ext.create("BPMSoft.Collection");
		 ...
		 * @param {BPMSoft.BaseViewModel} detailViewModel  ###### ############# ######.
		 */
			...
			if (customColumnButtons) {
				customColumnButtons.each(function(customColumnButton) {
					if (customColumnButton.clickMethodNames) {
						this.BPMSoft.each(customColumnButton.clickMethodNames, function(clickMethodName) {
		...
		/**
		 * ########## ############ ############# ######### ### ###### #######.
		 * @param {BPMSoft.EntitySchemaColumn} entitySchemaColumn ####### ###### #######.
		 * @return {Object} ############ ############# ######### ######.
		 */
		...
		getIsFeatureEnabled: function(code) {
			return this.BPMSoft.Features.getIsEnabled(code);
		}
	});

	var privateClassName = "BPMSoft.SupplyPaymentGridButtonsUtility";
	var instance = null;
