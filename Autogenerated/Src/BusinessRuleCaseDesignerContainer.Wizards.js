define("BusinessRuleCaseDesignerContainer", ["BusinessRuleCaseDesignerContainerResources"], function(resources) {
		...
		/**
		 * @class BPMSoft.controls.BusinessRuleCaseDesignerContainer
		 */
		Ext.define("BPMSoft.controls.BusinessRuleCaseDesignerContainer", {
			extend: "BPMSoft.Container",
			alternateClassName: "BPMSoft.BusinessRuleCaseDesignerContainer",
			...
			/**
			 * @inheritdoc BPMSoft.AbstractContainer#getTpl
			 * @overridden
			 */
			getTpl: function() {
				return [
			...
			getTplData: function() {
				...
				caseTplData.conditionHeaderIconPath =
					BPMSoft.ImageUrlBuilder.getUrl(resources.localizableImages.IfIcon);
				caseTplData.actionHeaderIconPath =
					BPMSoft.ImageUrlBuilder.getUrl(resources.localizableImages.ThenIcon);
		...
		return BPMSoft.BusinessRuleCaseDesignerContainer;
	});
