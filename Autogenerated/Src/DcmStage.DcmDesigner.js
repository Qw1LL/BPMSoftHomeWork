define("DcmStage", ["css!DcmStage"], function() {
	Ext.ns("BPMSoft.enums.DcmStage.AddButtonStyle");

	/**
	 * Add button styles.
	 * @enum
	 */
	BPMSoft.enums.DcmStage.AddButtonStyle = {
		/**
		 * Arrow style.
		 */
	...
	/**
	 * @class BPMSoft.controls.DcmStage
	 */
	Ext.define("BPMSoft.controls.DcmStage", {
		alternateClassName: "BPMSoft.DcmStage",
		extend: "BPMSoft.Container",

		mixins: {
			reorderableItemMixin: "BPMSoft.ReorderableItemMixin",
			toolsMixin: "BPMSoft.ToolsMixin"
		},

		/**
		 * @inheritdoc BPMSoft.controls.AbstractContainer#defaultRenderTpl
		 * @overridden
		 */
		defaultRenderTpl: [
		 ...
		 * @type {BPMSoft.enums.DcmStage.AddButtonStyle}
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.AbstractContainer#itemsEventMap
		 * @protected
		 * @override
		 */
		itemsEventMap: {
		...
		/**
		 * @inheritdoc BPMSoft.controls.Container#init
		 * @overridden
		 */
		init: function() {
		...
		initCustomHeaderColorClasses: function() {
			...
			this.iterateCustomHeaderColorClasses(headerColorClasses, function(cssClassName, cssClassBody) {
				...
				BPMSoft.createStyleSheet(cssClass);
			}, this);
		},
		...
		iterateCustomHeaderColorClasses: function(headerColorClasses, iterator, scope) {
			BPMSoft.each(headerColorClasses, function(properties, className) {
		...
		getHeaderColorClasses: function(color) {
			...
			var borderColorCSS = BPMSoft.getIsRtlMode() ? "border-right-color": "border-left-color";
			...
			var headerColorClasses = {
				...
				".dcm-stage .stage-header.outer-rounded .boundary-el::before": headerColorClass,
		...
		getCustomHeaderColorClassBody: function(properties) {
			...
			BPMSoft.each(properties, function(propertyValue, propertyName) {
		...
		setHeaderColor: function(color) {
			...
			this.iterateCustomHeaderColorClasses(headerColorClasses, function(cssClassName, cssClassBody) {
				BPMSoft.updateStyleSheet(cssClassName, cssClassBody);
			}, this);
		},
		...
		/**
		 * @inheritdoc BPMSoft.core.mixins.Draggable#getDefaultDraggableConfig
		 * @overridden
		 */
		getDefaultDraggableConfig: function() {
			...
			var moveDragConfig = defaultDraggableConfig[BPMSoft.DragAction.MOVE];
		...
		/**
		 * @inheritdoc BPMSoft.core.mixins.Draggable#createDraggableClone
		...
		/**
		 * @inheritdoc BPMSoft.core.mixins.Draggable#generateDraggableElement
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.AbstractContainer#indexOf
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.AbstractContainer#getRenderToEl
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.AbstractContainer#processTemplate
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.AbstractContainer#getTplData
		 * @overridden
		 */
		getTplData: function() {
		 ...
		 * @param {BPMSoft.enums.DcmStage.AddButtonStyle} addButtonStyle Add button style.
		 * @return {String} Class name.
		 */
		getAddButtonStyleClassName: function(addButtonStyle) {
			var className = "";
			switch (addButtonStyle) {
				case BPMSoft.enums.DcmStage.AddButtonStyle.INNER_ARROW:
					className = "inner-arrow";
					break;
				case BPMSoft.enums.DcmStage.AddButtonStyle.INNER_ROUNDED:
					className = "inner-rounded";
					break;
				case BPMSoft.enums.DcmStage.AddButtonStyle.OUTER_ROUNDED:
		...
		/**
		 * @inheritdoc BPMSoft.controls.Component#getSelectors
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.AbstractContainer#bind
		 * @overridden
		 */
		bind: function() {
			this.callParent(arguments);
		...
		/**
		 * @inheritdoc BPMSoft.controls.Component#onAfterRender
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.Component#onAfterReRender
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.Component#getBindConfig
	...
	return BPMSoft.controls.DcmStage;
});
