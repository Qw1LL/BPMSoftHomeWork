define("LookupUtilitiesV2", ["BPMSoft", "ModalBox", "LookupUtilitiesV2Resources", "MaskHelper"
], function(BPMSoft, ModalBox, resources) {
	Ext.define("BPMSoft.configuration.LookupUtilities", {
		extend: "BPMSoft.core.BaseObject",
		alternateClassName: "BPMSoft.LookupUtilities",
		...
		_subscribeOnResultSelectedRowsMessage: function(sandbox, callback, scope, lookupPageId) {
			sandbox.subscribe("ResultSelectedRows", function(args) {
				...
				BPMSoft.LookupUtilities.unloadModule(this.scope.sandbox);
		...
		prepareModalBox: function() {
			ModalBox.show(this.modalBoxSize, BPMSoft.emptyFn);
