 ...
 */
define("SourceCodeEditPage", ["BPMSoft", "SourceCodeEditEnums", "SourceCodeEditPageResources", "SourceCodeEdit"],
	function(BPMSoft, sourceCodeEditEnums) {
		return {
			messages: {
				/**
				 * @message GetValue
			...
			methods: {
				 ...
				 * @return {Object} Image config. For config properties see {@link BPMSoft.ImageUrlBuilder} class.
				 */
