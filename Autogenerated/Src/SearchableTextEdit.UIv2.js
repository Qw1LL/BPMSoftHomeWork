define("SearchableTextEdit", ["ext-base", "BPMSoft", "SearchEdit"], function(Ext) {
	/**
	 * @class BPMSoft.controls.SearchableTextEdit
	 * Edit control with search ability and expandable list for found items.
	 */
	Ext.define("BPMSoft.controls.SearchableTextEdit", {
		extend: "BPMSoft.SearchEdit",
		alternateClassName: "BPMSoft.SearchableTextEdit",
		...
		/**
		 * @inheritdoc BPMSoft.SearchEdit#searchDelay
		 * @overridden
		 */
		searchDelay: 200,
		...
		/**
		 * @inheritdoc BPMSoft.ExpandableList#enableRightIcon
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseEdit#onFocus
		 * @overridden
		 */
		onFocus: function() {
		...
		/**
		 * @inheritdoc BPMSoft.BaseEdit#onBlur
		 * @overridden
		 */
		onBlur: function() {
			this.callParent(arguments);
		...
		/**
		 * @inheritdoc BPMSoft.BaseEdit#onKeyDown
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseEdit#onEnterKeyPressed
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Bindable#initBinding
		 * @overridden
		 */
