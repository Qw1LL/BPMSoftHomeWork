define("PageDesigner", ["ext-base", "PageDesignerResources", "SectionDesignDataModule", "DesignViewGeneratorV2",
	...
	function(Ext, resources, designData, designViewGenerator, schemaBuilder, sectionDesignerUtils, designViewModel,
		 ...
		 * ##### ###### ######### ########
		 */
		var pageDesignerClass = Ext.define("BPMSoft.configuration.PageDesigner", {
			extend: "BPMSoft.BaseObject",
			alternateClassName: "BPMSoft.PageDesigner",
			 ...
			 * ######### ########### ############# #####
			 * @private
			 * @param {BPMSoft.Component} schemaView ############# #####
			 */
			...
			updateTabsCollection: function(changedColumnName, newColumnValue) {
				...
				var tabsCollection = new BPMSoft.Collection();
				if (tabName) {
			 ...
			 * ########## ########## ######## ########## #####. ####### # ############## ###### ############# #########.
			 * @private
			 * @param {BPMSoft.BaseViewModel} viewModelClass ##### ###### ############# #####.
			 * @param {BPMSoft.Component} schemaView ############# #####.
			 * @param {Object} schema ##### ######## ##############.
			 */
			onSchemaBuild: function(viewModelClass, schemaView, schema) {
				...
				var cloneSchema = this.BPMSoft.deepClone(schema);
			...
			initItemsCaptionConverters: function(items) {
				BPMSoft.iterateChildItems(items, function(iterationConfig) {
