define("DuplicatesMergeModuleV2", ["BaseNestedModule", "DuplicatesMergeViewConfigV2", "DuplicatesMergeViewModelV2"],
	function() {
		Ext.define("BPMSoft.configuration.DuplicatesMergeModule", {
			extend: "BPMSoft.BaseNestedModule",
			alternateClassName: "BPMSoft.DuplicatesMergeModule",
			 ...
			 * @type {String}
			 */
			viewModelClassName: "BPMSoft.DuplicatesMergeViewModel",

			/**
			 * The class name of the generator of view configuration.
			 * @type {String}
			 */
			viewConfigClassName: "BPMSoft.DuplicatesMergeViewConfig",
		...
		return BPMSoft.DuplicatesMergeModule;
	});
