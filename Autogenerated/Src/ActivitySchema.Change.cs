namespace BPMSoft.Configuration
{
	...
	#region Class: Activity_Change_BPMSoftSchema

	/// <exclude/>
	public class Activity_Change_BPMSoftSchema : BPMSoft.Configuration.Activity_Document_BPMSoftSchema
	{

		#region Constructors: Public

		public Activity_Change_BPMSoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Activity_Change_BPMSoftSchema(Activity_Change_BPMSoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Activity_Change_BPMSoftSchema(Activity_Change_BPMSoftSchema source)
			: base(source) {
		}
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Activity_Change_BPMSoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new Activity_Change_BPMSoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Activity_Change_BPMSoftSchema(this, true);
		}
	...
	#region Class: Activity_Change_BPMSoft

	/// <summary>
	/// Активность.
	/// </summary>
	public class Activity_Change_BPMSoft : BPMSoft.Configuration.Activity_Document_BPMSoft
	{

		#region Constructors: Public

		public Activity_Change_BPMSoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Activity_Change_BPMSoft";
		}

		public Activity_Change_BPMSoft(Activity_Change_BPMSoft source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new Activity_Change_BPMSoft(this);
		}
	...
	/// <exclude/>
	public partial class Activity_ChangeEventsProcess<TEntity> : BPMSoft.Configuration.Activity_DocumentEventsProcess<TEntity> where TEntity : Activity_Change_BPMSoft
	{
	...
	/// <exclude/>
	public class Activity_ChangeEventsProcess : Activity_ChangeEventsProcess<Activity_Change_BPMSoft>
	{
