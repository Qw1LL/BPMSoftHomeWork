...
define("FormulaTaskPropertiesPage", ["FormulaTaskPropertiesPageResources"], function() {
	return {
		...
		methods: {
			 ...
			 * @return {BPMSoft.core.enums.DataValueType|null}
			 */
			...
			openMetaPathMappingEditWindow: function(parameterName, parameterValue) {
				...
				this.initializeLookupSchema(referenceSchemaUId, function() {
					...
					var mappingType = BPMSoft.MappingEnums.MappingUnion.PROCESS_AND_ELEMENT_PARAMETERS;
			...
			/**
			 * @inheritdoc BPMSoft.MappingEditMixin#setParametersInfoCallback
			 * @override
			 */
