namespace BPMSoft.Configuration
{
	...
	#region Class: LeadSource_TouchPoints_BPMSoftSchema

	/// <exclude/>
	public class LeadSource_TouchPoints_BPMSoftSchema : BPMSoft.Configuration.BaseLookupSchema
	{

		#region Constructors: Public

		public LeadSource_TouchPoints_BPMSoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public LeadSource_TouchPoints_BPMSoftSchema(LeadSource_TouchPoints_BPMSoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public LeadSource_TouchPoints_BPMSoftSchema(LeadSource_TouchPoints_BPMSoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "LeadSource_TouchPoints_BPMSoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new LeadSource_TouchPoints_BPMSoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new LeadSource_TouchPoints_BPMSoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new LeadSource_TouchPoints_BPMSoftSchema(this, true);
		}
	...
	#region Class: LeadSource_TouchPoints_BPMSoft

	/// <summary>
	/// Source.
	/// </summary>
	public class LeadSource_TouchPoints_BPMSoft : BPMSoft.Configuration.BaseLookup
	{

		#region Constructors: Public

		public LeadSource_TouchPoints_BPMSoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "LeadSource_TouchPoints_BPMSoft";
		}

		public LeadSource_TouchPoints_BPMSoft(LeadSource_TouchPoints_BPMSoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("LeadSource_TouchPoints_BPMSoftDeleted", e);
			Validating += (s, e) => ThrowEvent("LeadSource_TouchPoints_BPMSoftValidating", e);
		...
		public override object Clone() {
			return new LeadSource_TouchPoints_BPMSoft(this);
		}
	...
	/// <exclude/>
	public partial class LeadSource_TouchPointsEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadSource_TouchPoints_BPMSoft
	{
	...
	/// <exclude/>
	public class LeadSource_TouchPointsEventsProcess : LeadSource_TouchPointsEventsProcess<LeadSource_TouchPoints_BPMSoft>
	{
