define("HighchartsWrapper", ["ext-base", "BPMSoft", "DefaultChartConfig", "jQuery",
		"DashboardEnums", "ChartProviderFactory"],
	function(Ext, BPMSoft, defaultChartConfig) {
		Ext.define("BPMSoft.controls.Chart", {
			extend: "BPMSoft.Container",
			alternateClassName: "BPMSoft.Chart",

			/**
			 * Class name of the chart provider factory.
			 */
			chartProviderFactoryClassName: 'BPMSoft.ChartProviderFactory',
			 ...
			 * @type {String[]}
			 */
			colorSet: BPMSoft.DashboardEnums.WidgetColorSet,
			 ...
			 * @type {Boolean}
			 */
			oldUIFeature: BPMSoft.Features.getIsEnabled("OldUI"),
			...
			defaultTextStyle: {
				"color": "#999999",
				"font-family": this.oldUIFeature ? "Segoe UI" : "Golos Regular",
				"font-size": "13px",
				"line-height": "14px",
				"width": "100%",
				"fill": "#999999"
			...
			initMenu: function() {
				...
				var isMenuInitialized = drilldownMenu instanceof BPMSoft.Menu;
				if (!isMenuInitialized) {
					...
					this.drilldownMenu = Ext.create("BPMSoft.Menu", config);
				}
			},
			...
			getInitConfig: function() {
				var colorSet = BPMSoft.deepClone(this.colorSet);
			...
			setCategories: function(categories) {
				var canCompare = this.categories && BPMSoft.isArray(categories);
			...
			_setSeriesType: function(type) {
				...
				BPMSoft.each(this.series, function(serie) {
					serie.type = type;
				}, this);
			},
