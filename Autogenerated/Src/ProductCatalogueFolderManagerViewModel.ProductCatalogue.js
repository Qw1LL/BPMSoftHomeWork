define("ProductCatalogueFolderManagerViewModel", ["ProductCatalogueFolderManagerViewModelResources",
	...
	Ext.define("BPMSoft.configuration.ProductCatalogueFolderManagerViewModel", {
		extend: "BPMSoft.BaseFolderManagerViewModel",
		alternateClassName: "BPMSoft.ProductCatalogueFolderManagerViewModel",
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#getRootFolderTypes
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#load
		 * @override
		 */
		load: function() {
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#getLoadBatchQuery
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#handleLoadBatchResult
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#initializeRootFolders
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#initializeCustomFolders
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#dblClickGrid
		 * @override
		 */
		...
		getCatalogueLevelItemsSelect: function(nextRow, currentRow) {
			...
			select.addParameterColumn(nextRow.get("Id"), BPMSoft.DataValueType.GUID, "ParentId");
			select.addParameterColumn(nextRow.get("Name"), BPMSoft.DataValueType.TEXT, "ParentName");
			select.addParameterColumn(nextRow.get("Position"), BPMSoft.DataValueType.INTEGER, "Position");
			select.addParameterColumn(nextRow.get("ReferenceSchemaName"), BPMSoft.DataValueType.TEXT,
				"ReferenceSchemaName");
			select.rowCount = -1;
		 ...
		 * @return {BPMSoft.data.filters.FilterGroup} Filters group.
		 */
		getCatalogueAdditionalFilters: function(rowItem, filterConfigs) {
			...
			BPMSoft.each(filterConfigs, function(filterItem) {
		...
		prepareCatalogueFolders: function(catalogueFolderValues, rowConfig, resultItems) {
			...
			BPMSoft.each(catalogueFolderValues, function(item) {
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#showFolderInfo
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#onExpandHierarchyLevels
		 * @override
		 */
		 ...
		 * @protected
		 * @param {BPMSoft.BaseViewModelCollection} response Catalogue items select result.
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#onActiveRowAction
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#getNewFolderParentId
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#closeFolderManager
		 * @override
		 */
		 ...
		 * @private
		 * @param {Object} row
		 * @param {BPMSoft.FilterGroup} filtersGroup Catalog folder filter object.
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseFolderManagerViewModel#applyFolderFilters
		 * @override
		 */
	...
	return BPMSoft.ProductCatalogueFolderManagerViewModel;
});
