define("EmailMessageEnrichmentMixin", ["EmailMessageEnrichmentMixinResources", "ConfigurationEnums",
	"ConfigurationConstants", "NetworkUtilities", "EmailHelper", "EmailEnrichmentMixin"],
		function(resources, ConfigurationEnums, ConfigurationConstants, NetworkUtilities) {
			 ...
			 */
			Ext.define("BPMSoft.configuration.mixins.EmailMessageEnrichmentMixin", {
				extend: "BPMSoft.EmailEnrichmentMixin",
				alternateClassName: "BPMSoft.EmailMessageEnrichmentMixin",
				...
				/**
				 * @inheritdoc BPMSoft.EmailEnrichmentMixin#getEnrichmentButtonMenuItem
				 * @overridden
				 */
				...
				loadSenderData: function() {
					...
					esq.filters.addItem(this.BPMSoft.createColumnFilterWithParameter(
						this.BPMSoft.ComparisonType.EQUAL, "Activity", this.get("RecordId")));
					...
					esq.filters.addItem(this.BPMSoft.createColumnInFilterWithParameters("Role", roleIds));
				...
				getSenderInfo: function() {
					...
					var senderInfoRegExp = this.BPMSoft.EmailHelper.emailPattern;
				...
				checkIfContactHasCommunication: function(config) {
					...
					esq.filters.addItem(this.BPMSoft.createColumnFilterWithParameter(
						this.BPMSoft.ComparisonType.EQUAL, "Number", config.senderEmail));
					esq.filters.addItem(this.BPMSoft.createColumnFilterWithParameter(
						this.BPMSoft.ComparisonType.EQUAL, "Contact", config.contactId));
					esq.filters.addItem(this.BPMSoft.createColumnFilterWithParameter(
						this.BPMSoft.ComparisonType.EQUAL, "CommunicationType", typeId));
					esq.getEntityCollection(function(response) {
						if (response.success) {
				...
				connectContactCommunicationItem: function(config, callback, scope) {
					...
					insert.setParameterValue("Number", config.senderEmail, this.BPMSoft.DataValueType.TEXT);
					insert.setParameterValue("Contact", config.contactId, this.BPMSoft.DataValueType.GUID);
					insert.setParameterValue("CommunicationType", typeId, this.BPMSoft.DataValueType.GUID);
				...
				connectActivityParticipantItem: function(config) {
					...
					insert.setParameterValue("Participant", contactId, this.BPMSoft.DataValueType.GUID);
