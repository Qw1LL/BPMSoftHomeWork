namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ProjectFileSchema : BPMSoft.Configuration.FileSchema
	{
	...
	/// <summary>
	/// Файл и ссылка проекта.
	/// </summary>
	public class ProjectFile : BPMSoft.Configuration.File
	{
	...
	/// <exclude/>
	public partial class ProjectFile_ProjectEventsProcess<TEntity> : BPMSoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ProjectFile
	{
