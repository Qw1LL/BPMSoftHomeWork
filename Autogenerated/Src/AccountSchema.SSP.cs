namespace BPMSoft.Configuration
{
	...
	#region Class: Account_SSP_BPMSoftSchema

	/// <exclude/>
	public class Account_SSP_BPMSoftSchema : BPMSoft.Configuration.Account_RelationshipDesigner_BPMSoftSchema
	{

		#region Constructors: Public

		public Account_SSP_BPMSoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Account_SSP_BPMSoftSchema(Account_SSP_BPMSoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Account_SSP_BPMSoftSchema(Account_SSP_BPMSoftSchema source)
			: base(source) {
		}
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Account_SSP_BPMSoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new Account_SSP_BPMSoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Account_SSP_BPMSoftSchema(this, true);
		}
	...
	#region Class: Account_SSP_BPMSoft

	/// <summary>
	/// Account.
	/// </summary>
	public class Account_SSP_BPMSoft : BPMSoft.Configuration.Account_RelationshipDesigner_BPMSoft
	{

		#region Constructors: Public

		public Account_SSP_BPMSoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Account_SSP_BPMSoft";
		}

		public Account_SSP_BPMSoft(Account_SSP_BPMSoft source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new Account_SSP_BPMSoft(this);
		}
	...
	/// <exclude/>
	public partial class Account_SSPEventsProcess<TEntity> : BPMSoft.Configuration.Account_RelationshipDesignerEventsProcess<TEntity> where TEntity : Account_SSP_BPMSoft
	{
	...
	/// <exclude/>
	public class Account_SSPEventsProcess : Account_SSPEventsProcess<Account_SSP_BPMSoft>
	{
