namespace BPMSoft.Core.Process
{
	...
	/// <exclude/>
	public class DownloadTemplateForImportContactsProcessSchema : BPMSoft.Core.Process.ProcessSchema
	{
	...
	/// <exclude/>
	public class DownloadTemplateForImportContactsProcess : BPMSoft.Core.Process.Process
	{
