namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class WebPageSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Web page.
	/// </summary>
	public class WebPage : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class WebPage_WebFormEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : WebPage
	{
