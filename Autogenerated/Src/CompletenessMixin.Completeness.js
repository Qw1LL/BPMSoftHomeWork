define("CompletenessMixin", ["ServiceHelper", "ConfigurationCompletenessIndicatorGenerator",
	...
	function(ServiceHelper) {
		/**
		 * @class BPMSoft.configuration.mixins.CompletenessHelpMixin
		 * ######, ########### ###### # ######## ########## #######.
		 */
		Ext.define("BPMSoft.configuration.mixins.CompletenessMixin", {
			alternateClassName: "BPMSoft.CompletenessMixin",
			...
			getMenuItemClassName: function() {
				return "BPMSoft.CompletenessMenuItem";
			},
			...
			getCompleteness: function(config, callback, scope) {
				...
				BPMSoft.delay(ServiceHelper.callService, ServiceHelper, 1000, [
			...
			completenessServiceCallback: function(response, callback, scope) {
				...
				if (result) {
					if (result.success) {
						...
						this.log(result.errorInfo.message, this.BPMSoft.LogMessageType.ERROR);
					}
				}
		...
		return BPMSoft.CompletenessMixin;
	});
