		...
		return {
			...
			methods: {
				...
				getBlankSlateHeaderCaption: function() {
					var masterColumnInfo = this.get("MasterColumnInfo");
					var profileHeaderCaption=this.get("Resources.Strings.ProfileHeaderCaption");
					return masterColumnInfo ? masterColumnInfo.caption : profileHeaderCaption;
				},
				 ...
				 * @param {String} [typeColumnValue] Value of type column.
				 */
				setEditColumnName: this.BPMSoft.emptyFn,

				/**
				 * @inheritdoc BPMSoft.MiniPageUtilities#getMiniPageSandboxId
				 * @overridden
				 */
				 ...
				 * @protected
				 * @param {BPMSoft.BaseViewModel} editPage Edit page instance.
				...
				/**
				 * @inheritdoc BPMSoft.BaseViewModel#clearEntity
				 * @overridden
				 */
				 ...
				 * @protected
				 */
				onProfileLoaded: this.BPMSoft.emptyFn,
