define("DefaultChartConfig", ["ext-base", "BPMSoft"], function() {
	/**
	 * Is old UI feature enabled. Used for switching fonts.
	 * @type {Boolean}
	 */
	var oldUIFeature = BPMSoft.Features.getIsEnabled("OldUI");
	...
	var defaultLabelStyle = {
		font: oldUIFeature ? "13px ' SegoeUI'" : "13px 'Golos Regular'",
		color: "#999999"
	};
	...
	var defaultTitleStyle = {
		font: oldUIFeature ? "13px 'Segoe UI Light', Verdana, sans-serif" : "13px 'Golos Regular'",
		color: "#444444"
	};
	...
	var defaultDataLabelsStyle = {
		font: oldUIFeature ? "14px 'Segoe UI'" : "14px 'Golos Regular'",
		color: "#444444"
	};
	...
	var pie = {
		...
		xAxis: {
			...
			labels: {
				...
				x: 0,
				style: {
					fontFamily: oldUIFeature ? "Segoe UI" : "Golos Regular",
					fontSize: "16px",
					color: "#444"
				}
			},
		...
		legend: {
			...
			itemStyle: {
				fontFamily: oldUIFeature ? "Segoe UI Light" : "Golos Regular",
				fontSize: "13px",
				color: "#777777",
				borderRadius: 0
			}
