define("MLModelPageFiltersMixin", ["BPMSoft"],
	function(BPMSoft) {
		/**
		 * @class BPMSoft.configuration.mixins.MLModelPageFiltersMixin
		 * Mixin that separates filter logic out of MLModelPage
		 */
		Ext.define("BPMSoft.configuration.mixins.MLModelPageFiltersMixin", {
			alternateClassName: "BPMSoft.MLModelPageFiltersMixin",
			 ...
			 * @param {BPMSoft.FilterGroup} args.filter Filter object.
		...
		return BPMSoft.MLModelPageFiltersMixin;
	});
