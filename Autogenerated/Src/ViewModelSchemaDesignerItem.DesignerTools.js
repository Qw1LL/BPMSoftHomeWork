define("ViewModelSchemaDesignerItem", [], function() {
	...
	Ext.define("BPMSoft.ViewModelSchemaDesignerItem", {
		extend: "BPMSoft.controls.DraggableContainer",
		alternateClassName: "BPMSoft.controls.ViewModelSchemaDesignerItem",
		...
		/**
		 * @inheritdoc BPMSoft.RightIcon#rightIconClasses
		 * @override
		 */
		...
		tpl: [
			/* jshint ignore:start */
			'<div id="{id}-view-model-schema-designer-item-wrap" data-SchemaIsChanged="{isSchemaIsChanged}" data-used="{isUsed}" data-required="{isRequired}"' +
			'		class="{wrapClasses}">',
		...
		getTplData: function() {
			...
			if (this.isSchemaIsChanged) {
				tplData.isSchemaIsChanged = this.isSchemaIsChanged;
			}
			...
			tplData.content = BPMSoft.encodeHtml(this.content);
			return tplData;
		},
		...
		getBindConfig: function() {
			...
			var itemBindConfig = {
				...
				isSchemaIsChanged: {
					changeMethod: "setIsSchemaIsChanged"
				}
			};
		 ...
		 * @param {Boolean} value Value.
		 */
		setIsSchemaIsChanged: function(value) {
			if (this.isSchemaIsChanged === value) {
				return;
			}
			this.isSchemaIsChanged = value;
			if (this.rendered) {
				this.reRender();
			}
		},
		...
		/**
		 * @inheritdoc BPMSoft.MenuMixin#onMenuItemsChange
		 * @override
		 */
		onMenuItemsChange: BPMSoft.emptyFn,

		/**
		 * @inheritdoc BPMSoft.Component#bind
		 * @override
		 */
		bind: function() {
			this.callParent(arguments);
		...
		/**
		 * @inheritdoc BPMSoft.DraggableContainer#onDestroy
		 * @override
		 */
		onDestroy: function() {
	...
	return BPMSoft.ViewModelSchemaDesignerItem;
