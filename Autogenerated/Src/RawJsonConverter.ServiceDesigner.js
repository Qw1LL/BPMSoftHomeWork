define("RawJsonConverter", ["RawConverter", "RawBuffer", "ServiceJsonConverter", "UriJsonConverter"],
	...
	Ext.define("BPMSoft.services.RawJsonConverter", {
		alternateClassName: "BPMSoft.RawJsonConverter",
		...
		onHeadersParsed: function(parsedSection) {
			...
			json[this.sectionAuth] = {authType: BPMSoft.services.enums.AuthType.None};
			let url = "";
	...
	return BPMSoft.RawJsonConverter;
