define("MultiCurrencyEditViewGenerator", ["ext-base", "MultiCurrencyEditViewGeneratorResources", "BPMSoft",
		"DesignViewGeneratorV2", "CtiContainerList"],
	function(Ext, resources, BPMSoft) {
		Ext.define("BPMSoft.configuration.MultiCurrencyEditViewGenerator", {
			extend: "BPMSoft.ViewGenerator",
			alternateClassName: "BPMSoft.MultiCurrencyEditViewGenerator",
			...
			_getDecimalPrecision: function(columnName) {
				...
				var precision = column.precision || BPMSoft.SysValue.CURRENT_MONEY_DISPLAY_PRECISION;
				return precision;
			},
			...
			generateCurrencyLabel: function(viewConfig) {
				var labelConfig = BPMSoft.deepClone(viewConfig);
			...
			/**
			 * @inheritdoc BPMSoft.ViewGeneratorV2#getMarkerValue
			 * @overridden
			 */
			...
			/**
			 * @inheritdoc BPMSoft.ViewGeneratorV2#getLabelCaption
			 * @overridden
			 */
			...
			generateMultiCurrencyEdit: function(viewConfig) {
				...
				var controlConfig = {
					...
					"className": "BPMSoft.MultiCurrencyEdit",
			...
			/**
			 * Generates config for {BPMSoft.MultiCurrencyEdit}.
			 * @protected
			 * @param {Object} viewConfig Control config.
		...
		return Ext.create(BPMSoft.MultiCurrencyEditViewGenerator);
	});
