define("BusinessRuleCaseDesignerViewModel", ["BusinessRuleCaseDesignerViewModelResources",
	...
	"BusinessRulePopulateItemActionDesignerContainer"], function(resources) {
		...
		/**
		 * @class BPMSoft.Designers.BusinessRuleCaseDesignerViewModel
		 */
		Ext.define("BPMSoft.Designers.BusinessRuleCaseDesignerViewModel", {
			extend: "BPMSoft.BusinessRuleElementDesignerViewModel",
			alternateClassName: "BPMSoft.BusinessRuleCaseDesignerViewModel",

			columns: {

				/**
				 * Case action collection.
				 * @type {BPMSoft.BusinessRuleActionViewModel}
				 */
				"ActionCollection": {
				 ...
				 * @type {BPMSoft.BusinessRuleConditionGroupViewModel}
				 */
				"ConditionGroup": {
					"type": BPMSoft.ViewModelColumnType.VIRTUAL_COLUMN,
			...
			_isActionDependsOnEntitySchema: function(action) {
				...
				return actionClass.prototype instanceof BPMSoft.ColumnBusinessRuleAction || action.type === "PopulateBusinessRuleAction";
			},
			...
			prepareActionMenuItems: function() {
				...
				var actionInfo = this.BPMSoft.BusinessRuleElementHelper.getElementsByGroupType("BusinessRuleActions");
				BPMSoft.each(actionInfo, function(action) {
					...
					actionMenuItems.addItem(this.Ext.create("BPMSoft.BaseViewModel", {
						values: {
			...
			prepareActionCollection: function() {
				...
				var actionCollection = this.Ext.create("BPMSoft.BaseViewModelCollection");
				BPMSoft.each(actionGroupMetaItem.getPropertyValue("items"), function(actionMetaItem) {
			...
			createActionViewModel: function(actionMetaItem, actionCollection) {
				...
				var element = this.BPMSoft.BusinessRuleElementHelper.getElementByClassName(className);
			 ...
			 * @return {BPMSoft.BusinessRuleConditionGroupDesignerViewModel} Business rule condition designer view model.
			 */
			createBusinessRuleConditionGroupViewModel: function(columnValues) {
				return this.createItemViewModel("BPMSoft.BusinessRuleConditionGroupDesignerViewModel", columnValues);
			},
			 ...
			 * @param {Object} columnValues Column values.
			 * @return {BPMSoft.BusinessRuleActionDesignerViewModel} Business rule action designer view model.
			 */
			...
			addAction: function(actionType) {
				var actionCollection = this.get("ActionCollection");
				var element = this.BPMSoft.BusinessRuleElementHelper.getElementByType(actionType);
			 ...
			 * @param {BPMSoft.BusinessRuleActionDesignerViewModel} action Action.
			 * @private
			 */
			 ...
			 * @return {BPMSoft.BusinessRuleCase} Business rule case instance.
			 */
			createMetaItem: function() {
				return Ext.create("BPMSoft.BusinessRuleCase", {
					action: {
		...
		return BPMSoft.BusinessRuleCaseDesignerViewModel;
	});
