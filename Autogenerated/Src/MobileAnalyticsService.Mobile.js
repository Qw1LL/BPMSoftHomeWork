/**
 * @class BPMSoft.AnalyticsService
 * Provides methods for work with analytics web service.
 */
Ext.define("BPMSoft.configuration.service.AnalyticsService", {
	alternateClassName: "BPMSoft.AnalyticsService",
	...
	statics: {
		...
		sendRequest: function(config) {
			BPMSoft.RequestManager.issueRequest({
				...
				requestFnConfig: {
					isCancelable: true,
					url: BPMSoft.util.encodeServiceUrl(this.serviceUrl) + config.methodName,
					method: "POST",
