		...
		methods: {
			...
			_initSysLanguage: function() {
				this.set("SysLanguage", {
					"Id": this.BPMSoft.SysValue.PRIMARY_LANGUAGE.value,
					"Name": this.BPMSoft.SysValue.PRIMARY_LANGUAGE.displayValue,
					"Code": this.BPMSoft.SysValue.PRIMARY_LANGUAGE.code
				});
			},
			 ...
			 * @private
			 * @param {BPMSoft.core.collections.Collection} languages List of languages.
			...
			loadTemplateFromSheet: function(languageId) {
				...
				if (language) {
					...
					this.setMLangColumnValue(language, "Subject",
						this.BPMSoft.decodeHtmlEntities(this.get("Subject")));
				}
			},

			/**
			 * Set columns connected with Body into multilingual entity.
			 * @param {BPMSoft.model.BaseViewModel} language Multilingual entity.
			 * @protected
			 */
			setBodyColumnsValues: function(language) {
				...
				var configText = this.BPMSoft.encode(config);
			 ...
			 * @param {String} languageId language identifier.
			 * @return {BPMSoft.BaseViewModel} language params
			 * @protected
			 */
			 ...
			 * @param {BPMSoft.Collection} mLangContent Language identifier.
			 * @protected
			 */
			 ...
			 * @protected
			 * @param {BPMSoft.core.collections.Collection} mLangContent Multilingual data from entity.
			 * @param {String} columnName Name of multilingual column.
			 ...
			 * @protected
			 * @param {BPMSoft.data.queries.BatchQuery} batchQuery Query for all operations.
			...
			/**
			 * @inheritdoc BPMSoft.EmailContentBuilder#savePreviewImage
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.EmailContentBuilder#onPreviewImageCanvasReady
			 * @override
			 */
				...
				this.BPMSoft.chain(
					...
					function(next, languages) {
						...
						this.showCopyCurrentLangConfirmation(function(resultCode) {
							...
							this.BPMSoft.each(selectedLanguages, function(language) {
			 ...
			 * @return {BPMSoft.BatchQuery} BatchQuery for updating config and html of target email
			 * template.
			 */
