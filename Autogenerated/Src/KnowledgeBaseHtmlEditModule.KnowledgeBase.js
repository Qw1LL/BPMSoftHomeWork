define('KnowledgeBaseHtmlEditModule', ['ext-base', 'BPMSoft', 'KnowledgeBaseHtmlEditModuleResources',
	'HtmlEditModule'],
	function(Ext, BPMSoft, resources) {
		Ext.ns('BPMSoft.controls.HtmlEdit');

		Ext.define('BPMSoft.controls.KnowledgeBaseHtmlEdit', {
			extend: 'BPMSoft.HtmlEdit',
			alternateClassName: 'BPMSoft.KnowledgeBaseHtmlEdit',
			tpl: [
			...
			constructor: function() {
				...
				BPMSoft.each(this.itemsConfig, function(itemConfig) {
