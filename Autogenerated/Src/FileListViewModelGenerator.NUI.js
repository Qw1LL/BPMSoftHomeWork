define('FileListViewModelGenerator', ['ext-base', 'BPMSoft', 'FileListViewModelGeneratorResources', 'FileHelper',
	'GridUtilities'],
	function(Ext, BPMSoft, resources, FileHelper, GridUtilities) {
		var methods = {
			...
			loadByIds: function(ids, callback) {
				...
				column.orderDirection = BPMSoft.OrderDirection.DESC;
				select.addColumn('Size');
				select.filters.addItem(BPMSoft.createColumnInFilterWithParameters("Id", ids));
				select.getEntityCollection(function() {
					this.onDataLoaded.apply(this, arguments);
					callback.apply(this, arguments);
				}, this);
		...
		function generateViewModel(entitySchema) {
			...
			var config = {
				...
				//className: 'BPMSoft.FileListModule',
				name: 'FileListModule',
				columns: {},
				primaryColumnName: '',
