namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AppBuild : BPMSoft.Core.Entities.Entity
	{
		...
		public AppBuild(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AppBuild";
		...
		public IEnumerable<AppWrapper> AppWrapperCollectionByAppBuild {
			get;
			set;
		}
