namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class UsrTransportRequestsFolder : BPMSoft.Core.Entities.Entity
	{
		...
		public UsrTransportRequestsFolder(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "UsrTransportRequestsFolder";
		...
		public IEnumerable<UsrTransportRequestsFolder> UsrTransportRequestsFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<UsrTransportRequestsInFolder> UsrTransportRequestsInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public UsrTransportRequestsFolder Parent {
			get {
				return _parent ??
					(_parent = new UsrTransportRequestsFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
