namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class EnrchEmailData : BPMSoft.Core.Entities.Entity
	{
		...
		public EnrchEmailData(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "EnrchEmailData";
