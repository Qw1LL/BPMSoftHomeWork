namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class UsrTransportRequestsInTag : BPMSoft.Core.Entities.Entity
	{
		...
		public UsrTransportRequestsInTag(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "UsrTransportRequestsInTag";
		...
		private UsrTransportRequestsTag _tag;
		/// <summary>
		/// Тег раздела Заявки на транспорт.
		/// </summary>
		public UsrTransportRequestsTag Tag {
			get {
				return _tag ??
					(_tag = new UsrTransportRequestsTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		private UsrTransportRequests _entity;
		/// <summary>
		/// Заявки на транспорт.
		/// </summary>
		public UsrTransportRequests Entity {
			get {
				return _entity ??
					(_entity = new UsrTransportRequests(LookupColumnEntities.GetEntity("Entity")));
			}
		}
