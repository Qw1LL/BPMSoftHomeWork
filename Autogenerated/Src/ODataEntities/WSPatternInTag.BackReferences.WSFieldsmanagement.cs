namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class WSPatternInTag : BPMSoft.Core.Entities.Entity
	{
		...
		public WSPatternInTag(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "WSPatternInTag";
		...
		private WSPatternTag _tag;
		/// <summary>
		/// Тег раздела Правила ввода.
		/// </summary>
		public WSPatternTag Tag {
			get {
				return _tag ??
					(_tag = new WSPatternTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		private WSPattern _entity;
		/// <summary>
		/// Правила ввода.
		/// </summary>
		public WSPattern Entity {
			get {
				return _entity ??
					(_entity = new WSPattern(LookupColumnEntities.GetEntity("Entity")));
			}
		}
