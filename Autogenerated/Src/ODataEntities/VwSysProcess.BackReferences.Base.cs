namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwSysProcess : BPMSoft.Core.Entities.Entity
	{
		...
		public VwSysProcess(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwSysProcess";
		...
		/// <summary>
		/// Уникальный идентификатор схемы рабочего пространства.
		/// </summary>
