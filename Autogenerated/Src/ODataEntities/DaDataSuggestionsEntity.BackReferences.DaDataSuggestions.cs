namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class DaDataSuggestionsEntity : BPMSoft.Core.Entities.Entity
	{
		...
		public DaDataSuggestionsEntity(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "DaDataSuggestionsEntity";
		...
		public IEnumerable<DaDataSuggestionsSettings> DaDataSuggestionsSettingsCollectionByDaDataSuggestionsEntity {
			get;
			set;
		}
