namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysMsgLib : BPMSoft.Core.Entities.Entity
	{
		...
		public SysMsgLib(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysMsgLib";
		...
		public IEnumerable<TelephonyIntegration> TelephonyIntegrationCollectionBySysMsgLib {
			get;
			set;
		}
		...
		/// <summary>
		/// Название схемы страницы настройки.
		/// </summary>
		...
		/// <summary>
		/// Название класса cti-провайдера.
		/// </summary>
