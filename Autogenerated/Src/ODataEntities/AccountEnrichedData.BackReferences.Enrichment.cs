namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AccountEnrichedData : BPMSoft.Core.Entities.Entity
	{
		...
		public AccountEnrichedData(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AccountEnrichedData";
		...
		public AccountEnrichmentService AccountEnrichmentService {
			get {
				return _accountEnrichmentService ??
					(_accountEnrichmentService = new AccountEnrichmentService(LookupColumnEntities.GetEntity("AccountEnrichmentService")));
			}
		}
