namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class WSColourOfFieldFolder : BPMSoft.Core.Entities.Entity
	{
		...
		public WSColourOfFieldFolder(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "WSColourOfFieldFolder";
		...
		public IEnumerable<WSColourOfFieldFolder> WSColourOfFieldFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<WSColourOfFieldInFolder> WSColourOfFieldInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public WSColourOfFieldFolder Parent {
			get {
				return _parent ??
					(_parent = new WSColourOfFieldFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
