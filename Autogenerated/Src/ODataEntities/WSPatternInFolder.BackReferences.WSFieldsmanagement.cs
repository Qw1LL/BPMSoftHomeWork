namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class WSPatternInFolder : BPMSoft.Core.Entities.Entity
	{
		...
		public WSPatternInFolder(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "WSPatternInFolder";
		...
		private WSPatternFolder _folder;
		/// <summary>
		/// Группа Правила ввода.
		/// </summary>
		public WSPatternFolder Folder {
			get {
				return _folder ??
					(_folder = new WSPatternFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}
		...
		public WSPattern WSPattern {
			get {
				return _wSPattern ??
					(_wSPattern = new WSPattern(LookupColumnEntities.GetEntity("WSPattern")));
			}
		}
