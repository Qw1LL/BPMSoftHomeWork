namespace BPMSoft.Configuration.OData
{
	...
	/// <exclude/>
	public class WSPatternFolder : BPMSoft.Core.Entities.Entity
	{
		...
		public WSPatternFolder(BPMSoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "WSPatternFolder";
		...
		public IEnumerable<WSPatternFolder> WSPatternFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<WSPatternInFolder> WSPatternInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public WSPatternFolder Parent {
			get {
				return _parent ??
					(_parent = new WSPatternFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
