		...
		function(ServiceHelper) {
			return {
				...
				methods: {
					 ...
					 */
					init: function() {
						var dependentEntities = this.Ext.create("BPMSoft.Collection");
					 ...
					 * return {BPMSoft.BaseViewModel} Item with view model.
					 * @private
					 */
					createItemViewModel: function(config) {
						var itemWithModel = Ext.create("BPMSoft.BaseViewModel", {
							values: {
						...
						itemWithModel.BPMSoft = this.BPMSoft;
					 ...
					 * @return {BPMSoft.EntitySchemaQuery} Entity schema query or the count of the processes.
					 * @private
					 */
					getProcessDependenciesEsq: function() {
						...
						esq.addAggregationSchemaColumn("RecordId", this.BPMSoft.AggregationType.COUNT, "Count");
					...
					fillDependencies: function(response) {
						...
						var tmpItemsCollection = this.Ext.create("BPMSoft.Collection");
						if (response && response.GetDependentEntitiesResult) {
							...
							this.BPMSoft.each(itemsCollection, function(item) {
					 ...
					 * @param {BPMSoft.BaseViewModel} item View model of item.
