define('CommunicationDetail', ['sandbox', 'ext-base', 'BPMSoft', 'ContactCommunication', 'AccountCommunication',
		'ConfigurationConstants', 'CommunicationDetailStructure', 'CommunicationDetailResources', 'LookupUtilities',
		'ServiceHelper', 'EmailHelper'], function(sandbox, Ext, BPMSoft, ContactCommunication, AccountCommunication,
	...
	structure.userCode = function() {
		...
		this.methods.filterTypes = function(select) {
			...
			select.filters.addItem(BPMSoft.createColumnFilterWithParameter(BPMSoft.ComparisonType.EQUAL, columnPath,
				true));
