define("OpportunityFunnelChart", ["ext-base", "BPMSoft", "ChartModuleHelper", "OpportunityFunnelChartResources",
		"HighchartsWrapper", "jQuery", "DashboardEnums", "OpportunityChartProviderFactory"],
	function(Ext, BPMSoft, chartModuleHelper) {
		Ext.define("BPMSoft.controls.OpportunityFunnelChart", {
			extend: "BPMSoft.Chart",
			alternateClassName: "BPMSoft.OpportunityFunnelChart",
			 ...
			 * @override
			 */
			chartProviderFactoryClassName: "BPMSoft.OpportunityChartProviderFactory",
			...
			/**
			 * @inheritdoc BPMSoft.Chart#setType
			 * @override
			 */
			...
			setSeriesMinHeight: function(series) {
				...
				var sum = 0;
				BPMSoft.each(seriesData, function(seriesData) {
					sum += seriesData.y;
				});
