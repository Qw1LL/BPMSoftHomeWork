/**
 * @class BPMSoft.configuration.controller.ChartDashboardItemPage
 */
Ext.define("BPMSoft.configuration.controller.ChartDashboardItemPage", {
	extend: "BPMSoft.controller.DashboardItemPage",
	alternateClassName: "BPMSoft.controller.ChartDashboardItemPage",
	...
	getFilterValue: function(index, serieIndex) {
		...
		if (axisConfig.dateTimeFormat) {
			return BPMSoft.encode(itemValue);
		} else if (axisConfig.dataValueType === BPMSoft.DataValueType.Lookup) {
	...
	generateDashboardItemConfig: function(metadata) {
		var configGenerator = Ext.create("BPMSoft.ChartDashboardItemConfigGenerator");
