define("BaseStageControl", ["BaseStageControlItem", "css!BaseStageControl"], function() {
	 ...
	 */
	Ext.define("BPMSoft.controls.BaseStageControl", {
		extend: "BPMSoft.controls.AbstractContainer",
		alternateClassName: "BPMSoft.BaseStageControl",
		 ...
		 * @type {String}
		 */
		itemClassName: "BPMSoft.BaseStageControlItem",
		...
		/**
		 * @inheritdoc BPMSoft.Component#classes
		 * @override
		 */
		classes: null,
		 ...
		 * @private
		 * @param {BPMSoft.BaseViewModelCollection} menuViewModel View model for stage item menu.
		 * @param {BPMSoft.BaseViewModel} item Stage item view model.
		 */
		initMenuItems: function(menuViewModel, item) {
			...
			menuViewModel.each(function(menuItem) {
				...
				var tag = menuItem.get("Id") || BPMSoft.generateGUID();
		...
		init: function() {
			...
			this.addEvents(
				 ...
				 * @param {BPMSoft.BaseStageControl} this
				 */
				"activeStageChanged",
				/**
				 * @event
		 ...
		 * @param {BPMSoft.BaseViewModel} item Object that contains parameters of control template.
		 * @return {BPMSoft.BaseStageControlItem} Button element for stage.
		 */
		 ...
		 * @param {BPMSoft.BaseViewModel} stageViewModel Stage item view model.
		 ...
		 * @protected
		 * @param {BPMSoft.BaseViewModel} stageItem Stage control element.
		 * @return {Boolean} True if stage was changed.
		 */
		 ...
		 * @param {BPMSoft.BaseViewModelCollection} collection Collection of viewModels.
		 * @protected
		 */
