namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	[IsVirtual]
	public class StageBaseSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Stage lookup base.
	/// </summary>
	public class StageBase : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class StageBase_BaseEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : StageBase
	{
