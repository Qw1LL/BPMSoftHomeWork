define("DcmStageContainer", ["ext-base", "BPMSoft", "DcmReorderableContainer"], function(Ext, BPMSoft) {
	/**
	 * Class for DcmStageContainer.
	 */
	Ext.define("BPMSoft.controls.DcmStageContainer", {
		extend: "BPMSoft.Designers.DcmReorderableContainer",
		alternateClassName: "BPMSoft.DcmStageContainer",
		...
		/**
		 * @inheritdoc BPMSoft.controls.ReorderableContainer#itemClassName
		 */
		itemClassName: "BPMSoft.DraggableContainer",

		/**
		 * @inheritdoc BPMSoft.controls.ReorderableContainer#align
		 */
		align: BPMSoft.enums.ReorderableContainer.Align.HORIZONTAL,
		...
		/**
		 * @inheritdoc BPMSoft.core.mixins.Reorderable#getItemByIndex
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.ReorderableContainer#setInvalidDrag
		 * @override
		 */
	...
	return BPMSoft.Designers.DcmStageContainer;
});
