define("BaseTimelineItemView", ["MultilineLabel", "CollapsibleContainer", "ImageCustomGeneratorV2", "css!TimelineCSS"],
	 ...
	 */
	Ext.define("BPMSoft.configuration.BaseTimelineItemView", {
		extend: "BPMSoft.BaseObject",
		alternateClassName: "BPMSoft.BaseTimelineItemView",
				...
				"caption": {
					...
					"bindConfig": {
						"converter": function(value) {
							return BPMSoft.sanitizeHTML(value);
						}
					}
				},
				"contentVisible": true,
		...
		getSimpleLabelViewConfig: function(labelTextBinding, cssClasses) {
			...
			return {
				"name": "Label" + BPMSoft.generateGUID(),
				"itemType": BPMSoft.ViewItemType.LABEL,
