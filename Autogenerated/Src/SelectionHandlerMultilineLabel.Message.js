define("SelectionHandlerMultilineLabel", ["SelectionHandlerMultilineLabelResources",
	...
	function(resources) {
		/**
		 * BPMSoft.controls.SelectionHandlerMultilineLabel
		 * SelectionHandlerMultilineLabel class. Extend multiline label and provide opportunity for handling selected
		 * text in control.
		 */
		Ext.define("BPMSoft.SelectionHandlerMultilineLabel", {
			extend: "BPMSoft.MultilineLabel",
			alternateClassName: "BPMSoft.controls.SelectionHandlerMultilineLabel",
		...
		return BPMSoft.SelectionHandlerMultilineLabel;
	}
);
