define("DesignTimeEnums", ["ext-base", "BPMSoft", "DesignTimeEnumsResources"],
	function() {
		Ext.ns("BPMSoft.DesignTimeEnums");

		/**
		 * @enum {String}
		 * Base schemas unique identifiers.
		 */
		BPMSoft.DesignTimeEnums.BaseSchemaUId = {
			/**
			 * Base object
			 */
		 ...
		 */
		BPMSoft.DesignTimeEnums.SysModuleFolderMode = {
			/**
		 ...
		 * Wizard URL
		 */
		BPMSoft.DesignTimeEnums.WizardUrl = {
			/**
			 * Detail wizard URL.
			 */
		 ...
		 * Default icons id.
		 */
		BPMSoft.DesignTimeEnums.DefaultIcon = {
			/**
		 ...
		 */
		BPMSoft.DesignTimeEnums.SysModuleColumnSizes = {
			/**
		 ...
		 */
		BPMSoft.DesignTimeEnums.EntitySchemaColumnSizes = {
			/**
