/**
 * @class BPMSoft.configuration.DetailRuleColumnsMixin
...
define("DetailRuleColumnsMixin", ["ConfigurationConstants"], function(ConfigurationConstants) {
	Ext.define("BPMSoft.configuration.DetailRuleColumnsMixin", {
		alternateClassName: "BPMSoft.DetailRuleColumnsMixin",
		...
		_getCommunicationRulesConfig: function() {
			...
			const accountCommunications = this._getCommunicationRuleConfig({
				...
				columns: BPMSoft.deepClone(columns)
			});
