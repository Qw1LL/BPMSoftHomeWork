namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class SpecificationTypeSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Тип характеристики.
	/// </summary>
	public class SpecificationType : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class SpecificationType_SpecificationEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SpecificationType
	{
