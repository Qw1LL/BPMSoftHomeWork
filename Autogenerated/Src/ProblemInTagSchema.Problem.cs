namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ProblemInTagSchema : BPMSoft.Configuration.BaseEntityInTagSchema
	{
	...
	/// <summary>
	/// Тег в записи раздела проблемы.
	/// </summary>
	public class ProblemInTag : BPMSoft.Configuration.BaseEntityInTag
	{
	...
	/// <exclude/>
	public partial class ProblemInTag_ProblemEventsProcess<TEntity> : BPMSoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ProblemInTag
	{
