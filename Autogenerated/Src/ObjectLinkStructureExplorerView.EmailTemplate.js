define("ObjectLinkStructureExplorerView", ["ObjectLinkStructureExplorerViewResources", "StructureExplorerViewConfig"],
	function(resources) {
		...
		/**
		 * @class BPMSoft.configuration.ObjectLinkStructureExplorerView
		 * Object link structure explorer view class.
		 */
		Ext.define("BPMSoft.configuration.ObjectLinkStructureExplorerView", {
			extend: "BPMSoft.StructureExplorerViewConfig",
			alternateClassName: "BPMSoft.ObjectLinkStructureExplorerView",

			//region Methods: Protected

			/**
			 * @inheritdoc BPMSoft.StructureExplorerViewConfig#generateMainView
			 * @overridden
			 */
			...
			/**
			 * @inheritdoc BPMSoft.StructureExplorerViewConfig#getHeaderCaption
			 * @overridden
			 */
			...
			/**
			 * @inheritdoc BPMSoft.StructureExplorerViewConfig#getSaveButtonCaption
			 * @overridden
			 */
		...
		return BPMSoft.ObjectLinkStructureExplorerView;
	});
