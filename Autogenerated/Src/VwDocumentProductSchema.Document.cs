namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class VwDocumentProductSchema : BPMSoft.Configuration.DocumentProductSchema
	{
	...
	/// <summary>
	/// Продукт в документе (представление).
	/// </summary>
	public class VwDocumentProduct : BPMSoft.Configuration.DocumentProduct
	{
	...
	/// <exclude/>
	public partial class VwDocumentProduct_DocumentEventsProcess<TEntity> : BPMSoft.Configuration.DocumentProduct_DocumentEventsProcess<TEntity> where TEntity : VwDocumentProduct
	{
