namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class EventFolderSchema : BPMSoft.Configuration.BaseFolderSchema
	{
	...
	/// <summary>
	/// Группа раздела "Мероприятие".
	/// </summary>
	public class EventFolder : BPMSoft.Configuration.BaseFolder
	{
	...
	/// <exclude/>
	public partial class EventFolder_MarketingCampaignEventsProcess<TEntity> : BPMSoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : EventFolder
	{
