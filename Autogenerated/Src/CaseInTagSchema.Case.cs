namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class CaseInTagSchema : BPMSoft.Configuration.BaseEntityInTagSchema
	{
	...
	/// <summary>
	/// Тег в записи раздела обращения.
	/// </summary>
	public class CaseInTag : BPMSoft.Configuration.BaseEntityInTag
	{
	...
	/// <exclude/>
	public partial class CaseInTag_CaseEventsProcess<TEntity> : BPMSoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : CaseInTag
	{
