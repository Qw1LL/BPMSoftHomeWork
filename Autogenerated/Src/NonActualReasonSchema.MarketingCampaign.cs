namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class NonActualReasonSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// <summary>
	/// Причина неактуальности средства связи.
	/// </summary>
	public class NonActualReason : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class NonActualReason_MarketingCampaignEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : NonActualReason
	{
