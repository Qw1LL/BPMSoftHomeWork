define("CasesEstimateLabel", ["CasesEstimateLabelResources", "ext-base", "BPMSoft", "css!CasesEstimateLabel"],
		function(resources, Ext, BPMSoft) {
			 ...
			 * @param container ######### ###########
			 */
			function setClockImage(container) {
