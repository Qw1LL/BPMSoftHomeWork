 ...
 */
define("DcmSchemaStagePropertiesPage", ["ext-base", "BPMSoft", "DcmSchemaStagePropertiesPageResources",
	...
	return {
		mixins: {
			editableContainerListMixin: "BPMSoft.EditableContainerListMixin",
		...
		attributes: {
			 ...
			 * @type {BPMSoft.Designers.DcmSchema}
			 */
			"ParentSchema": {
				type: BPMSoft.ViewModelColumnType.VIRTUAL_COLUMN
			},
			...
			/**
			 * Transition type.
			 * @type {BPMSoft.DcmConstants.StageTransitionType}
			 */
			"TransitionType": {
				dataValueType: BPMSoft.DataValueType.LOOKUP,
				type: BPMSoft.ViewModelColumnType.VIRTUAL_COLUMN,
		...
		methods: {
			...
			_initPermissions: function() {
				...
				const dcmSchemaStagePermission = Ext.create("BPMSoft.DcmSchemaStagePermission", stagePermissionConfig);
			...
			_clearPermissions: function(properties) {
				...
				if (propertyValue === BPMSoft.emptyString) {
			...
			initTransitionType: function() {
				...
				const value = BPMSoft.findWhere(BPMSoft.DcmConstants.StageTransitionType, {
			...
			initStageColumnReferenceEntitySchema: function(callback, scope) {
				...
				BPMSoft.EntitySchemaManager.findBundleSchemaInstance(schemaConfig, function(schema) {
					...
					BPMSoft.EntitySchemaManager.findBundleSchemaInstance(config, function(stageColumnSchema) {
			...
			getLookupRecordListConfig: function() {
				...
				if (entitySchema) {
					...
					var dataCollection = BPMSoft.DataManager.getEntitySchemaData(entitySchema.name);
					...
					dataCollection.each(function(dataItem) {
						...
						if (!BPMSoft.contains(stageRecords, primaryColumnValue)) {
				...
				return BPMSoft.sortObj(resultConfig, "displayValue");
			},
			...
			initDataManager: function(callback, scope) {
				...
				if (schema) {
					...
					BPMSoft.DataManager.select(config, callback, scope);
				} else {
					callback.call(scope);
				}
			},
			 ...
			 * @private
			 * @return {BPMSoft.DcmSchemaStage} Parent stage.
			 */
			 ...
			 * @private
			 * @return {BPMSoft.DcmSchemaStage|null} Previous stage.
			 */
			 ...
			 * @private
			 * @return {BPMSoft.DcmSchema} Parent schema.
			 */
			 ...
			 * @private
			 * @return {BPMSoft.Collection} Stages collection.
			 */
			 ...
			 * @private
			 * @return {BPMSoft.DcmSchemaStage} Current stage.
			 */
			 ...
			 * @private
			 * @param {BPMSoft.DcmStageViewModel} stage Stage view model.
			...
			onColorChange: function() {
				...
				BPMSoft.updateStyleSheet(".dcm-schema-stage-properties-page .t-title-label-stage", "color", color);
			},
			 ...
			 * @private
			 * @param {BPMSoft.DcmSchemaStage} stage current stage.
			 * @param {String} value new display value.
			 */
			updateDataManagerItemDisplayValue: function(stage, value) {
				var entitySchema = this.get("StageColumnReferenceEntitySchema");
				if (entitySchema) {
					var dataManagerItems = BPMSoft.DataManager.getEntitySchemaData(entitySchema.name);
			 ...
			 * @private
			 * @param {BPMSoft.model.BaseViewModel} viewModel Lookup record view model.
			 * @return {String}
			 */
			...
			createLookupRecord: function(lookupRecord) {
				var newValue = BPMSoft.generateGUID();
			...
			onLookupRecordChange: function(viewModel, lookupRecord) {
				var isNewLookupRecord = lookupRecord && BPMSoft.isEmptyGUID(lookupRecord.value);
			...
			createLookupRecordDataManagerItem: function(config, callback, scope) {
				...
				var entitySchema = BPMSoft[stageColumnReferenceEntitySchema.name];
				var createConfig = {
				...
				BPMSoft.DataManager.createItem(createConfig, callback, scope);
			},
			 ...
			 * @return {BPMSoft.Collection} items Container list items.
			 ...
			 * @protected
			 * @return {BPMSoft.Collection} Collections of stage permissions items for editable container list.
			 */
			 ...
			 * @param {BPMSoft.BaseViewModel} item Stage view model.
			...
			saveValues: function() {
				...
				const transitionTypeValue = transitionType
					...
					: BPMSoft.DcmConstants.StageTransitionType.NONE.value;
				...
				if (this._isFeatureDcmStagesPermissionsEnabled()) {
					const usePermissions = this.$UsePermissions;
					const permissions = usePermissions ? permissionsProp.getPermissionsString() : BPMSoft.emptyString;
			 ...
			 * @param {BPMSoft.DataValueType.GUID} stageUId UId for
			 ...
			 * @param {BPMSoft.DataValueType.GUID} source Connected from stage uid.
			 * @param {BPMSoft.DataValueType.GUID} target Connected to stage uid.
			 ...
			 * @param  {BPMSoft.DataValueType.GUID} stageUId Stage uId.
			 * @param {String} moduleId Container list module id.
			 */
			...
			onPrepareTransitionTypeList: function(filter, list) {
				list.clear();
				list.loadAll(BPMSoft.DcmConstants.StageTransitionType);
			},
		...
		diff: /**SCHEMA_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"value": {"bindTo": "Color"},
					"layout": {"column": 0, "row": 14, "colSpan": 24, "rowSpan": 0}
				}
			},
			{
				"operation": "insert",
				...
				"values": {
					...
					"layout": {"column": 0, "row": 13, "colSpan": 24, "rowSpan": 0}
				}
			},
			{
				"operation": "insert",
