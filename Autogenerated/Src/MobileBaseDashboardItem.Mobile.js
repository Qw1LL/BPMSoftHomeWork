/**
 * @class BPMSoft.configuration.BaseDashboardItem
 * Base dashboard item.
 */
Ext.define("BPMSoft.configuration.controls.BaseDashboardItem", {
	...
	config: {
		 ...
		 */
		configGeneratorClassName: "BPMSoft.BaseDashboardItemConfigGenerator"
	 ...
	 * @return {BPMSoft.BaseDashboardItemConfigGenerator} Instance of config generator.
	 */
