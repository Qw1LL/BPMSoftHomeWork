namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class MailBoxTypeSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Тип почтового ящика.
	/// </summary>
	public class MailBoxType : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class MailBoxType_SLMEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MailBoxType
	{
