define("StructureExplorerUtilitiesV2", ["BPMSoft", "ModalBox", "AngularStructureExplorerUtilities"],
	function(BPMSoft, ModalBox, AngularStructureExplorerUtilities) {
		 ...
		 *
		 */
		Ext.define("BPMSoft.configuration.StructureExplorerUtilities", {
			extend: "BPMSoft.BaseObject",
			alternateClassName: "BPMSoft.StructureExplorerUtilities",
			 ...
			 * @param {BPMSoft.BaseViewModel} config.scope The environment in which the method is invoked the handler.
