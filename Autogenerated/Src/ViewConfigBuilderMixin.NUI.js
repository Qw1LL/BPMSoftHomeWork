define("ViewConfigBuilderMixin", ["ViewConfigBuilderMixinResources"], function(resources) {
	Ext.define("BPMSoft.configuration.mixins.ViewConfigBuilderMixin", {
		alternateClassName: "BPMSoft.ViewConfigBuilderMixin",
		...
		addViewConfigs: function(hierarchy) {
			...
			BPMSoft.each(hierarchy, function(hierarchyItem) {
