namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ChangeStatusSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Состояние изменения.
	/// </summary>
	public class ChangeStatus : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class ChangeStatus_ChangeEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ChangeStatus
	{
