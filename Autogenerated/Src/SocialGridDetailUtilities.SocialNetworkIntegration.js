define("SocialGridDetailUtilities", [], function() {
	Ext.define("BPMSoft.configuration.mixins.SocialGridDetailUtilities", {
		alternateClassName: "BPMSoft.SocialGridDetailUtilities",
		 ...
		 * ######### ##### ############# ###### # #########,
		 * ## ## ############# ## ### ###### # ## ###### ######## #######.
		 * @inheritdoc BPMSoft.ConfigurationGridUtilities#addNewRowToCollection
		 * @overridden
		 */
		 ...
		 * @param {Object} config.scope ######## ########## ####### ######### ######.
		 */
		createSocialEntityDataRows: BPMSoft.emptyFn,
		...
		getChangeItemsQueries: function() {
			...
			collection.each(function(item) {
				...
				var selected = this.BPMSoft.contains(selectedItems, itemId);
				if (selected) {
		 ...
		 * ########## ######### ######### ########.
		 * @private
		 * @param {BPMSoft.BaseCommunicationViewModel} item ########### #######.
		 * @return {Object} ######### ######### ########.
		 */
		getItemValidationResult: function(item) {
			...
			if (item.isChanged() && !item.validate()) {
				...
				this.BPMSoft.each(attributes, function(attribute, attributeName) {
