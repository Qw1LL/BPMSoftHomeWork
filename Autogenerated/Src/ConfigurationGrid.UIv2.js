define("ConfigurationGrid", ["css!ConfigurationGrid"], function() {
	...
	Ext.define("BPMSoft.controls.ConfigurationGrid", {
		extend: "BPMSoft.Grid",
		alternateClassName: "BPMSoft.ConfigurationGrid",

		/**
		 * @inheritdoc BPMSoft.Grid#activeRowCss
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#actionsRowTpl
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#selectedRowCss
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#activateRow
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#createActionsRow
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#deactivateRow
		 * @override
		 */
		...
		destroyActiveRowControls: function() {
			BPMSoft.each(this.activeRowControls, function(activeRowControl) {
		...
		/**
		 * @inheritdoc BPMSoft.Grid#formatCellContent
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#initColumnBindings
		 * @override
		 */
		initColumnBindings: function(columnsConfig) {
			...
			BPMSoft.each(columnsConfig, function(configItem) {
					...
					for (var propertyName in configItem) {
						...
						if (Ext.isArray(item)) {
							...
							if (binding) {
								...
								var GridKeyType = BPMSoft.GridKeyType;
		...
		/**
		 * @inheritdoc BPMSoft.Grid#initActionItems
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#onUpdateItem
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#onAfterReRender
		 * @protected
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#onAfterRender
		 * @protected
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#onDestroy
		 * @override
		 */
		...
		onControlsContainerClick: function(event) {
			event.stopEvent();
			this._isOnGridClicking = false;
		},

		/**
		 * @inheritdoc BPMSoft.Grid#onDocumentClick
		 * @override
		 */
		onDocumentClick: function() {
			if (this.activeRow && !this._isOnGridClicking && this.rendered) {
				this.deactivateRows();
			}
		},

		/**
		 * @inheritdoc BPMSoft.Grid#onGridClick
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#onCheckboxClick
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#renderRowActions
		 * @override
		 */
		...
		renderRowControls: function(renderTo, id) {
			...
			BPMSoft.each(rowControls, function(controlConfig) {
		...
		/**
		 * @inheritdoc BPMSoft.Grid#setActiveRow
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#selectMultiRows
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#onEnterPressed
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.Grid#onGridDoubleClick
		 * @override
		 */
		onGridDoubleClick: BPMSoft.emptyFn

	});

	return BPMSoft.ConfigurationGrid;
});
