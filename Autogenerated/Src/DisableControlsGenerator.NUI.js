define("DisableControlsGenerator", ["ViewGeneratorV2"], function() {
	/**
	 * @class BPMSoft.configuration.DisableControlsGenerator
	 * Generator class for disable or enable schema model items. Provides additional binding for generating controls.
	 */
	Ext.define("BPMSoft.configuration.DisableControlsGenerator", {
		extend: "BPMSoft.ViewGenerator",
		alternateClassName: "BPMSoft.DisableControlsGenerator",
		...
		generateModelItem: function(config) {
			if (BPMSoft.Features.getIsEnabled("CompleteCardLockout")) {
	...
	return Ext.create("BPMSoft.DisableControlsGenerator");
});
