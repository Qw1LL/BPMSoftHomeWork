/**
 * @class BPMSoft.configuration.ChartDashboardItem
 * Dashboard item that displays chart widget.
 */
Ext.define("BPMSoft.configuration.controls.ChartDashboardItem", {
	extend: "BPMSoft.configuration.controls.BaseDashboardItem",
	alternateClassName: "BPMSoft.ChartDashboardItem",
	...
	config: {
		...
		/**
		 * @cfg {Object} customChartConfig Custom configuration for BPMSoft.Chart.
		 */
		 ...
		 * @inheritdoc
		 */
		configGeneratorClassName: "BPMSoft.ChartDashboardItemConfigGenerator"
	...
	createChart: function() {
		...
		this.chart = Ext.create("BPMSoft.Chart", config);
		return this.chart;
	},
	...
	initializeFullscreenButton: function() {
		if (this.config.rawConfig.widgetType !== BPMSoft.DashboardItemWidgetType.Chart) {
			return;
		}
		this.callParent(arguments);
	},
	...
	/**
	 * Returns chart.
	 * @returns {BPMSoft.Chart} Instance of chart.
	 */
	getChart: function() {
		return this.chart;
	},
