...
define("SimpleTaskAddModule", ["SimpleTaskAddModuleResources", "ConfigurationEnums",  "ConfigurationConstants",
	...
	function(resources, ConfigurationEnums, ConfigurationConstants, ProcessModuleUtilities) {
		/**
		 * @class BPMSoft.configuration.SimpleTaskAddModule
		 * ##### SimpleTaskAddModule ############ ### ########## ###### ## ############ #### # ##########
		 */
		Ext.define("BPMSoft.configuration.SimpleTaskAddModule", {
			alternateClassName: "BPMSoft.SimpleTaskAddModule",
			...
			getModifyActivityIcon: function() {
				return {
					...
					url: this.BPMSoft.ImageUrlBuilder.getUrl(resources.localizableImages.ModifyTaskIcon)
				};
			},
			...
			getViewModel: function(config, callback) {
				...
				var generatorConfig = this.BPMSoft.deepClone(config);
		...
		return BPMSoft.SimpleTaskAddModule;
	});
