namespace BPMSoft.Configuration
{
	...
	#region Class: Case_Problem_BPMSoftSchema

	/// <exclude/>
	public class Case_Problem_BPMSoftSchema : BPMSoft.Configuration.Case_Portal_BPMSoftSchema
	{

		#region Constructors: Public

		public Case_Problem_BPMSoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Case_Problem_BPMSoftSchema(Case_Problem_BPMSoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Case_Problem_BPMSoftSchema(Case_Problem_BPMSoftSchema source)
			: base(source) {
		}
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Case_Problem_BPMSoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new Case_Problem_BPMSoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Case_Problem_BPMSoftSchema(this, true);
		}
	...
	#region Class: Case_Problem_BPMSoft

	/// <summary>
	/// Обращение.
	/// </summary>
	public class Case_Problem_BPMSoft : BPMSoft.Configuration.Case_Portal_BPMSoft
	{

		#region Constructors: Public

		public Case_Problem_BPMSoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Case_Problem_BPMSoft";
		}

		public Case_Problem_BPMSoft(Case_Problem_BPMSoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Case_Problem_BPMSoftDeleted", e);
			Saved += (s, e) => ThrowEvent("Case_Problem_BPMSoftSaved", e);
			SaveError += (s, e) => ThrowEvent("Case_Problem_BPMSoftSaveError", e);
			Validating += (s, e) => ThrowEvent("Case_Problem_BPMSoftValidating", e);
		...
		public override object Clone() {
			return new Case_Problem_BPMSoft(this);
		}
	...
	/// <exclude/>
	public partial class Case_ProblemEventsProcess<TEntity> : BPMSoft.Configuration.Case_PortalEventsProcess<TEntity> where TEntity : Case_Problem_BPMSoft
	{
	...
	/// <exclude/>
	public class Case_ProblemEventsProcess : Case_ProblemEventsProcess<Case_Problem_BPMSoft>
	{
