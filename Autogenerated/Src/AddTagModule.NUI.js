define("AddTagModule", ["AddTagViewModule", "AddTagView", "AddTagModuleResources"],
	function(AddTagViewModule, AddTagView) {
		var addTagModule = Ext.define("BPMSoft.configuration.AddTagModule", {
			extend: "BPMSoft.BaseModule",
			alternateClassName: "BPMSoft.AddTagModule",
			Ext: null,
			BPMSoft: null,
			sandbox: null,
			viewModel: null,
			...
			adjustTagViewModel: function() {
				...
				viewModel.getTagViewModel = function(tagName, config) {
					var tagViewModelConfig = this.Ext.create("BPMSoft.BaseViewModel", config);
					...
					var tagView = this.Ext.create("BPMSoft.Container",
				...
				viewModel.goToSection = function(tagName) {
					...
					var sectionName = BPMSoft.configuration.ModuleStructure[schema].sectionSchema;
			...
			init: function() {
				...
				var viewModel = this.viewModel = Ext.create("BPMSoft.BaseViewModel", modelConfig);
			...
			render: function(renderTo) {
				...
				var view = this.view = this.Ext.create("BPMSoft.Container", viewConfig);
