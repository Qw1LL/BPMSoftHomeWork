	...
	function(resources, sourceCodeEditEnums) {
		return {
			...
			methods: {
				 ...
				 * @private
				 * @param {BPMSoft.ProcessFlowElementSchema} processElement Process element.
				 * @return {Boolean}
				 */
				getIsUserTask: function(processElement) {
					return processElement instanceof BPMSoft.ProcessUserTaskSchema ||
						processElement instanceof BPMSoft.ProcessSchemaUserTask;
				},
				 ...
				 * @private
				 * @param {Function} callback Callback function.
				 * @param {BPMSoft.UserTaskSchema} callback.userTaskSchema UserTask schema instance.
				 * @param {Object} scope Callback function call context.
				 */
				getUserTaskSchema: function(callback, scope) {
					...
					if (Ext.isEmpty(schemaUId) || BPMSoft.isEmptyGUID(schemaUId)) {
						callback.call(scope, null);
						return;
					}
					BPMSoft.ProcessUserTaskSchemaManager.forceGetInstanceByUId(userTask.schemaUId, callback, scope);
				},
				...
				_changeSchemaParameterMapping: function(element, newUId, oldUID) {
					...
					var processElementParameterMacros = BPMSoft.FormulaMacros.prepareProcessElementParameterValue(
						element.uId, oldUID);
				...
				init: function(callback, scope) {
					this.callParent([function() {
						...
						if (this.useNotification && this.schemaManagerName) {
							BPMSoft[this.schemaManagerName].on("outdated", this.onSchemaOutdated, this);
						}
				 ...
				 * @protected
				 * @param {BPMSoft.UserTaskSchema} userTaskSchema UserTask schema instance.
				 * @param {Function} callback Callback function.
				 * @param {Object} scope Callback function call context.
				 */
				 ...
				 * @private
				 * @param {BPMSoft.ProcessSchema} oldSchema Old schema.
				 */
				 ...
				 * @protected
				 */
				initHasCompileModeLimitations: BPMSoft.emptyFn,
				 ...
				 */
				synchronizeSchemaParameters: BPMSoft.abstractFn,
				 ...
				 * @param {BPMSoft.manager.ProcessSchemaParameter} newParameter New parameter.
				 * @param {BPMSoft.manager.ProcessSchemaParameter} oldParameter Old parameter.
				 */
				...
				_synchronizeNestedParameters: function(element, newParameter, oldParameter) {
					if (!BPMSoft.Features.getIsEnabled("ManageProcessCollectionParameters")) {
						return;
					}
				...
				onDestroy: function() {
					if (this.useNotification && this.schemaManagerName) {
						BPMSoft[this.schemaManagerName].un("outdated", this.onSchemaOutdated, this);
					}
					this.callParent(arguments);
				},
				 ...
				 * @protected
				 * @param {BPMSoft.ProcessSchemaParameterCollection|BPMSoft.Collection} parametersCollection Collection of parameters.
				 */
				getRootsParameters: function(parametersCollection) {
					return parametersCollection instanceof BPMSoft.ProcessSchemaParameterCollection
				...
				getCompileModeLimitationsInfoContent: function() {
					return BPMSoft.Resources.ProcessSchemaDesigner.Messages.CollectionInCompileProcessInfoText;
				},
