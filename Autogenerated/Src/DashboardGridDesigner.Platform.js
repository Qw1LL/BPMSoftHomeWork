	...
	return {
		...
		methods: {
			...
			applyGridConfig: function(profile) {
				...
				var newGridConfig = BPMSoft.decode(profile.listedConfig);
			...
			getOrderColumnConfig: function() {
				...
				BPMSoft.each(gridItems, function(column) {
			 ...
			 */
			getProfile: function() {
				var gridConfig = BPMSoft.encode(this.get("gridConfig"));
				var profile = {
					isTiled: false,
			...
			/**
			 * @inheritdoc BPMSoft.BaseWidgetDesigner#refreshWidget.
			 * @overridden
			 */
			...
			_findOrderColumns: function() {
				...
				return BPMSoft.filter(columns, function(column) {
			...
			_setOrderColumnAttributes: function(orderColumns) {
				BPMSoft.each(orderColumns, function(column) {
			 ...
			 * @protected
			 * @virtual
			 * @param {BPMSoft.BaseEntitySchema} entitySchema Entity schema.
			 */
			...
			/**
			 * @inheritdoc BPMSoft.BaseWidgetDesigner#canRefreshWidget.
			 * @overridden
			 */
			...
			/**
			 * @inheritdoc BPMSoft.BaseWidgetDesigner#loadFilterModule.
			 * @overridden
			 */
