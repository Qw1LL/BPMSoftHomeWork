define("CommunicationOptionsMixin", ["EmailHelper", "CtiLinkColumnUtility", "EmailLinksMixin"],
	function(EmailHelper) {
		...
		/**
		 * @class BPMSoft.configuration.mixins.CommunicationOptionsMixin.
		 * Provides methods for communication options usage.
		 */
		Ext.define("BPMSoft.configuration.mixins.CommunicationOptionsMixin", {
			extend: "BPMSoft.CtiLinkColumnUtility",
			alternateClassName: "BPMSoft.CommunicationOptionsMixin",
			...
			_safeExecute: function(action, args) {
				try {
					...
					this.log(e.ToString(), BPMSoft.LogMessageType.ERROR);
				}
			},
			 ...
			 * @param {BPMSoft.Collection} relationFields Call instance crelation column values collection.
			 ...
			 * @protected
			 * @return {BPMSoft.Collection} Profile schema relation fields values collection.
			 */
			 ...
			 * @param {String} number Phone number to call.
			 * @param {String} contactId Contact record unique identifier.
			 * @param {BPMSoft.Collection} relationFields Related lookup values collection.
			 * @return {Boolean} False to stop click event propagation.
			 */
