		...
		return {
			...
			methods: {
				...
				init: function() {
					...
					this.set("PrimaryColumnValue", this.BPMSoft.generateGUID());
				 ...
				 * @protected
				 */
				initDefaultValues: BPMSoft.emptyFn,

				/**
				 * Returns mask caption.
				 * @return {string} Mask Caption
				 */
				getPublishMaskCaption: BPMSoft.emptyFn,
				...
				_actualizeCanBeDestroyedState: function(cacheKey) {
					var cache = this.BPMSoft.ClientPageSessionCache.getItem(cacheKey);
				 ...
				 */
				getServiceConfig: this.BPMSoft.emptyFn,
				 ...
				 * @virtual
				 */
				onNewCardSaved: this.BPMSoft.emptyFn,
				 ...
				 * @virtual
				 */
				onDashboardRealoaded: this.BPMSoft.emptyFn,
				...
				initDropzoneEvents: function() {
					...
					this.BPMSoft.ConfigurationFileApi.initDropzoneEvents.call(this, dropZoneContainer,
