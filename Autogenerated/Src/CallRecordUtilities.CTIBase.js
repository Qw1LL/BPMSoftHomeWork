define("CallRecordUtilities", ["BPMSoft", "CallRecordUtilitiesResources", "CtiConstants", "RightUtilities"],
	function(BPMSoft, resources, ctiConstants, RightUtilities) {

		/**
		 * @class BPMSoft.configuration.mixins.CallRecordUtilities
		 * Call record utilities mixin.
		 * @type {BPMSoft.BaseObject}
		 */
		Ext.define("BPMSoft.configuration.mixins.CallRecordUtilities", {
			extend: "BPMSoft.BaseObject",
			alternateClassName: "BPMSoft.CallRecordUtilities",
			 ...
			 * @return {BPMSoft.BaseViewModel} Grid row view-model.
			 */
		...
		return Ext.create("BPMSoft.configuration.mixins.CallRecordUtilities");
	});
