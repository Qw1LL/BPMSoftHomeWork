 ...
 */
define("EmbeddedProcessSchemaPropertiesPage", ["BPMSoft", "EmbeddedProcessSchemaPropertiesPageResources",
	...
	return {
		...
		methods: {
			...
			initLocalizableStrings: function(schema) {
				...
				BPMSoft.each(schema.localizableStrings, function(localizableString) {
			...
			createLocalizableStringViewModel: function(config) {
				const caption = config.caption || Ext.create("BPMSoft.LocalizableString");
				const value = config.value || Ext.create("BPMSoft.LocalizableString");
				const toolButtonConfig = this._getToolButtonConfig(config.isEditable);
				const viewModel = Ext.create("BPMSoft.ProcessSchemaLocalizableStringViewModel", {
					values: {
						Id: config.id,
						Name: config.name,
						Caption: caption,
			 ...
			 * @private
			 * @param {BPMSoft.model.ProcessSchemaLocalizableStringViewModel} localizableStringViewModel
			...
			updateLocalizableStrings: function(schema) {
				const localizableStringViewModels = this.get("LocalizableStringViewModels");
				let isChanged = false;
				BPMSoft.each(localizableStringViewModels, function(viewModel) {
			...
			removeLocalizableStrings: function(schema) {
				...
				const localizableStringViewModels = this.get("LocalizableStringViewModels");
				const localizableStrings = schema.localizableStrings;
				BPMSoft.each(localizableStrings, function(localizableString) {
