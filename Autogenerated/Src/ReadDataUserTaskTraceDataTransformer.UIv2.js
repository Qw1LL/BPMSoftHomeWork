define("ReadDataUserTaskTraceDataTransformer", ["BPMSoft", "ext-base", "ProcessUserTaskConstants"],
	function(BPMSoft, Ext, ProcessUserTaskConstants) {
	/**
	 * Class ReadDataUserTaskTraceDataTransformer.
	 */
	Ext.define("BPMSoft.configuration.ReadDataUserTaskTraceDataTransformer", {
		extend: "BPMSoft.BaseObject",
		alternateClassName: "BPMSoft.ReadDataUserTaskTraceDataTransformer",
		...
		_replaceAggregationType: function() {
			var aggregationTypeInvertEnum = _.invert(BPMSoft.AggregationType);
	...
	return BPMSoft.ReadDataUserTaskTraceDataTransformer;
});
