namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ServicePactFolderSchema : BPMSoft.Configuration.BaseFolderSchema
	{
	...
	/// <summary>
	/// Группа раздела "Сервисные договоры".
	/// </summary>
	public class ServicePactFolder : BPMSoft.Configuration.BaseFolder
	{
	...
	/// <exclude/>
	public partial class ServicePactFolder_SLMITILServiceEventsProcess<TEntity> : BPMSoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ServicePactFolder
	{
