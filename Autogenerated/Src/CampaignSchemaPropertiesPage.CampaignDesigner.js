	...
	function(resources, MarketingEnums, SysAdminUnit) {
		return {
			...
			methods: {
				 ...
				 * @private
				 * @param {BPMSoft.CampaignSchema} campaignSchema Current campaign schema.
				 */
				...
				_getWarningValidationResult: function(columnName, message) {
					return {
						...
						validationType: BPMSoft.ValidationType.WARNING,
				 ...
				 * @private
				 * @param {BPMSoft.CampaignSchema} schema Current campaign schema.
				 */
				...
				_setDefaultTimeZone: function() {
					if (!this.$TimeZoneCode) {
						...
						BPMSoft.each(this.$TimeZoneEnum, function(item) {
				...
				_setDefaultCampaignFirePeriod: function() {
					if (!this.$DefaultCampaignFirePeriodValue) {
						...
						BPMSoft.each(this.$CampaignFirePeriodList, function(item) {
				 ...
				 * @private
				 * @param {BPMSoft.Designers.CampaignSchema} campaignSchema Campaign schema.
				 */
				...
				*/
				 ...
				 * @param {BPMSoft.Collection} list Current collection to bind.
				 */
