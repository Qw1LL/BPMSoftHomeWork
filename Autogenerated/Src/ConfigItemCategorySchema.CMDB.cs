namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ConfigItemCategorySchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// <summary>
	/// Категория конфигурационной единицы.
	/// </summary>
	public class ConfigItemCategory : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class ConfigItemCategory_CMDBEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ConfigItemCategory
	{
