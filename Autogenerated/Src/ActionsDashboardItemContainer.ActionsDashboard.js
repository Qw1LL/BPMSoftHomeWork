define("ActionsDashboardItemContainer", ["ext-base", "BPMSoft"], function(Ext, BPMSoft) {

	Ext.define("BPMSoft.controls.ActionsDashboardItemContainer", {
		alternateClassName: "BPMSoft.ActionsDashboardItemContainer",
	...
	return BPMSoft.controls.ActionsDashboardItemContainer;
});
