  define("SectionServiceMixin", [],
	function() {
		/**
		 * @class BPMSoft.configuration.mixins.SectionServiceMixin
		 * Section service mixin.
		 */
		Ext.define("BPMSoft.configuration.mixins.SectionServiceMixin", {
			alternateClassName: "BPMSoft.SectionServiceMixin",
			 ...
			 * @protected
			 */
			processedSectionTypes: BPMSoft.emptyFn,

			/**
			 * Processed receiving general and portal sections from service.
			 * @protected
			 */
			processedGeneralAndSspSections: BPMSoft.emptyFn,
