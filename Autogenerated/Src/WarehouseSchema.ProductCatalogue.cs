namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class WarehouseSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Склад.
	/// </summary>
	public class Warehouse : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class Warehouse_ProductCatalogueEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : Warehouse
	{
