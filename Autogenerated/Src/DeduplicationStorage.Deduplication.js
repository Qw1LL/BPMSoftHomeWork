/**
 * @class BPMSoft.configuration.DeduplicationStorage
 */
define("DeduplicationStorage", ["ServiceHelper"], function(ServiceHelper) {
	Ext.define("BPMSoft.configuration.DeduplicationStorage", {
		extend: "BPMSoft.BaseObject",
		alternateClassName: "BPMSoft.DeduplicationStorage",
		...
		_getResultGroups: function(count) {
			const resultGroups = [];
			let totalCount = 0;
			BPMSoft.each(this.groups, function(group, groupId) {
				if (group.compled) {
