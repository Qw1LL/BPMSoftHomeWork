...
Ext.define("BPMSoft.configuration.controller.ActivityParticipantGridPage", {
	extend: "BPMSoft.controller.BaseGridPage",
	alternateClassName: "BPMSoft.configuration.ActivityParticipantGridPageController",
	...
	createContactsPicker: function(store, model) {
		...
		return Ext.create("BPMSoft.LookupPicker", {
			component: {
				store: store,
	...
	getPickerQueryConfig: function() {
		var lookupQueryConfig = BPMSoft.sdk.LookupGridPage.getQueryConfig("Contact");
	...
	onPickerSelect: function(grid, selectedRecord) {
		...
		newRecord.save({
			...
			success: function() {
				this.loadStore();
				BPMSoft.PageNavigator.markPreviousPagesAsDirty();
			},
