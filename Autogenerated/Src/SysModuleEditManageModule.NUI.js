define("SysModuleEditManageModule", ["NetworkUtilities", "MiniPageUtilities", "BaseModule"],
	function(NetworkUtilities) {
		...
		/**
		 * @class BPMSoft.configuration.SysModuleEditManageModule
		 ...
		 */
		Ext.define("BPMSoft.configuration.SysModuleEditManageModule", {
			extend: "BPMSoft.BaseModule",
			alternateClassName: "BPMSoft.SysModuleEditManageModule",
			mixins: {
			...
			getModuleId: function(moduleConfig) {
				...
				var tag = moduleConfig.tag || BPMSoft.GUID_EMPTY;
				var typeColumnValue = moduleConfig.typeColumnValue || BPMSoft.GUID_EMPTY;
				var idPostfix = BPMSoft.generateGUID();
			 ...
			 * @param {BPMSoft.BaseViewModel} config.item Quick menu item view model.
			 ...
			 * @param {BPMSoft.ConfigurationEnums.CardOperation} config.operation Operation, that will pass to card.
		...
		return Ext.create("BPMSoft.SysModuleEditManageModule");
	});
