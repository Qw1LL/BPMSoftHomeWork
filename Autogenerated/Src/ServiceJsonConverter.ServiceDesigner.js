define("ServiceJsonConverter", [], function() {
	...
	Ext.define("BPMSoft.services.ServiceJsonConverter", {
		alternateClassName: "BPMSoft.ServiceJsonConverter",
		...
		detectAuthType: function(json) {
			this._setAuthType(json, BPMSoft.services.enums.AuthType.None);
			if (json[this.sectionRequest][this.sectionHeader] &&
				...
				if (authHeader.indexOf("Basic") === 0) {
					this._setAuthType(json, BPMSoft.services.enums.AuthType.Basic);
	...
	return BPMSoft.ServiceJsonConverter;
