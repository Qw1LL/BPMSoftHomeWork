define("ConfigurationItemGenerator", ["ContainerList", "ViewGeneratorV2"], function() {
	/**
	 * @class BPMSoft.configuration.ConfigurationItemGenerator
	 * Configuration item view generator class.
	 */
	Ext.define("BPMSoft.configuration.ConfigurationItemGenerator", {
		alternateClassName: "BPMSoft.ConfigurationItemGenerator",
		...
		generateHierarchicalContainerList: function(config, generatorConfig) {
			...
			containerListConfig.className = "BPMSoft.HierarchicalContainerList";
	...
	return Ext.create("BPMSoft.ConfigurationItemGenerator");
});
