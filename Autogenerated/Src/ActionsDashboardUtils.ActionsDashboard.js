define("ActionsDashboardUtils", [
	...
	Ext.define("BPMSoft.manager.ActionsDashboardUtils", {
		extend: "BPMSoft.core.BaseObject",
		alternateClassName: "BPMSoft.ActionsDashboardUtils",
		singleton: true,
		 ...
		 * @param {Object} config Mask config {@link BPMSoft.controls.Mask#show}.
		 */
		...
		hideMask: function() {
			...
			BPMSoft.each(masks, function(el) {
				Ext.removeNode(el);
			}, this);
		}
	...
	return BPMSoft.ActionsDashboardUtils;
});
