define("CallSectionGridRowViewModel", ["CallSectionGridRowViewModelResources", "CtiConstants",
	...
	function(resources, ctiConstants) {
		...
		/**
		 * @class BPMSoft.configuration.CallSectionGridRowViewModel
		 * ##### ###### ############# ###### ####### "######".
		 */
		Ext.define("BPMSoft.configuration.CallSectionGridRowViewModel", {
			extend: "BPMSoft.BaseSectionGridRowViewModel",
			alternateClassName: "BPMSoft.CallSectionGridRowViewModel",
			Ext: null,
			BPMSoft: null,
			sandbox: null,
