define("MiniPageListener", ["sandbox", "MaskHelper", "ModuleUtils", "BaseModule", "AlignableContainer",
	...
	Ext.define("BPMSoft.configuration.MiniPageListener", {
		extend: "BPMSoft.BaseModule",
		alternateClassName: "BPMSoft.MiniPageListener",
		 ...
		 * @type {String}
		 */
		viewModelClass: "BPMSoft.MiniPageContainerViewModel",
		 ...
		 * @return {BPMSoft.Container} Instance of MiniPage container.
		 */
		initView: function() {
		...
		initEvents: function(options) {
			...
			this.viewModel.allowClickPropagation = options.allowClickPropagation === false ? false : true;
			if (container) {
		...
		unsubscribeContainerEvents: function(container) {
			...
			container.un('click', scope.onContainerClick, scope);
		},
		...
		subscribeContainerEvents: function(container, isFixed) {
			...
			container.on('click', scope.onContainerClick, scope);
			if (!isFixed) {
		...
		open: function(config) {
			var addOperation = config.operation === BPMSoft.ConfigurationEnums.CardOperation.ADD;
			if (addOperation) {
