	...
	function(OperatorSingleWindowConstants, QueueClientNotificationUtilities, resources) {
		return {
			...
			mixins: {
				...
				/**
				 * @class BPMSoft.QueueSortUtilities implements queue sorting features.
				 */
			...
			methods: {
				...
				getFilters: function() {
					...
					if (!showProcessedQueueItem) {
						filters.add("ShowProcessedQueueItemFilter", this.BPMSoft.createColumnFilterWithParameter(
				...
				/**
				 * @inheritdoc BPMSoft.BaseSectionV2#getDefaultAnalyticsDataViewCaption
				 * @overridden
				 */
				...
				/**
				 * @inheritdoc BPMSoft.BaseSectionV2#getFolderEntitiesNames
				 * @overridden
				 */
				...
				/**
				 * @inheritdoc BPMSoft.BaseSectionV2#getFolderManagerConfig
				 * @overridden
				 */
				...
				/**
				 * @inheritdoc BPMSoft.GridUtilities#addReportDataColumns
				 * @overridden
				 */
				...
				/**
				 * @inheritdoc BPMSoft.WizardUtilities#canUseWizard
				 * @overridden
				 */
				...
				/**
				 * @inheritdoc BPMSoft.QueueSortUtilities#getInitialQueueSortConfig
				 * @overridden
				 */
				...
				loadQueuesSettingsDataView: function() {
					...
					this.sandbox.publish("PushHistoryState", {
						hash: this.BPMSoft.combinePath("SectionModuleV2", queuesSettingsModuleName),
						stateObj: {
				...
				openQueueItemStatusesLookup: function(callback) {
					...
					filters.addItem(this.BPMSoft.createColumnFilterWithParameter(
						this.BPMSoft.ComparisonType.EQUAL, "IsFinal", true, this.BPMSoft.DataValueType.BOOLEAN));
				...
				changeQueueItemsOperators: function(queueItemIds, operatorId, callback) {
					var update = this.Ext.create("BPMSoft.UpdateQuery", {rootSchemaName: "QueueItem"});
					var filters = update.filters;
					filters.add("IdFilter", update.createColumnInFilterWithParameters("Id", queueItemIds));
					var bpmsoft = this.BPMSoft;
					var dataValueType = bpmsoft.DataValueType;
					if (operatorId) {
						...
						filterGroup.add("AnotherOperatorFilter", update.createColumnFilterWithParameter(
							BPMSoft.ComparisonType.NOT_EQUAL, "Operator", operatorId));
				...
				changeQueueItemsStatus: function(queueItemIds, status, callback) {
					...
					var filters = update.filters;
					filters.add("IdFilter", update.createColumnInFilterWithParameters("Id", queueItemIds));
					var dataValueType = this.BPMSoft.DataValueType;
					filters.add("NotNewStatusFilter", update.createColumnFilterWithParameter(
						this.BPMSoft.ComparisonType.NOT_EQUAL, "Status", status, dataValueType.LOOKUP));
				...
				onAssignOperatorMenuItemClick: function() {
					...
					filters.addItem(this.BPMSoft.createColumnIsNotNullFilter("[SysAdminUnit:Contact].Id"));
					config.filters = filters;
