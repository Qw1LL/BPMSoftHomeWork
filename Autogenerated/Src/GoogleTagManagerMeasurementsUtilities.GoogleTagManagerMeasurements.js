define("GoogleTagManagerMeasurementsUtilities", ["GoogleTagManagerUtilities", "performancecountermanager"
	 ...
	 */
	Ext.define("BPMSoft.configuration.mixins.GoogleTagManagerMeasurementsUtilities", {
		extend: "BPMSoft.core.BaseObject",
		alternateClassName: "BPMSoft.GoogleTagManagerMeasurementsUtilities",
		...
		startGoogleTagManagerMeasurements: function() {
			if (BPMSoft.CurrentUser.userType !== BPMSoft.UserType.SSP) {
				BPMSoft.SysSettings.querySysSettingsItem("UseGoogleTagManager", function(value) {
					if (value) {
