define("MenuUtilities", ["ext-base"], function(Ext) {
	/**
	 * @class BPMSoft.configuration.MenuUtilities
	 * ##### MenuUtilities ############ ### ######## ######### ####.
	 */
	var menuUtilitiesClass = Ext.define("BPMSoft.configuration.MenuUtilities", {
		alternateClassName: "BPMSoft.MenuUtilities",
