...
define("ContainerList", [], function() {
	 ...
	 */
	return Ext.define("BPMSoft.controls.ContainerList", {
		extend: "BPMSoft.Container",
		alternateClassName: "BPMSoft.ContainerList",
		...
		init: function() {
			...
			this.rowIds = Ext.create("BPMSoft.Collection");
			this.addEvents(
				/**
		 ...
		 * @param {BPMSoft.data.modules.BaseViewModel} model Data model.
		 */
		bind: function(model) {
		...
		initDomEvents: function() {
			this.callParent(arguments);
			this.debounceWindowScroll = this.debounceWindowScroll || BPMSoft.debounce(this.onWindowScroll, 10);
		...
		getItemViewConfig: function(item) {
			...
			itemConfig = BPMSoft.deepClone(itemConfig);
		...
		getItemView: function(item) {
			...
			var className = itemConfig && itemConfig.className ? itemConfig.className : "BPMSoft.Container";
		...
		/**
		 * The event handler for the "data Loaded" collection {@link BPMSoft.Collection}
		 * @protected
		 * @param {BPMSoft.Collection} items
		 * @param {BPMSoft.Collection} newItems
		 */
		...
		/**
		 * "add" event handler for collection BPMSoft.Collection
		 * @protected
		 * @param {BPMSoft.BaseViewModel} item Collection element.
		...
		/**
		 * "remove" event handler for collection BPMSoft.Collection
		 * @protected
		...
		/**
		 * @inheritdoc BPMSoft.Component#getMaskConfig
		 * @override
		 */
		...
		getEmptyMessageConfig: function() {
			...
			if (emptyMessageConfig && emptyMessageConfig.className) {
				return BPMSoft.deepClone(emptyMessageConfig);
			}
			return null;
		},
