define("FiltersContainerViewModel", ["StorageUtilities"], function(StorageUtilities) {
	/**
	 * @class BPMSoft.configuration.FiltersContainerViewModel
	 * ##### ###### ############# ########## ########.
	 */
	Ext.define("BPMSoft.configuration.FiltersContainerViewModel", {
		alternateClassName: "BPMSoft.FiltersContainerViewModel",
		...
		init: function(callback, scope) {
			...
			this.set("filtersViewModels", this.Ext.create("BPMSoft.Collection"));
		 ...
		 * @return {BPMSoft.Collection} A collection of view models.
		 */
		 ...
		 * @return {BPMSoft.BaseFilterViewModel} ###### ############# #######.
		 */
		...
		getFilterClassConfig: function(filterConfig) {
			...
			return {
				className: "BPMSoft.BaseFilterViewModel",
				Ext: this.Ext,
		 ...
		 */
		getFilters: function() {
			var filtersCollection = this.Ext.create("BPMSoft.FilterGroup");
		 ...
		 * @return {BPMSoft.BaseFilterViewModel} View model of the filter.
		 */
		 ...
		 * @virtual
		 * @param {String} filterName ### ###### ############# #######.
		 * @param {BPMSoft.FilterGroup} filter ##### ######## ########.
		 */
