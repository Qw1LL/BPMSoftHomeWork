define("DynamicContentBlockViewModel", ["DynamicContentBlockViewModelResources", "ContentBlockViewModel",
	...
	function(resources) {
		...
		/**
		 * @class BPMSoft.controls.DynamicContentBlockViewModel
		 */
		Ext.define("BPMSoft.DynamicContentBlockViewModel", {
			extend: "BPMSoft.ContentBlockViewModel",

			/**
			 * @inheritdoc BPMSoft.BaseContentBlockViewModel#className
			 * @override
			 */
			className: "BPMSoft.DynamicContentBlock",
		...
		return BPMSoft.DynamicContentBlockViewModel;
	}
);
