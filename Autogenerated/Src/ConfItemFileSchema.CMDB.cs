namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ConfItemFileSchema : BPMSoft.Configuration.FileSchema
	{
	...
	/// <summary>
	/// Объект для детали файлы и ссылки объекта раздела "Конфигурационные единицы".
	/// </summary>
	public class ConfItemFile : BPMSoft.Configuration.File
	{
	...
	/// <exclude/>
	public partial class ConfItemFile_CMDBEventsProcess<TEntity> : BPMSoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ConfItemFile
	{
