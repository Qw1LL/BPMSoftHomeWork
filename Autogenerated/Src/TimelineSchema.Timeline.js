		...
		return {
			...
			attributes: {
				...
				"DefaultItemViewClassName": {
					...
					type: this.BPMSoft.ViewModelColumnType.VIRTUAL_COLUMN,
					value: "BPMSoft.BaseTimelineItemView"
				},
				...
				"DefaultTimelineDataStorageClassName": {
					dataValueType: this.BPMSoft.DataValueType.TEXT,
					type: this.BPMSoft.ViewModelColumnType.VIRTUAL_COLUMN,
					value: "BPMSoft.TimelineDataStorage"
				},
				...
				"DefaultOrderDirection": {
					...
					type: this.BPMSoft.ViewModelColumnType.VIRTUAL_COLUMN,
					value: this.BPMSoft.OrderDirection.DESC
				},
				...
				/**
				 * Current order direction caption.
				 */
				"OrderDirectionCaption": {
					dataValueType: this.BPMSoft.DataValueType.CUSTOM_OBJECT,
					type: this.BPMSoft.ViewModelColumnType.VIRTUAL_COLUMN
				},
			...
			methods: {
				...
				initDataStorage: function(config) {
					...
					this.initOrderDirectionCaption();
				},
				...
				initOrderDirectionIcon: function() {
					...
					var orderDirectionIcon = timelineConfig.orderDirection === BPMSoft.OrderDirection.ASC
				...
				initOrderDirectionCaption: function() {
					var timelineConfig = this.$TimelineConfig;
					var orderDirectionCaption = timelineConfig.orderDirection === BPMSoft.OrderDirection.ASC
						? this.get("Resources.Strings.OrderDirectionAscCaption")
						: this.get("Resources.Strings.OrderDirectionDescCaption");
					this.set("OrderDirectionCaption", orderDirectionCaption);
				},
				...
				applyEntitiesConfig: function(pageEntities) {
					var defaultIcon = this.BPMSoft.ImageUrlBuilder.getUrl(this.get("Resources.Images.DefaultIcon"));
					var baseEntitiesConfig = this.BPMSoft.deepClone(this.BPMSoft.TimelineManager.getTileConfig());
					this.BPMSoft.each(pageEntities, function(entityConfig, index, list) {
				...
				initTimelineConfig: function() {
					var timelineConfig = this.BPMSoft.deepClone(this.get("InitialConfig")) || {};
					var entities = this.BPMSoft.TimelineManager.getTimelinePageConfig(this.$CardSchemaName);
				 ...
				 * @protected
				 * @param {BPMSoft.BaseViewModel} item Timeline collection item.
				 */
				 ...
				 * @protected
				 * @param {BPMSoft.Collection} collection Collection of timeline items to modify.
				 */
				 ...
				 * @protected
				 * @param {BPMSoft.BaseModel} model Item model object.
				 ...
				 * @protected
				 * @return {BPMSoft.TimelineDataStorage} Timeline data storage.
				 */
				 ...
				 * @protected
				 * @return {BPMSoft.ViewGenerator} View Generator.
				 */
				createItemsViewGenerator: function() {
					var viewGenerator = this.Ext.create("BPMSoft.TimelineItemsViewGenerator");
				 ...
				 * @protected
				 * @param {BPMSoft.BaseTimelineItemViewModel} item Container list item.
				...
				getEmptyTimelineImageContainerViewConfig: function(messageProperties) {
					return {
						...
						items: [{
							...
							imageSrc: this.BPMSoft.ImageUrlBuilder.getUrl(messageProperties.image)
						}]
					};
				},
				...
				requireTileClasses: function(callback, scope) {
					...
					this.BPMSoft.each(timelineConfig.entities, function(entityConfig) {
					...
					this.BPMSoft.require(viewModuleNames, function() {
						this.BPMSoft.require(resourcesModuleNames, callback, scope);
					}, this);
				},
				...
				requireDataProviders: function(callback, scope) {
					var moduleNames = [];
					var timelineConfig = this.$TimelineConfig;
					BPMSoft.each(timelineConfig.entities, function(entityConfig) {
					...
					BPMSoft.require(moduleNames, callback, scope);
				},
				...
				init: function(callback, scope) {
					...
					this.callParent([function() {
						this.BPMSoft.chain(
							...
							function(next) {
								this.BPMSoft.TimelineManager.initialize(next, this);
							},
							function(next) {
				...
				reverseTimelineItems: function(callback, scope) {
					...
					this.$IsTimelineItemsLoading = true;
					var timelineConfig = this.$TimelineConfig;
					timelineConfig.orderDirection = timelineConfig.orderDirection === this.BPMSoft.OrderDirection.ASC
							? this.BPMSoft.OrderDirection.DESC
							: this.BPMSoft.OrderDirection.ASC;
					this.initDataStorage(timelineConfig);
