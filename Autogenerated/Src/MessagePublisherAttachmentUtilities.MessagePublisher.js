define("MessagePublisherAttachmentUtilities", ["ext-base", "BPMSoft", "MessagePublisherAttachmentUtilitiesResources",
			"MaskHelper", "FileUploadErrorHandlers", "ConfigurationEnums"],
		function(Ext, BPMSoft, resources, MaskHelper) {
			/**
			 * @class BPMSoft.configuration.MessagePublisherAttachmentUtilities
			 */
			Ext.define("BPMSoft.configuration.mixins.MessagePublisherAttachmentUtilities", {
				alternateClassName: "BPMSoft.MessagePublisherAttachmentUtilities",
				...
				getAttachFileButtonImageConfig: function() {
					var imageUrl = this.BPMSoft.ImageUrlBuilder.getUrl(resources.localizableImages.AttachFileButtonImage);
					return {
				 ...
				 * @protected
				 */
				onAttachFileButtonClick: BPMSoft.emptyFn,
				...
				getAttachments: function(callback, scope) {
					...
					orderColumn.orderDirection = this.BPMSoft.OrderDirection.DESC;
					esq.filters.addItem(esq.createColumnFilterWithParameter(
							this.BPMSoft.ComparisonType.EQUAL, this.entitySchemaName, this.get("PrimaryColumnValue")));
