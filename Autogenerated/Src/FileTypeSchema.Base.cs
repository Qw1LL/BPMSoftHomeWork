namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class FileTypeSchema : BPMSoft.Configuration.BaseCodeLookupSchema
	{
	...
	/// Attachment Type.
	/// </summary>
	public class FileType : BPMSoft.Configuration.BaseCodeLookup
	{
	...
	/// <exclude/>
	public partial class FileType_BaseEventsProcess<TEntity> : BPMSoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : FileType
	{
