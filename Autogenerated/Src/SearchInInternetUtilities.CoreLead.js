define("SearchInInternetUtilities", ["SearchInInternetUtilitiesResources"], function(resources) {
	var SearchInInternetUtilitiesClass = Ext.define("BPMSoft.configuration.mixins.SearchInInternetUtilities", {
		alternateClassName: "BPMSoft.SearchInInternetUtilities",
		...
		setSearchEnginesUrlCollection: function(sysSettingValues) {
			var collection = {};
			this.BPMSoft.each(sysSettingValues, function(settingValue, settingName) {
		...
		loadUrlFromSysSettings: function() {
			...
			this.BPMSoft.SysSettings.querySysSettings(sysSettingsCodes, this.setSearchEnginesUrlCollection, this);
		},
