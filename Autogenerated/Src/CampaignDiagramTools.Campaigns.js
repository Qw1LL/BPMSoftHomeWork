 ...
 * ########### ### ###### # ########## ########.
 */
define("CampaignDiagramTools", ["BPMSoft", "ext-base", "CampaignEnums", "CampaignDiagramEnums", "ej-diagram"],
		function(BPMSoft, Ext, campaignEnums, campaignDiagramEnums) {
			...
			var getCreateConnectionTool = function(scope) {
				...
				var createConnectionHandle = scope.createConnectionHandle = ej.datavisualization.Diagram.UserHandle({
					...
					constraint: BPMSoft.diagram.ToolsConstraint.ConnectionEditTool,
				...
				var CreateConnectionTool = (function(base, scope) {
					...
					return tool;
				})(BPMSoft.CampaignDiagramTools.ConnectionEditTool, scope);
			...
			var getNodeSelectionTool = function() {
				...
				var nodeSelectionHandle = this.nodeSelectionHandle = ej.Diagram.UserHandle({
					...
					size: handleDefaults.size,
					constraint: BPMSoft.diagram.ToolsConstraint.NodeSelectionTool,
					position: {x: 0, y: 0},
					enableMultiSelection: false,
					backgroundColor: handleDefaults.backgroundColor,
			...
			Ext.define("BPMSoft.diagram.userHandles.CampaignDiagramTools", {
				alternateClassName: "BPMSoft.CampaignDiagramTools",
