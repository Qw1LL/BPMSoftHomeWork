define('QuickFilterViewModel', ['ext-base', 'BPMSoft', 'FixedFilterViewModel',
	'FolderFilterViewModel', 'CustomFilterViewModel', 'QuickFilterViewModelResources'],
	function(Ext, BPMSoft, FixedFilterViewModel, FolderFilterViewModel, CustomFilterViewModel, resources) {
		...
		function getFilters() {
			...
			if (this.filterModulesMap) {
				BPMSoft.each(this.filterModulesMap, function(item, index) {
