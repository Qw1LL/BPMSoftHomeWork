		...
		return {
			...
			methods: {
				...
				getServiceConfig: function() {
					return {
						className: "BPMSoft.Configuration.CallMessagePublisher"
					};
				},
				...
				getCallDirectionFilter: function(query) {
					...
					return query.createColumnFilterWithParameter(BPMSoft.ComparisonType.NOT_EQUAL,
				...
				setDefaultValues: function() {
					this.set("CallDirectionsList", this.Ext.create("BPMSoft.Collection"));
