		...
		return {
			...
			methods: {
				...
				getChannelIcon: function () {
					return this.BPMSoft.ImageUrlBuilder.getUrl(this.get("Resources.Images.SocialChannelIcon"));
				},
				...
				initAttributes: function() {
					this.set("CommentMessages", this.Ext.create("BPMSoft.Collection"));
				},

				/**
				 * @inheritdoc BPMSoft.BaseMessageHistoryItemPage#historyMessageEsqApply
				 * @override
				 */
				...
				/**
				 * @param entityCollection {BPMSoft.Collection} Collection of social message entities.
				 * @private
				 */
				 ...
				 * @param entity {BPMSoft.Entity} Entity source for view model attributes filling.
				 * @protected
				 * @return {BPMSoft.SocialMessageHistoryCommentItemPageViewModel} Created entity.
				 */
				...
				getCommentViewModelClassName: function() {
					return "BPMSoft.SocialMessageHistoryCommentItemPageViewModel";
				},

				/**
				 * Build select query to fetch comments.
				 * @return {BPMSoft.EntitySchemaQuery} Built query.
				 */
				getCommentMessagesSelect: function() {
					...
					select.addColumn("CreatedOn").orderDirection = this.BPMSoft.OrderDirection.ASC;
					var parentMessageFilter = select.createColumnFilterWithParameter(
						this.BPMSoft.ComparisonType.EQUAL, "Parent", this.get("RecordId"));
				...
				getCommentViewConfigClassName: function() {
					return "BPMSoft.SocialMessageHistoryCommentItemPageViewConfig";
				},
				...
				getCommentsIcon: function() {
					return this.BPMSoft.ImageUrlBuilder.getUrl(this.get("Resources.Images.CommentsIcon"));
				},
				...
				getShowMoreCommentsIcon: function() {
					return this.BPMSoft.ImageUrlBuilder.getUrl(this.get("Resources.Images.ExpandArrow"));
				},
				...
				/**
				 * @inheritDoc BPMSoft.BaseMessageHistoryItemPage#getIsNeedToColor
				 * @override
				 */
