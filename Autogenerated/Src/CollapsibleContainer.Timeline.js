define("CollapsibleContainer", ["CollapsibleContainerResources", "css!CollapsibleContainer"], function(resources) {
	Ext.define("BPMSoft.controls.CollapsibleContainer", {
		extend: "BPMSoft.controls.AbstractContainer",
		alternateClassName: "BPMSoft.CollapsibleContainer",
		...
		/**
		 * @inheritdoc BPMSoft.AbstractContainer#getTplData
		 * @override
		 */
		getTplData: function() {
			...
			Ext.apply(tplData, {
				...
				collapsingButtonCaption: BPMSoft.encodeHtml(collapsingButtonCaption)
			});
			if (this.collapsed) {
				tplData.wrapClassName.push(this.collapsedClass);
			}
			var imageUrl = BPMSoft.ImageUrlBuilder.getUrl(this.collapsingButtonImage);
			if (imageUrl) {
		...
		/**
		 * @inheritdoc BPMSoft.Component#onOwnerCtAfterRenderOrAfterRerender
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.AbstractContainer#getBindConfig
		 * @override
		 */
	...
	return BPMSoft.CollapsibleContainer;
});
