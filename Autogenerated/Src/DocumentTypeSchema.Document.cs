namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class DocumentTypeSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Тип документа.
	/// </summary>
	public class DocumentType : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class DocumentType_DocumentEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DocumentType
	{
