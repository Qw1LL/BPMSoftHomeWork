/**
 * @class BPMSoft.configuration.view.DashboardItemPage
 */
Ext.define("BPMSoft.configuration.view.DashboardItemPage", {
	extend: "BPMSoft.view.BasePage",
	alternateClassName: "BPMSoft.view.DashboardItemPage",
	...
	/**
	 * @property {BPMSoft.Grid} Instance of grid.
	 * @protected
	 */
	grid: null,
