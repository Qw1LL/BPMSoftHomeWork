namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class CaseSchema : BPMSoft.Configuration.Case_Problem_BPMSoftSchema
	{
	...
	/// Обращение.
	/// </summary>
	public class Case : BPMSoft.Configuration.Case_Problem_BPMSoft
	{
	...
	/// <exclude/>
	public partial class Case_ChangeEventsProcess<TEntity> : BPMSoft.Configuration.Case_ProblemEventsProcess<TEntity> where TEntity : Case
	{
