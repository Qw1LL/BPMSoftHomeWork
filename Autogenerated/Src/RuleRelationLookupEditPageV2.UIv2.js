	...
	function(resources, EntityStructureHelper) {
		return {
			...
			methods: {
				 ...
				 * @overridden
				 */
				initViewOptionsButtonMenu: BPMSoft.emptyFn,
				...
				init: function() {
					...
					this.set("SchemaList", this.Ext.create("BPMSoft.Collection"));
					this.set("SchemaColumnList", this.Ext.create("BPMSoft.Collection"));
					this.set("DependentSchemaList", this.Ext.create("BPMSoft.Collection"));
					this.set("DependentSchemaColumnList", this.Ext.create("BPMSoft.Collection"));
				...
				setFromSchemaList: function(filter, list) {
					...
					esq.addColumn("[SysSchema:UId:SectionSchemaUId].Name", "Name");
					esq.addColumn("[SysSchema:UId:SectionSchemaUId].Caption", "Caption");
					filter = this.BPMSoft.createColumnFilterWithParameter(this.BPMSoft.ComparisonType.EQUAL,
							"Name", "ACTIVITY");
