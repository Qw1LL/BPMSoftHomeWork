/**
 * @class BPMSoft.configuration.controller.DashboardItemPage
 * @abstract
 */
Ext.define("BPMSoft.configuration.controller.DashboardItemPage", {
	extend: "BPMSoft.controller.BasePage",
	alternateClassName: "BPMSoft.controller.DashboardItemPage",
	...
	loadGridConfig: function(callback) {
		...
		BPMSoft.AnalyticsService[this.gridDataConfigServiceName]({
	 ...
	 */
	generateDashboardItemConfig: BPMSoft.abstractFn,
	 ...
	 * @virtual
	 * @param {Object} gridConfig Config of grid.
	 * @return {BPMSoft.configuration.AnalyticsServiceGridDataProxy} Proxy.
	 */
	createAnalyticsServiceGridDataProxy: function(gridConfig) {
		var record = this.getSysDashboardRecord();
		return Ext.create("BPMSoft.configuration.AnalyticsServiceGridDataProxy", {
