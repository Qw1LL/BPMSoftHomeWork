...
define("SourceCodeEdit", ["ext-base", "SourceCodeEditEnums", "AceEdit", "css!SourceCodeEdit"
	...
	/**
	 * @class BPMSoft.configuration.SourceCodeEdit
	 * Class for editing source codes.
	 */
	Ext.define("BPMSoft.configuration.SourceCodeEdit", {
		extend: "BPMSoft.BaseEdit",
		alternateClassName: "BPMSoft.SourceCodeEdit",
		...
		/**
		 * Flag that indicates word line break wrap
		 * @type {Boolean}
		 */
		isWrap: false,
		...
		/**
		 * @inheritdoc BPMSoft.BaseEdit#combineClasses
		 * @protected
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseEdit#setShowValueAsLink
		 * Hides base implementation.
		 * @protected
		 * @overridden
		 */
		setShowValueAsLink: BPMSoft.emptyFn,

		/**
		 * @inheritdoc BPMSoft.BaseEdit#setLinkValue
		 * Hides base implementation.
		 * @protected
		 * @overridden
		 */
		setLinkValue: BPMSoft.emptyFn,

		/**
		 * @inheritdoc BPMSoft.BaseEdit#setPlaceholder
		 * Hides base implementation.
		 * @protected
		 * @overridden
		 */
		setPlaceholder: BPMSoft.emptyFn,
		...
		initAceEdit: function(ace) {
			...
			aceEdit.renderer.setScrollMargin(20);
		...
		setWhitespacesVisible: function(whitespacesVisible) {
			this.log(this.Ext.String.format(this.BPMSoft.Resources.ObsoleteMessages.ObsoleteMethodMessage,
				"setWhitespacesVisible", "setShowWhitespaces"), BPMSoft.LogMessageType.WARNING);
		...
		/**
		 * @inheritdoc BPMSoft.BaseEdit#setDomValue
		 * @protected
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseEdit#setReadonly
		 * @protected
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseEdit#setFocused
		 * @protected
		 * @overridden
		 */
		...
		/**
		 * @inheritdoc BPMSoft.BaseEdit#setCaretToLastPosition
		 * @protected
		 * @overridden
		 */
	...
	return Ext.create("BPMSoft.SourceCodeEdit");
});