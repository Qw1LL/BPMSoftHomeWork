define("GridSettingsViewModelGenerator", ["ext-base", "BPMSoft", "GridSettingsViewModelGeneratorResources",
	"ConfigurationConstants", "ColumnSettingsUtilities"],
	function(Ext, BPMSoft, resources, ConfigurationConstants, ColumnSettingsUtilities) {
				...
				getTiledProfileConfig: function() {
					...
					for (var i = 0; i < collection.length; i++) {
						...
						for (var j = 0; j < row.cells.length; j++) {
							...
							var captionLcz = {};
							captionLcz[BPMSoft.Resources.CultureSettings.currentCultureId] = cell.caption;
				...
				getListedProfileConfig: function() {
					...
					if (collection.length > 0) {
						...
						for (var k = 0; k < firstRow.cells.length; k++) {
							...
							var captionLcz = {};
							captionLcz[BPMSoft.Resources.CultureSettings.currentCultureId] = listedCell.caption;
