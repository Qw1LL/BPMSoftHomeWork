define("ExtendedHtmlEditModule", ["ext-base", "BPMSoft", "ExtendedHtmlEditModuleResources", "HtmlEditModule"
	 ...
	 */
	Ext.define("BPMSoft.controls.ExtendedHtmlEdit", {
		extend: "BPMSoft.HtmlEdit",
		alternateClassName: "BPMSoft.ExtendedHtmlEdit",

		mixins: {
			expandableList: "BPMSoft.ExpandableList"
		},
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#tpl
		 * @override
		 */
		tpl: [
			"<div id=\"{id}-html-edit\" class=\"{htmlEditClass}\" style=\"{htmlEditStyle}\">",
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#onImagesLoaded
		 * @override
		 */
		onImagesLoaded: BPMSoft.emptyFn,
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#subscribeForEvents
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.ExpandableList#maskDelay
		 * @override
		 */
		maskDelay: 100,

		/**
		 * @inheritdoc BPMSoft.HtmlEdit#setValueDelay
		 * @override
		 */
		setValueDelay: 50,
		...
		constructor: function() {
			...
			this.insertEmailTemplateDebounce = new Ext.util.DelayedTask(BPMSoft.emptyFn, this);
		},
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#getBindConfig
		 * @override
		 */
		 ...
		 */
		onBeforeCommandExec: BPMSoft.emptyFn,
		...
		/**
		 * @inheritdoc BPMSoft.AbstractContainer#onDestroy
		 * @override
		 */
		onDestroy: function() {
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#destroy
		 * @override
		 */
		destroy: function() {
			var editor = this.editor;
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#init
		 * @override
		 */
		init: function() {
			...
			if (this.useTemplates) {
				...
				var item = {
					...
					imageConfig: {
						...
						url: "data:image/svg+xml;base64,"
					},
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#initDomEvents
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.HtmlEdit#onContentDom
		 * @override
		 */
		...
		isTrackingStartChar: function() {
			var result = false;
			BPMSoft.each(this.trackingStartChars, function(trackingStartCharCode) {
		...
		/**
		 * @inheritdoc BPMSoft.controls.HtmlEdit#setStyle
		 * @override
		 */
		setStyle: function() {
			this.callParent(arguments);
		...
		/**
		 * @inheritdoc BPMSoft.controls.HtmlEdit#onFontFamilyChange
		 * @override
		 */
		...
		/**
		 * @inheritdoc BPMSoft.controls.HtmlEdit#onFontSizeChange
		 * @override
		 */
