define("ForecastHierarchyItemViewModel", ["StructureExplorerUtilities", "ForecastHierarchyItemViewModelResources"],
	function(StructureExplorerUtilities, resources) {
		...
		/**
		 * @class BPMSoft.configuration.ForecastHierarchyItemViewModel
		 * Forecast hierarchy item view model.
		 */
		Ext.define("BPMSoft.configuration.ForecastHierarchyItemViewModel", {
			extend: "BPMSoft.BaseViewModel",
			alternateClassName: "BPMSoft.ForecastHierarchyItemViewModel",
		...
		return BPMSoft.ForecastHierarchyItemViewModel;
	});
