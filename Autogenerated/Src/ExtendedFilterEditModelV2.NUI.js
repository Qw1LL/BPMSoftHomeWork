define("ExtendedFilterEditModelV2", ["ext-base", "BPMSoft", "ExtendedFilterEditModelV2Resources",
			...
			var model = {
				...
				methods: {
					...
					onFiltersChanged: function() {
						...
						activeFolder.set("OptimizationType", BPMSoft.Folder.OptimizationType.TryOptimize);
					},
					 ...
					 * @return {BPMSoft.FolderFilterItemViewModel} Created folder.
					 */
					createFolder: function(entityFolderSchema, folderName, parentId) {
						...
						BPMSoft.each(folder.columns, function(column) {
							column.columnPath = column.name;
							column.type = BPMSoft.ViewModelColumnType.ENTITY_COLUMN;
						});
						folder.set(entityFolderSchema.primaryColumnName, BPMSoft.generateGUID());
					...
					onInputBoxClosed: function(pressedButtonCode, inputBoxControls) {
						if (pressedButtonCode === BPMSoft.MessageBoxButtons.SAVE.returnCode &&
					...
					openInputBox: function() {
						...
						BPMSoft.utils.inputBox(resources.localizableStrings.InputBoxCaption, this.onInputBoxClosed,
							[messageBoxButtons.SAVE.returnCode, messageBoxButtons.CANCEL.returnCode], this,
							{
								name: {
