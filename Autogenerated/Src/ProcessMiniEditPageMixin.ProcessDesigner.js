define("ProcessMiniEditPageMixin", ["ProcessMiniEditPageModule"], function() {
	 ...
	 */
	Ext.define("BPMSoft.configuration.mixins.ProcessMiniEditPageMixin", {
		alternateClassName: "BPMSoft.ProcessMiniEditPageMixin",
		...
		_setActiveItemIdValue: function(id) {
			...
			if (!parentModule && !BPMSoft.isDebug) {
				return;
			}
		...
		getItemEditInfo: function() {
			...
			var itemInfo = {};
			BPMSoft.each(columns, function(columnValue, columnName) {
