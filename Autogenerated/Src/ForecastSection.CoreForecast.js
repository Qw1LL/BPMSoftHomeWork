	...
	function(resources, RightUtilities, AcademyUtilities, ConfigurationEnums, ServiceHelper) {
		return {
			...
			methods: {
				 ...
				 * @protected
				 * @virtual
				 * @param {BPMSoft.BaseViewModel} activeTab Active tab view model.
				 */
				...
				initData: function() {
					...
					const tabsCollection = this.Ext.create("BPMSoft.BaseViewModelCollection", {
				...
				setIsTabsEmpty: function() {
					...
					this.setCenterPanelContainerEmptyClass(isEmpty)
					this.set("IsTabsEmpty", isEmpty);
				},
				
				setCenterPanelContainerEmptyClass: function (result) {
					const container = document.querySelector('#centerPanelContainer');
					if(result) {
						container?.classList.add('forecast-empty')
					} else {
				...
				unloadNestedModules: function() {
					...
					this.setCenterPanelContainerEmptyClass(false)
				},
			...
			openForecastPage: function(moduleId, operation) {
				...
				checkRecordOperationRights: function(operation) {
					...
					let result;
					switch (operation) {
						case this.BPMSoft.RightsEnums.operationTypes.read:
							result = this.isSchemaRecordCanReadRightConverter(rights);
							break;
						case this.BPMSoft.RightsEnums.operationTypes.edit:
							result = this.isSchemaRecordCanEditRightConverter(rights);
							break;
						case this.BPMSoft.RightsEnums.operationTypes.delete:
				...
				deleteCurrentForecast: function() {
					...
					this.canDeleteForecastItems(function(result) {
						...
						if (resultMessage) {
							this.BPMSoft.utils.showConfirmation(resources.localizableStrings[resultMessage],
								this.BPMSoft.emptyFn,
							...
							this.BPMSoft.utils.showConfirmation(this.get("Resources.Strings.DeleteConfirmationMessage"),
								function(returnCode) {
				...
				onDeleteAccept: function() {
					...
					const deleteForecastQuery = this.Ext.create("BPMSoft.DeleteQuery", {
				...
				init: function(callback, scope) {
					this.$ForecastUIV2FeatureEnabled = this.BPMSoft.Features.getIsEnabled("ForecastUIV2");
				...
				initDataViews: function() {
					...
					this.BPMSoft.each(defaultDataViews, function(dataView, dataViewName) {
				...
				initMainHeaderCaption: function() {
					...
					this.BPMSoft.utils.dom.setAttributeToBody("is-card-opened", false);
				},
				...
				getSectionSubHeaderCaption: function () {
					if (!this.$Forecasts || this.$Forecasts.isEmpty()) {
						return;
					}
					var forecasts = this.get("Forecasts");
					...
					if(forecasts && forecastId) {
						return this.$Forecasts?.get(forecastId)?.get("Name");
					}
				}
			...
			diff: [
				...
				},
				{
					...
					"values": {
						...
						"wrapClass": ["forecast-section-header-container-wrapClass"],
						"items": []
					}
				},
				{
					...
					"values": {
						...
						"caption": {"bindTo": "getSectionSubHeaderCaption"},
						"labelClass": ["forecast-section-header-label"],
						"visible": {
							"bindTo": "IsTabsEmpty",
							"bindConfig": {
								"converter": "invertBooleanValue"
				...
				},
				{
					...
					"values": {
						...
						"wrapClass": ["forecast-section-separate-container-wrapClass"],
						"items": []
					}
				},
				{
				...
				},
				{
					...
					"index": 1,
					"values": {
						"id": "ForecastSeparateModeActionsButton",
						"itemType": BPMSoft.ViewItemType.BUTTON,
						"style": BPMSoft.controls.ButtonEnums.style.DEFAULT,
						"caption": BPMSoft.Resources.SchemaDesigner.ActionsButtonCaption,
						"classes": {
							"textClass": ["actions-button-margin-right"],
							"wrapperClass": ["actions-button-margin-right"]
						},
									...
									"items": [
										{
											...
											"caption":  {"bindTo": "Resources.Strings.EditScheduleCaption"},
										},
										{
											...
											"caption":  {"bindTo": "Resources.Strings.DeleteScheduleCaption"},
										},
								
									{
									"markerValue": "SettingsButton",
									"caption": {"bindTo": "Resources.Strings.ConfigurationButtonHint"},
									"menu": {
										items: [
											{
												"caption": {"bindTo": "Resources.Strings.AddButtonCaption"},
