namespace BPMSoft.Configuration
{
	...
	public class BaseOffice365OAuthAuthenticator : BaseOAuthAuthenticator
	{
		...
		/// <summary>
		/// Creates a new <see cref="BPMSoft.Configuration.ContactSyncSettings"/> record
		/// for the specific <see cref="BPMSoft.Configuration.MailboxSyncSettings"/> identifier.
		/// </summary>
		/// <param name="mailboxId"><see cref="BPMSoft.Configuration.MailboxSyncSettings"/> identifier.</param>
		...
		/// <summary>
		/// Creates a new <see cref="BPMSoft.Configuration.ActivitySyncSettings"/> record
		/// for the specific <see cref="BPMSoft.Configuration.MailboxSyncSettings"/> identifier.
		/// </summary>
		/// <param name="mailboxId"><see cref="BPMSoft.Configuration.MailboxSyncSettings"/> identifier.</param>
