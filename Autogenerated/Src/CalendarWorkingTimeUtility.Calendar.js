define("CalendarWorkingTimeUtility", [],
	function() {
		/**
		 * @class This.BPMSoft.tconfiguration.mixins.CalendarWorkingTimeUtility
		 * Mixin, that implements work with working interval on detail.
		 */
		Ext.define("BPMSoft.configuration.mixins.CalendarWorkingTimeUtility", {
			alternateClassName: "BPMSoft.CalendarWorkingTimeUtility",
			...
			addWorkingIntervalsQueryFilters: function(esq, primaryColumnValue) {
				esq.filters.add("primaryColumnValueFilter", this.BPMSoft.createColumnFilterWithParameter(
						this.BPMSoft.ComparisonType.EQUAL, this.entitySchemaName, primaryColumnValue));
			},
			...
			*/
			 ...
			 */
			getWorkingIntervalsQuery: this.BPMSoft.emptyFn,
			...
			applyVirtualColumnsConfig: function(columnName, cellConfig) {
				...
				cellConfig.dataValueType = this.BPMSoft.DataValueType.TEXT;
			...
			fillDayWorkingTimeDisplayValue: function(intervals) {
				...
				this.BPMSoft.each(intervals, function(item) {
