define("PortalContactMiniPage", ["PortalContactMiniPageResources", "MiniPageResourceUtilities", "EmailHelper", "TimezoneGenerator",
	...
	return {
		...
		attributes: {
			...
			"MiniPageModes": {
				"value": [BPMSoft.ConfigurationEnums.CardOperation.VIEW,
					BPMSoft.ConfigurationEnums.CardOperation.ADD, BPMSoft.ConfigurationEnums.CardOperation.EDIT]
			},
		...
		mixins: {
			/**
			 * @class BPMSoft.configuration.mixins.TimezoneMixin
			 * Time Zone mixin.
			 */
		...
		methods: {
			...
			isOwnerExist: function() {
				...
				var isOwnerExist = !BPMSoft.isEmpty(owner && owner.displayValue);
			...
			/**
			 * @inheritdoc BPMSoft.BaseMiniPage#publishOnSaveEvents
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.BaseMiniPage#updateDetail
			 * @override
			 */
