define("FileImportWizard", [
	"ext-base", "BPMSoft", "FileImportWizardBundle", "BaseWizardModule", "FileImportModule",
	"FileImportWizardHeaderModule", "HistoryStateUtilities", "FileImportWizardStep"
], function(Ext, BPMSoft) {
	Ext.define("BPMSoft.configuration.FileImportWizard", {
		extend: "BPMSoft.BaseWizardModule",
		alternateClassName: "BPMSoft.FileImportWizard",
		...
		initResources: function(callback, scope) {
			this.BPMSoft.require(["FileImportWizardBundleResources"], function(FileImportWizardBundleResources) {
				...
				this.steps = [
					{
						...
						groupName: "",
						config: {
							viewModelClassName: "BPMSoft.FileImportWizardStep"
						}
					},
					{
		...
		loadStep: function(stepName) {
			...
			this.sandbox.publish("PushHistoryState", {
				hash: this.BPMSoft.combinePath(step.moduleName, step.schemaName, this.importSessionId,
	...
	return BPMSoft.FileImportWizard;
});
