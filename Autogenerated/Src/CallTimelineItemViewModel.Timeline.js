define("CallTimelineItemViewModel", ["ConfigurationConstants", "CallTimelineItemViewModelResources",
	...
	function(ConfigurationConstants) {
		/**
		 * @class BPMSoft.configuration.CallTimelineItemViewModel
		 * Call timeline item view model class.
		 */
		Ext.define("BPMSoft.configuration.CallTimelineItemViewModel", {
			alternateClassName: "BPMSoft.CallTimelineItemViewModel",
			...
			/**
			 * @inheritdoc BPMSoft.BaseTimelineItemViewModel#getEntityIconSrc
			 * @override
			 */
			getEntityIconSrc: function() {
				...
				if (callIcon) {
					return BPMSoft.ImageUrlBuilder.getUrl(callIcon);
				} else {
