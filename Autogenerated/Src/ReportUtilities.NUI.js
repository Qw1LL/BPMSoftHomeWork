define("ReportUtilities", ["ext-base", "BPMSoft", "LocalizationUtilities", "SysModuleReport", "MaskHelper", "ServiceHelper"],
		function(Ext, BPMSoft, LocalizationUtilities, SysModuleReport, MaskHelper, ServiceHelper) {
	...
	function getReports(config) {
		...
		var esq = Ext.create("BPMSoft.EntitySchemaQuery", {rootSchema: SysModuleReport});
		...
		// ###### ##### ##### ########### ########## ## "##### ## ####"
		var activityFilter = BPMSoft.createColumnInFilterWithParameters("Id",
			["490AD08A-8C80-E011-AFBC-00155D04320C", "DCFD7211-240C-4E8D-9154-FF2BCE2FD20E"]);
		activityFilter.comparisonType = BPMSoft.ComparisonType.NOT_EQUAL;
	...
	function generateReport(entitySchemaUId, config) {
		...
		var recordId = config.recordId || BPMSoft.GUID_EMPTY;
