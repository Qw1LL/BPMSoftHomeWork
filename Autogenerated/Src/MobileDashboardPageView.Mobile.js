/**
 * @class BPMSoft.configuration.view.DashboardPage
 */
Ext.define("BPMSoft.configuration.view.DashboardPage", {
	...
	activateDashboard: function() {
		...
		if (this.carousel) {
			...
			if (activeItem) {
				...
				if (activeItem.getItemsStatus() === BPMSoft.DashboardContainerItemsStatus.Loaded) {
	...
	getCachedDashboardLayoutItem: function(dashboardId, itemName) {
		...
		if (layoutItems) {
			return BPMSoft.Array.find(layoutItems, function(layoutItem) {
	 ...
	 * @return {BPMSoft.configuration.DashboardViewGenerator} Instance.
	 */
	...
	createDashboardViewGenerator: function(layoutConfig) {
		var config = {
			...
			defaultItemsStatus: BPMSoft.DashboardContainerItemsStatus.Loading,
			itemListeners: {
		...
		return BPMSoft.DashboardUtils.getDashboardViewGeneratorInstance(config);
	},
	...
	getDashboardPicker: function() {
		...
		if (!dashboardPicker) {
			dashboardPicker = Ext.create("BPMSoft.LookupPicker", {
				component: {
					listPaging: false,
					grouped: true,
					store: null,
				...
				title: BPMSoft.LS.DashboardSectionTitle,
	 ...
	 * @protected
	 * @virtual
	 * @param {BPMSoft.controls.List} el Picker's list.
	 ...
	 * @protected
	 * @virtual
	 * @param {BPMSoft.controls.SearchFilterModule} filterModule Filter module.
	 */
	...
	initialize: function() {
		...
		navigationPanel.setTitle(BPMSoft.LocalizableStrings.MobileDashboardPageTitle);
	...
	createNoDataLabel: function() {
		return Ext.create("Ext.Label", {
			...
			html: BPMSoft.LocalizableStrings.MobileDashboardPageNoDataLabelText
		});
	},
	...
	getCarouselConfig: function(records, activeDashbordId) {
		...
		return {
			indicator: {
				titles: titles,
				noItemsTitle: BPMSoft.LocalizableStrings.MobileDashboardPageNoDashboardsText
			},
			items: items,
	 ...
	 * @protected
	 * @virtual
	 * @param {Object} carouselConfig Config of {@link BPMSoft.Carousel}.
	 */
	createCarousel: function(carouselConfig) {
		...
		this.carousel = Ext.create("BPMSoft.Carousel", carouselConfig);
	 ...
	 * @deprecated Extends method {@link BPMSoft.DashboardViewGenerator#getLayoutItem} in custom generator.
	 * @protected
	 * @virtual
	 ...
	 * @deprecated Extends method {@link BPMSoft.DashboardViewGenerator#generateItem} in custom generator.
	 * @protected
	 * @virtual
	 * @param {Object} item Configuration of dashboard item.
	...
	setNoData: function(noDashboardData) {
		if (noDashboardData) {
			...
			if (BPMSoft.ApplicationUtils.isOnlineMode()) {
				BPMSoft.RequestManager.fireEvent("connectionlost");
			} else {
	 ...
	 * @deprecated Extends method {@link BPMSoft.DashboardViewGenerator#getIndicatorItem} in custom generator.
	 * @param {Object} itemConfig Dashboard item data config.
	 ...
	 * @deprecated Extends method {@link BPMSoft.DashboardViewGenerator#getChartItem} in custom generator.
	 * @param {Object} itemConfig Dashboard item data config.
	 ...
	 * @deprecated Extends method {@link BPMSoft.DashboardViewGenerator#getGaugeItem} in custom generator.
	 * @param {Object} itemConfig Dashboard item data config.
	 ...
	 * @deprecated Extends method {@link BPMSoft.DashboardViewGenerator#getGridItem} in custom generator.
	 * @param {Object} itemConfig Dashboard item data config.
	 ...
	 * @deprecated Extends method {@link BPMSoft.DashboardViewGenerator#getCustomItem} in custom generator.
	 * @param {Object} itemConfig Dashboard item data config.
	 ...
	 * @deprecated Extends method {@link BPMSoft.DashboardViewGenerator#getDefaultItem} in custom generator.
	 * @param {Object} itemConfig Dashboard item data config.
	 ...
	 * @deprecated Extends method {@link BPMSoft.DashboardViewGenerator#getDataNotAvailableItem} in custom generator.
	...
	reflowDashboardItem: function(item) {
		if (item instanceof BPMSoft.ChartDashboardItem) {
	 ...
	 * @deprecated Extends method {@link BPMSoft.DashboardViewGenerator#getDefaultItemConfig} in custom generator.
	 * @param {Object} itemConfig Dashboard item data config.
	...
	/**
	 * Returns carousel.
	 * @returns {BPMSoft.Carousel} Instance of carousel.
	 */
	 ...
	 * @returns {BPMSoft.configuration.DashboardContainer} Instance of dashboard container.
	 */
	 ...
	 * @returns {BPMSoft.configuration.DashboardContainer} Carousel item.
	 */
