namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ProblemTypeSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Тип проблемы.
	/// </summary>
	public class ProblemType : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class ProblemType_ProblemEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ProblemType
	{
