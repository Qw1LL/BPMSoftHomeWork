namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class CaseCategorySchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// Категория обращения.
	/// </summary>
	public class CaseCategory : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class CaseCategory_CaseEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CaseCategory
	{
