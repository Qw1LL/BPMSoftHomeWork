namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ContractFileSchema : BPMSoft.Configuration.FileSchema
	{
	...
	/// <summary>
	/// Файл и ссылка договора.
	/// </summary>
	public class ContractFile : BPMSoft.Configuration.File
	{
	...
	/// <exclude/>
	public partial class ContractFile_CoreContractsEventsProcess<TEntity> : BPMSoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ContractFile
	{
