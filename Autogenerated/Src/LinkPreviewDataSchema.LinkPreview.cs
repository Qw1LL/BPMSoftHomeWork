namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class LinkPreviewDataSchema : BPMSoft.Configuration.BaseEntitySchema
	{
	...
	/// Link preview data.
	/// </summary>
	public class LinkPreviewData : BPMSoft.Configuration.BaseEntity
	{
	...
	/// <exclude/>
	public partial class LinkPreviewData_LinkPreviewEventsProcess<TEntity> : BPMSoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : LinkPreviewData
	{
