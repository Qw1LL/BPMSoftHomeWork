define('ProcessLogFolderFilterViewModel', ['ext-base', 'BPMSoft', 'ProcessLogFolderFilterViewModelResources',
        'FolderLookupPageViewModel', 'LookupUtilities'],
    function(Ext, BPMSoft, resources, FolderLookupPageViewModel, LookupUtilities) {
		...
		function getFolderViewModelConfig(entitySchema, mainViewModel) {
            ...
            model.values.entitySchemaLookupEditList = new BPMSoft.Collection();
			...
			model.methods.getLookupFilters = function() {
				...
				filterCollection.add("SysWorkspace",
						BPMSoft.createColumnFilterWithParameter(BPMSoft.ComparisonType.EQUAL,
								'SysWorkspace', BPMSoft.SysValue.CURRENT_WORKSPACE.value));
            ...
            model.methods.getEntitySchemaNames = function(filter, list) {
                ...
                esq.filters.add('CurrentDisplayValue', BPMSoft.createColumnFilterWithParameter(
                    BPMSoft.ComparisonType.START_WITH, 'Caption', filter));
            ...
            model.methods.renderFilter = function() {
                ...
                var filterView = Ext.create(viewConfig.className || 'BPMSoft.ControlGroup', viewConfig);
