namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class ReleaseTagSchema : BPMSoft.Configuration.BaseTagSchema
	{
	...
	/// Тег раздела релизы.
	/// </summary>
	public class ReleaseTag : BPMSoft.Configuration.BaseTag
	{
	...
	/// <exclude/>
	public partial class ReleaseTag_ReleaseEventsProcess<TEntity> : BPMSoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ReleaseTag
	{
