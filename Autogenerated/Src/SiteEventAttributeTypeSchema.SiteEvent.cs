namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class SiteEventAttributeTypeSchema : BPMSoft.Configuration.BaseLookupSchema
	{
	...
	/// <summary>
	/// Тип атрибута события сайта.
	/// </summary>
	public class SiteEventAttributeType : BPMSoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class SiteEventAttributeType_SiteEventEventsProcess<TEntity> : BPMSoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SiteEventAttributeType
	{
