define("MessagePublishersModule", [],
	function() {
		/**
		 * @class BPMSoft.configuration.MessagePublishersModule
		 */
		Ext.define("BPMSoft.configuration.MessagePublishersModule", {
			extend: "BPMSoft.BaseSchemaModule",
			alternateClassName: "BPMSoft.MessagePublishersModule",
		...
		return this.BPMSoft.MessagePublishersModule;
	});
