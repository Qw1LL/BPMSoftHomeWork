namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class QueueTagSchema : BPMSoft.Configuration.BaseTagSchema
	{
	...
	/// Тег раздела очереди.
	/// </summary>
	public class QueueTag : BPMSoft.Configuration.BaseTag
	{
	...
	/// <exclude/>
	public partial class QueueTag_OperatorSingleWindowEventsProcess<TEntity> : BPMSoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : QueueTag
	{
