define("BaseExtendedMenu", ["ConfigurationEnums", "NetworkUtilities"], function(ConfigurationEnums, NetworkUtilities) {
	Ext.define("BPMSoft.configuration.mixins.BaseExtendedMenu", {
		alternateClassName: "BPMSoft.BaseExtendedMenu",
		...
		openCard: function(item, valuePairs) {
			...
			var moduleId = this.sandbox.id + "_" + entitySchemaName + this.BPMSoft.generateGUID();
