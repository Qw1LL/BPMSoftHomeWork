define('SysWorkplaceSection', ['ext-base', 'BPMSoft', 'sandbox', 'SysWorkplace', 'SysWorkplaceSectionStructure',
	'SysWorkplaceSectionResources', 'LocalizableHelper', 'ServiceHelper', 'css!SysWorkplaceHelper'],
	function(Ext, BPMSoft, sandbox, entitySchema, structure, resources, LocalizableHelper, ServiceHelper) {
		structure.userCode = function() {
			...
			this.methods.modifyGridConfig = function(gridConfig) {
				...
				BPMSoft.each(activeRowActions, function(action) {
