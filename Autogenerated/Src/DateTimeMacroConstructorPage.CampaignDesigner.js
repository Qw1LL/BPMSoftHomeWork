		...
		return {
			...
			methods: {
				...
				_isMacroModeVisible: function() {
					return this.$DataValueType === BPMSoft.DataValueType.TEXT;
				},
				...
				getListFromEnum: function(enumName) {
					...
					BPMSoft.each(enums, function(item) {
				...
				setDateMacroByValue: function(value) {
					var dateMacroValue;
					BPMSoft.each(this.$DateMacroEnum, function(item) {
				...
				setTimeMacroByValue: function(value) {
					var timeMacroValue;
					BPMSoft.each(this.$TimeMacroEnum, function(item) {
						if (value.indexOf(item.value) !== -1) {
