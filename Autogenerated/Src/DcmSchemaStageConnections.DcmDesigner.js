define("DcmSchemaStageConnections", ["ext-base", "BPMSoft", "DcmSchemaStageConnection"],
	function(Ext, BPMSoft) {
		Ext.define("BPMSoft.Designers.DcmSchemaStageConnections", {
			extend: "BPMSoft.BaseObject",
			alternateClassName: "BPMSoft.DcmSchemaStageConnections",
			 ...
			 * @type {BPMSoft.DcmSchemaStageConnection[]}
			 */
			connections: null,
			...
			createConnectionObject: function(source, target) {
				var connection = Ext.create("BPMSoft.DcmSchemaStageConnection");
		...
		return BPMSoft.Designers.DcmSchemaStageConnections;
	}
);
