define("ViewModelSchemaDesignerUtils", ["BPMSoft"], function(BPMSoft) {

	Ext.define("BPMSoft.configuration.ViewModelSchemaDesignerUtils", {
		extend: "BPMSoft.BaseObject",
		alternateClassName: "BPMSoft.ViewModelSchemaDesignerUtils",
		singleton: true,
		...
		getUniqueItemName: function(prefix) {
			var guid = BPMSoft.generateGUID();
			return prefix + guid.substring(0, 8);
		}
	});
	return BPMSoft.ViewModelSchemaDesignerUtils;
});
