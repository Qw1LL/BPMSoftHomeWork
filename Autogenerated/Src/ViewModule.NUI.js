define("ViewModule", ["ext-base", "BPMSoft", "sandbox", "ViewModuleResources", "performancecountermanager",
	...
	"WelcomeScreenModule"],
		function(Ext, BPMSoft, sandbox, resources, performanceCounterManager, LookupUtilities,
			...
			var createBuyNowBtn = function(culture) {
				var buyNowBtn = {
					id: "buy-now-btn",
					cls: "buy-now-btn",
					iconPath: BPMSoft.ImageUrlBuilder.getUrl(resources.localizableImages["BuyNow" + culture.split("-")[1]])
				};
			...
			var createOnlineHelpBtn = function(culture) {
				...
				var onlineHelpBtn = {
					id: "online-help-btn",
					cls: "online-help-btn",
					iconPath: BPMSoft.ImageUrlBuilder.getUrl(resources.localizableImages["OnlineHelp" + culture.split("-")[1]])
				};
			...
			function openHomePage(sectionCode) {
				var module = BPMSoft.configuration.ModuleStructure[sectionCode];
				var url = BPMSoft.deepClone(sectionCode);
				if (module) {
			...
			function render(renderTo) {
				var leftPanel = Ext.create("BPMSoft.Container", {
					renderTo: renderTo,
					id: "leftPanel",
					classes: {
				...
				mainCenterPanel = Ext.create("BPMSoft.Container", {
					renderTo: renderTo,
				...
				centerPanel = Ext.create("BPMSoft.Container", {
			...
			function loadWelcomeScreen() {
				BPMSoft.SysSettings.querySysSettings(["ShowWelcomeScreen", "BuildType"], function(sysSettings) {
					...
					if (buildType === ConfigurationConstants.BuildType.Public) {
						...
						BPMSoft.require(["profile!WelcomeScreenModule"], function(profile) {
