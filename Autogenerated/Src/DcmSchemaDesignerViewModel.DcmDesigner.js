define("DcmSchemaDesignerViewModel", ["ext-base", "ProcessModuleUtilities", "DcmSchemaDesignerViewModelResources",
	...
	function(Ext, ProcessModuleUtilities, resources) {
		...
		Ext.define("BPMSoft.DcmSchemaDesignerViewModel", {
			extend: "BPMSoft.BaseProcessSchemaDesignerViewModel",
			alternateClassName: "BPMSoft.Designers.DcmSchemaDesignerViewModel",
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#storageLocationHref
			 * @override
			 */
			storageLocationHref: "DcmSchemaLocationHref",

			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#ProcessSchemaMetaData
			 * @override
			 */
			storageSchemaMetadata: "DcmSchemaMetaData",

			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#storageSchemaResources
			 * @override
			 */
			storageSchemaResources: "DcmSchemaResources",

			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#storageLoadedPropertiesItemName
			 * @override
			 */
			 ...
			 * @override
			 */
			schemaManager: BPMSoft.DcmSchemaManager,
			...
			loadPropertiesPageByClick: function(event) {
				if (BPMSoft.utils.dom.hasClassName(event.target, "load-dcm-properties-page-on-click")) {
			...
			checkCanRemoveElements: function(elements) {
				...
				if (!canRemove) {
					BPMSoft.ProcessSchemaDesignerUtilities.showProcessMessageBox({
						caption: BPMSoft.Resources.ProcessSchemaDesigner.Messages.InvalidRemoveElement,
						message: message
					});
				}
				return canRemove;
				...
				this.schemaManager.validateFilters(validationConfig, function(isValidFilters, message) {
					...
					if (isValidFilters) {
						...
						schema.addValidationResult(schema.validationInfo, schema, [{
							validationType: BPMSoft.ValidationType.ERROR,
							message: message
						}]);
			 ...
			 * @param {BPMSoft.DcmSchemaElement[]} dependentElements Dependent DcmSchema elements.
			 * @return {String}
			 */
			getRemoveElementConfirmationMessage: function(elementUId, dependentElements) {
				...
				var dependentElementsCaptions = dependentElements.map(function(dependentElement) {
					...
					return BPMSoft.getFormattedString("\"{0}\"", dependentElementViewModel.get("Caption"));
				}, this);
				...
				return BPMSoft.getFormattedString(messageTemplate,
			...
			removeUnusedDataManagerItems: function(entitySchemaName) {
				...
				var unusedRecords = [];
				var dataManagerItems = BPMSoft.DataManager.getEntitySchemaData(entitySchemaName);
			...
			saveStageLookupData: function(callback, scope) {
				...
				BPMSoft.chain(
					...
					function(next, stageEntitySchema) {
						...
						BPMSoft.DataManager.saveAndUpdatePackageSchemaData(config, next, this);
					},
			...
			deactivateCasesWithEmptyFilters: function(callback, scope) {
				var schema = this.get("Schema");
				var dcmSettingsId = this.get("DcmSettingsId");
				var esq = BPMSoft.DcmSchemaManager.getEnabledDcmSchemasEsq(schema.uId);
				...
				esq.getEntityCollection(function(response) {
					...
					if (enabledSchemas.getCount()) {
						...
						BPMSoft.DcmSchemaManager.setEnabled({items: schemaUIds, enabled: false}, callback, scope);
					} else {
						callback.call(scope);
					}
				}, this);
			 ...
			 * @private
			 * @param {BPMSoft.Designers.DcmSchemaStage} stage Dcm schema stage.
			 * @param {BPMSoft.Collection} dataManagerItems collection dataManagerItem for current reference entitySchema.
			...
			actualizeDcmSchemaStagesCaption: function(dcmSchema, callback, scope) {
				this.getDcmStageColumnReferenceSchema(dcmSchema, function(entitySchema) {
					...
					BPMSoft.DataManager.select(selectConfig, function() {
						var dataManagerItems = BPMSoft.DataManager.getEntitySchemaData(entitySchemaName);
			...
			getIsValidStorageStageColumnUId: function() {
				...
				var dcmSettingsId = this.get("DcmSettingsId");
				var dcmSettingsItem = BPMSoft.SysDcmSettingsManager.getItem(dcmSettingsId);
			...
			onBeforeStageMove: function(sender, moveData) {
				...
				var message = BPMSoft.getFormattedString(messageTemplate, dragStageCaption, parentStageCaption);
			...
			/**
			 * @inheritdoc BPMSoft.mixins.ReorderableContainerVMMixin#getReorderableIndex.
			...
			/**
			 * @inheritdoc BPMSoft.mixins.ReorderableContainerVMMixin#getMoveData
			...
			/**
			 * @inheritdoc BPMSoft.mixins.ReorderableContainerVMMixin#getDragOverData
			...
			/**
			 * @inheritdoc BPMSoft.model.BaseViewModel#getColumns
			 * @override
			 */
			getModelColumns: function() {
				...
				return Ext.apply(baseColumns, {
					...
					DefaultItemClassName: {
						...
						value: "BPMSoft.DcmStageViewModel"
					},
					DefaultStageCaption: {
						type: BPMSoft.core.enums.ViewModelColumnType.VIRTUAL_COLUMN,
						dataValueType: BPMSoft.core.enums.DataValueType.TEXT,
			...
			/**
			 * @inheritdoc BPMSoft.BaseProcessSchemaDesignerViewModel#onHidePropertyPage
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.BaseProcessSchemaDesignerViewModel#loadItems
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#onItemChanged
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#clearSchemaItems
			 * @override
			 */
			 ...
			 * @protected
			 * @param {BPMSoft.Designers.DcmSchemaStage} dcmStage Dcm schema stage.
			 * @return {BPMSoft.Designers.DcmStageViewModel} Dcm schema stage view model.
			 */
			...
			createDcmSchemaStage: function(config, index) {
				var stage = Ext.create("BPMSoft.DcmSchemaStage", config);
				var schema = this.get("Schema");
			...
			/**
			 * @inheritdoc BPMSoft.ReorderableContainerVMMixin#onDragDrop
			 * @override
			 */
			...
			onElementRemoveButtonClick: function(uId) {
				...
				if (dependentElements.length !== 0) {
					...
					var messageBoxButtons = BPMSoft.MessageBoxButtons;
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#save
			 * @override
			 */
			save: function() {
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#saveNewVersion
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#tryEditSchema
			 * @override
			 */
			tryEditSchema: function(schemaUId) {
				...
				if (dcmSettingsId) {
					...
					if (BPMSoft.DcmSchemaManager.getCanUseProcessVersions()) {
			...
			/**
			 * @inheritdoc BPMSoft.BaseSchemaDesignerStorageMixin#initSchema
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.BaseSchemaDesignerStorageMixin#getIsLoadStoragePanelVisible
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.BaseSchemaDesignerStorageMixin#saveSchemaToStorage
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.BaseSchemaDesignerStorageMixin#clearSchemaStorageInfo
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#getSaveSchemaVersionMessageBoxTitle
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#getSaveSchemaVersionMessageBoxMessage
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#getNeedSetActualSchemaVersionQuestionText
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#init.
			 * @override
			 */
			init: function() {
			...
			createStage: function(config, index) {
				...
				var stageId = BPMSoft.generateGUID();
			...
			/**
			 * @inheritdoc BPMSoft.mixins.ReorderableContainerVMMixin#move
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.mixins.ReorderableContainerVMMixin#getViewModelItems
			 ...
			 * @param {BPMSoft.Designers.DcmStageViewModel} parentStageViewModel Parent stage view model.
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#findItemByUId
			 * @override
			 */
			 ...
			 * @return {null|BPMSoft.Designers.DcmStageElementViewModel|BPMSoft.Designers.DcmStageViewModel}
			 */
			 ...
			 * @return {null|BPMSoft.Designers.DcmStageElementViewModel}
			 */
			 ...
			 * @return {undefined|BPMSoft.Designers.DcmStageViewModel}
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#selectItem
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#clearSelection
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.core.mixins.BaseProcessSchemaDesignerValidationMixin#showSchemaValidationMessageBox
			 * @override
			 * Prevent to save not valid schema.
			 */
			showSchemaValidationMessageBox: function(validationMessage, callback, scope) {
				var schema = this.get("Schema");
				var template = BPMSoft.Resources.ProcessSchemaDesigner.Messages.SchemaValidationMessageCaption;
			...
			/**
			 * @inheritdoc BPMSoft.BaseProcessSchemaDesignerViewModel#onAfterGetSchemaInstance
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#onKeyDown
			 * @override
			 */
			onKeyDown: function(event) {
				this.callParent([event]);
				var defaultResponse = true;
				var isBodyElement = BPMSoft.utils.dom.getIsBodyElement(event.target);
				var selectedItemId = this.selectedItemId;
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#loadSchemaPropertiesPage
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#onSandboxInitialized
			 * @override
			 */
			...
			/**
			 * @inheritdoc BPMSoft.Designers.BaseProcessSchemaDesignerViewModel#getSaveButtonMenuItems
			 * @override
			 */
		...
		return BPMSoft.Designers.DcmSchemaDesignerViewModel;
	}
);
