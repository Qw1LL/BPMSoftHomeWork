namespace BPMSoft.Configuration
{
	...
	/// <exclude/>
	public class InvoiceTagSchema : BPMSoft.Configuration.BaseTagSchema
	{
	...
	/// Тег раздела счета.
	/// </summary>
	public class InvoiceTag : BPMSoft.Configuration.BaseTag
	{
	...
	/// <exclude/>
	public partial class InvoiceTag_InvoiceEventsProcess<TEntity> : BPMSoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : InvoiceTag
	{
